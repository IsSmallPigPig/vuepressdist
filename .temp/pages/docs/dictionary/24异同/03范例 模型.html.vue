...
<p><span class="vocabulary"><strong>illustration</strong></span> [ˌɪləˈstreɪʃn]
...
<p><span class="vocabulary"><strong>precedent</strong></span> [ˈpresɪdənt]
<span class="definition">n. 1 [C, U] 可供后来者援用参考的具体例子：</span>court, judicial, legal precedent 法院的先例；判例；司法惯例 / The ruling set a precedent for future libel cases. 这项裁决为今后的诽谤案提供了判例。/ The trial could set an important precedent for dealing with large numbers of similar cases. 这次审判能为处理大量类似案例开创重要的先例。/ There is no obvious precedent for this law. 该法律没有明显的先例。/ Many precedents can be found for this decision. 这一裁定可以找到许多判例。/ The ruling does not set a binding precedent. 该判决不能成为具有约束力的先例。/ This would have set a dangerous new precedent. 这将可能创下一项新的危险的先例。/ This lowering of standards sets a dangerous precedent for future developments. 这次标准的降低为将来的发展开了危险的先例。/ There is a strong precedent for such a strategy. 有先例有力地说明这一战略可行。/ There is ample precedent for this tactic. 这种战术有过大量先例。<span class="definition">2 [C, U] 先前发生过的事件：</span>historical precedents 历史前例 / There is no precedent for a disaster of this scale. 这种规模的灾难是空前的。/ Such protests are without precedent in recent history. 这类抗议事件在近代史上没有发生过。/ There are plenty of precedents in Hollywood for letting people out of contracts. 在好莱坞，允许影视人员解除合同的先例有很多。</p>
<p><span class="vocabulary"><strong>model</strong></span> ['mɒdl]
<span class="definition">n. 1 [C] 对于一个体系的简单描述（用于解释事物的运行原理或推测将要发生什么等）：</span>conceptual, experimental, statistical, theoretical model 概念模型；实验模型；统计学模型；理论模型 / business, economic, mathematical, medical, political model 商业模型；经济模型；数学模型；医疗模式；政治模式 / an accounting model 会计核算模式 / an alternative model of married life 婚姻生活的另一种模式 <span class="definition">2 [C] 可被其他人仿效的某事物（如一种体制）：</span>The nation’s constitution provided a model that other countries followed. 该国的宪法成了别国仿效的范例。/ Successful schools must be used as models for the rest. 其他学校须效仿成功的学校。<span class="definition">3 [C] [褒] 作为一个杰出范例或典范的一个人或事物：</span>model citizen 模范公民 / model farm 示范农场 / She was a model of restraint. 她极有克制力，堪称典范。</p>
<p><span class="vocabulary"><strong>mould</strong></span> [məʊld; 美 moʊld]
<span class="definition">n. [C, usually sing.]（性格、态度、行为或生活方式的）模式，类型：</span>a hero in the ‘Superman’ mould “超人”型的英雄 / He is cast in a different mould from his predecessor. 他和他的前任性格不一样。/ She is clearly from a different mould from her team mate. 她与队友显然不属一类。/ He doesn't fit into the usual mould of bosses. 他跟一般的老板不一样。/ His brother came from a different mould, being a successful lawyer. 他的兄弟不一样，是一个成功的律师。/ She doesn't fit (into) the traditional mould of an academic. 她不像一个传统的学者。/ At first sight, Joe Pesci is not exactly cast in the leading man mould. 第一眼看上去，乔·佩希并不是当领袖的料。/ He was from the same mould as the men she had gazed at worshipfully when a child: rich, handsome, of impeccable social standing. 他富有、英俊，有无可挑剔的社会地位，是她孩提时就仰慕的那种男人。/ a young politician in the mould of the great statesmen of the past 颇具昔日伟大政治家风范的年轻政治家 / Breaking the traditional mould of local politics is not going to be easy. 打破地方政治的传统模式并非易事。</p>
<p><span class="vocabulary"><strong>lead</strong></span> [li:d]
<span class="definition">n. [sing.] 实例；范例；人们行动的榜样：</span>If one bank raises interest rates, all the others will follow their lead. 要是有一家银行提高利率，所有其他银行都会效法。/ You go first, I’ll take my lead from you. 你领头，我来照样做。/ moral lead（尤英）道德榜样 / The government should give a lead in tackling racism. 政府应该带头破除种族偏见。</p>
<p><span class="vocabulary"><strong>prototype</strong></span> [ˈprəʊtətaɪp; 美 ˈproʊ-]
<span class="definition">n. [C]（人或事物的）模范、典型：</span>He was the prototype of the elder statesman. 他是老一辈政治家的典型。</p>
<p><span class="vocabulary"><strong>classic</strong></span> ['klæsɪk]
<span class="definition">n. [C] 最优秀的、可作为典范的事物：</span>a classic of mutual trust 互信的典范 / The match was a classic. 那场比赛堪称经典。</p>
<p><span class="vocabulary"><strong>archetype</strong></span> [ˈɑ:kitaɪp]
<span class="definition">n. [C]（某个人或事物的）完美典型：</span>She is the archetype of an American movie star. 她是典型的美国影星。/ He came to this country 20 years ago and is the archetype of the successful Asian businessman. 他20年前来到这个国家，是成功亚裔商人的典范。</p>
<p><span class="vocabulary"><strong>pattern</strong></span> ['pætn]
<span class="definition">n. [usually sing.] 可供效仿的一个杰出典范：</span>This system sets the pattern for others to follow. 这个系统堪为他人仿效的典范。</p>
<p><span class="vocabulary"><strong>monument</strong></span> ['mɒnjumənt]
<span class="definition">n. [C] monument to sth 被视为典范的（某人的）品质或事迹：</span>This book is a monument to his talent as a philosopher. 这部著作是展现他哲学家才华的不朽之作。</p>
<p><span class="vocabulary"><strong>advertisement</strong></span> [əd'və:tɪsmənt]
<span class="definition">n. [C] advertisement for sth 展现某事物良好品质的一个例子，英式英语也用advert：</span>Dirty streets and homelessness are no advertisement for a prosperous society. 肮脏的街道和无家可归现象绝不是繁荣社会的景象。</p>
<p><span class="vocabulary"><strong>beauty</strong></span> ['bju:tɪ]
<span class="definition">n. [C]（同类中）出色的典型，极好的榜样或例子：</span>That last goal was a beauty! 最后进的一球真绝！</p>
<p><span class="vocabulary"><strong>soul</strong></span> [səʊl]
<span class="definition">n. [sing.] the soul of sth（一种良好品质的）完美典范或化身：</span>He is the soul of discretion. 他是谨慎的典范。</p>
<p><span class="vocabulary"><strong>study</strong></span> ['stʌdɪ]
<span class="definition">n. [sing.] [正式] study (in sth) 典型，范例：</span>Her face was a study of sadness. 她脸上完全是一副忧伤的表情。</p>
<p><span class="vocabulary"><strong>triumph</strong></span> [ˈtraɪʌmf]
<span class="definition">n. [sing.] a ~ (of sth) 成功的典范、楷模：</span>Her arrest was a triumph of international cooperation. 她的被捕是国际合作的成果。</p>
<p><span class="vocabulary"><strong>beacon</strong></span> [ˈbi:kən]
<span class="definition">n. [C] 对别人其激励作用的楷模：</span>He was a beacon of hope for the younger generation. 他是年轻一代的希望之灯。/ Our Parliament has been a beacon of hope to the peoples of Europe. 我们的国会一直是欧洲各族人民的希望之灯。/ General Rudnicki was a moral beacon for many exiled Poles. 鲁德尼茨基将军是众多被放逐的波兰人精神上的引路人。</p>
<p><span class="vocabulary"><strong>excuse</strong></span> [ɪk'skju:z]
<span class="definition">n. [C] 某事物的一个拙劣的样本，糟糕的例子：</span>Why get involved with that pathetic excuse for a human being? 为什么要与那个讨厌的家伙混在一起？/ She’s a pitiful excuse for an actress. 她是一个蹩脚的女演员。/ a sorry excuse for a man 差劲的男人</p>
<p><span class="vocabulary"><strong>exemplify</strong></span> [ɪgˈzemplɪfaɪ]
<span class="definition">vt. [常用被动式] [正式] 是…的典型（或典范、榜样）：</span>Her early work is exemplified in her book, ‘A Study of Children's Minds’. 她的《儿童思维研究》一书是她早期的代表作。/ His food exemplifies Italian cooking at its best. 他的菜肴代表了意大利烹饪的最高峰。/ The room's style exemplifies Conran's ideal of 'beauty and practicality'. 那个房间的风格是体现康兰“美观和实用”观念的典范。/ the emotional expressiveness of modern dance as exemplified by the work of Martha Graham 以玛莎·格雷厄姆的作品为代表的现代舞的情感表现力</p>
<p>周边词汇补充：
· pillar可指富有某种素质的人；某种素质的化身。</p>
<p>☀ <span class="category"><strong>例子、典范、榜样的形容词：</strong></span>
<span class="vocabulary"><strong>prize</strong></span> [praɪz]
<span class="definition">adj.（同类中）可作为一个极好的典范的：</span>a prize student 模范学生 / He’s a prize specimen of the human race! 他是人中楷模！/ He’s a prize idiot.（非正式用法）他是个十足的蠢猪。</p>
<p><span class="vocabulary"><strong>textbook</strong></span> ['tekstbʊk]
<span class="definition">adj. 只作前置定语，（用以强调…）可以用来做范例的，即标准的，典型的，规范的：</span>a textbook example of modern architecture 现代建筑的典范</p>
<p>☀ <span class="category"><strong>列举、例如：</strong></span>
<span class="vocabulary"><strong>recite</strong></span> [rɪ'saɪt]
<span class="definition">vt. recite sth (to sb) 以口头的形式大声逐一列举，逐一讲述：</span>to recite a list of his failings 逐一说出他的过失 / to recite a list of some famous artists 逐一列举一些知名画家 / to recite all advantages of the new product 逐一列举该款新产品的各种优点</p>
<p><span class="vocabulary"><strong>recital</strong></span> [rɪˈsaɪtl]
<span class="definition">n. [C]（口述）逐一列举：</span>了解即可</p>
<p><span class="vocabulary"><strong>enumerate</strong></span> [ɪˈnju:məreɪt; 美 ɪˈnu:-]
<span class="definition">vt. [正式] 列举、枚举：</span>I enumerate the work that will have to be done. 我列举了必须得做的一些工作。</p>
<p><span class="vocabulary"><strong>exemplify</strong></span> [ɪgˈzemplɪfaɪ]
<span class="definition">vt. [常用被动式] [正式] 举例说明：</span>She exemplified each of the points she was making with an amusing anecdote. 她的每一个论点都用一个逸闻趣事来说明。</p>
<p><span class="vocabulary"><strong>quote</strong></span> [kwəʊt; 美 kwoʊt]
<span class="definition">vt. 举例说明：</span>Can you quote me an instance of when this happened? 你能否给我举例说明一下这事发生的时间？/ an example that is often quoted as evidence of mismanagement 常常作为管理不盖的证据加以引述的例子 / Don't quote me on this but I think the figure is in excess of £2 billion. 我的话不足为据，但我认为这个数字超过20亿英锌。/ the most widely quoted and influential study in this field 该领域里引证最广、最有影响的研究</p>
<p><span class="vocabulary"><strong>cite</strong></span> [saɪt]
<span class="definition">vt. [正式] ~ sth (as sth) 提及某事作为例子：</span>He cites just one example. 他只引用了一个例子。/ This is similar to the example cited above. 这和上面所举的例子类似。/ He cited the fall in unemployment as one of the government's successes. 他举出失业人数下降作为政府的一项功绩。</p>
<p><span class="vocabulary"><strong>instance</strong></span> [ˈɪnstəns]
<span class="definition">vt. [正式] 举…为例：</span>了解即可</p>
<p><span class="vocabulary"><strong>like</strong></span> [laɪk]
<span class="definition">prep. 1 例如，譬如：</span>large cities like New York 诸如纽约这样的大城市 <span class="definition">2 用于表示符合某人的特点（或其通常做法等）：</span>It’s just like her to tell everyone about it. 她就是这么个人儿，能把这事儿见谁就告诉谁。</p>
<p>相关词义延伸：
· case还可指病人或伤员的病例；
· classic还可指（电影、著作、音乐等的）经典作品，即杰作、名著（也可专门用于表示文学名著）；
· model还可指时装模特儿。也可指受雇供艺术家（如画家、摄影师）进行创作的一个人，即艺术模特儿。</p>
<p>周边词汇补充：
· bible可指某一主题的（经常被人引用的）权威著作。</p>
<p>· 表示“代表”、“典型”的词群见[[04代表 典型]]
· 表示“杰出”、“优秀”的词群见[[01好坏]]
· 表示“正常”的词群见[[02正常 异常]]</p>
<p>☀ <span class="category"><strong>模型、模式的名词和动词：</strong></span>
<span class="vocabulary"><strong>model</strong></span> ['mɒdl]
...
· specimen还可指具有…特性的人，某类人的典型。</p>
<p>周边词汇补充：
· proof可指打印或复印出来需要校对的文字材料，即校样；
· look可指式样；
· figure可指冰上表演的一系列动作或花样；
· style可指某种设计的款式、样式；
· demonstrator可指（商品中的）样品、试用品。</p>
<p>· 表示“风格”的词群见[[03风格 流行]]
· 表示“作风”的词群见[[04方法 方式]]</p>
<p>☀ <span class="category"><strong>抽样、采样的动词：</strong></span>
<span class="vocabulary"><strong>sample</strong></span> [ˈsɑ:mpl; 美 ˈsæmpl]
<span class="definition">vt. [术语] 抽样、取样、采样（以进行调查研究）：</span>12% of the children sampled said they prefer cats to dogs. 在被抽样调查的孩子中，12%说他们喜欢猫胜过喜欢狗。/ The survey was done using a group of 100 children randomly sampled from the school population. 调查对象是从全校学生中随机选取的100名孩子。</p>
<p>相关词义延伸：
· sample还可指少量品尝食物。也可指短暂体验某事（以便对此事有个大致了解）。亦可指节录、选录（一段音乐或声音，用于新的乐曲中）。</p>
<p>周边词汇补充：
· proof可指印…的校样。</p>
</div></template>
