<template><div><p>☀ <span class="category"><strong>道义上应该：</strong></span>
<span class="vocabulary"><strong>should</strong></span> [ʃʊd]
...
<p><span class="vocabulary"><strong>ought</strong></span> [ɔ:t]
<span class="definition">modal verb. 1 ought to 用于说明做某事是对的，如应该、应当：</span>Mark, you’ve got a good wife. You ought to take care of her. 马克，你娶了个好妻子，应该好好待她。<span class="definition">2 ought to 用于表明你所期望发生的事，如应该：</span>Nurses ought to earn more. 护士的薪资应该多一点。<span class="definition">3 ought to 用于提出你的忠告、建议或推荐，如应该：</span>You don’t have to be alone with him and I don’t think you ought to be. 你不必单独跟他呆在一起，而且我认为你也不该这样。/ You ought to ask a lawyer’s advice. 你应当征求一下律师的意见。</p>
<p><span class="vocabulary"><strong>might</strong></span> [maɪt]
<span class="definition">modal verb. 用于表示对某人可以做（或本可以做）而未做某事表示生气或不满，即本应该：</span>I think you might at least offer to help! 我认为你至少应该主动提出帮忙吧！/ You might have told me that before! 你以前就该告诉我这件事！</p>
<p><span class="vocabulary"><strong>want</strong></span> [wɒnt]
<span class="definition">vi. [非正式] 用于向某人提出建议，意为应该：</span>If possible, you want to avoid alcohol. 你应尽可能避免饮酒。/ He wants to be more careful. 他应多加小心。/ You don’t want to do it like that. 你不应该那样做。</p>
<p><span class="vocabulary"><strong>be</strong></span> [bi:]
<span class="definition">auxiliary verb. be to do sth 用于表明必须（或应该）做的事：</span>You are to report this to the police. 你应该报警。/ What is to be done about this problem? 该如何处理这个问题？</p>
<p>周边词汇补充：
· must可用于推荐某人去做某事（因为你认为这是一个好主意），即应该、得。</p>
<p>☀ <span class="category"><strong>概率上应该：</strong></span>
<span class="vocabulary"><strong>should</strong></span> [ʃʊd]
