...
<p><span class="vocabulary"><strong>consolidate</strong></span> [kənˈsɒlɪdeɪt; 美 -ˈsɑ:l-]
<span class="definition">vt.&amp;vi. [术语]（使）事物结成一体，如合并：</span>The two companies consolidated for greater efficiency. 为提高效率，这两家公司已合并。/ Judge Charles Schwartz is giving the state 60 days to disband and consolidate Louisiana's four higher education boards. 查尔斯·施瓦茨法官将给路易斯安那州60天时间来解散然后合并该州的4个高等教育委员会。/ IBM, which consolidated some operations last summer, has made clear that it needs to continue to streamline them. 去年夏天合并了部分业务的IBM公司明确表示需要继续进行精简，以提高效率。/ All the debts have been consolidated. 所有债项均已合并。/ consolidated accounts 合并账目</p>
<p><span class="vocabulary"><strong>connect</strong></span> [kə'nekt]
<span class="definition">vt.＆vi. connect A to/with B / connect A and B 将两个或多个地点或事物连接（或联结）起来；被连接（或被联结）到一起：</span>The towns are connected by train and bus services. 这些城镇由火车和公共汽车连接起来。/ a connecting door (= one that connects two rooms) 连通两间房的一道门 / A corridor connects his office with the main building. 一条走廊把他的办公室同主楼连在一起。/ Downstairs toilets were connected directly to the drains. 楼下的马桶直接同下水道连在一起。<span class="definition">vt. connect sth (to sth) 将…连接到水、电、气等的主要供应设备上，或将其连接到其他设备上：</span>First connect the printer to the computer. 首先把打印机与计算机连接起来。/ Connect the machine to the power supply. 把机器连接到电源上。</p>
<p><span class="vocabulary"><strong>link</strong></span> [lɪŋk]
<span class="definition">vt. link A to/with B / link A and B (together) 常用被动式，在两个物体、机器、地点等之间建立物理联系或电子联系，相当于connect：</span>The video cameras are linked to a powerful computer. 这些摄像机是与一台功能强大的计算机相连接的。/ The computers are linked into a network. 这些计算机是联网的。/ The two spacecraft will link up in orbit. 两艘宇宙飞船将于轨道上对接。/ The Channel Tunnel links Britain with the rest of Europe. 英吉利海峡隧道把英国和欧洲其他国家连接起来了。/ the road that links Cairo with Alexandria 连接开罗和亚历山大的公路</p>
<p><span class="vocabulary"><strong>join</strong></span> [dӡɒɪn]
<span class="definition">vt.＆vi. 1 将两个或多个事物固定（或连接）在一起：</span>Join the two sections of pipe together. 将这两段管子连接在一起。/ The island is joined to the mainland by a bridge. 这个岛有一座桥与大陆相连。/ How do these two pieces join? 这两件东西怎样接合呢？/ Draw a line joining (up) all the crosses. 画条线将所有的十字连接起来。<span class="definition">2 两个事物或群体结合到一起（或一个事物或群体加入另一个事物或群体）以形成一个事物或群体，如结合、联合、汇合：</span>the place where the two paths join 两条小路汇合的地方</p>
<p><span class="vocabulary"><strong>meet</strong></span> [mi:t]
<span class="definition">vt.＆vi. 连接，（尤指两片地域或海域）相接：</span>That’s where the river meets the sea. 这条河就在这里流入大海。/ The curtains don’t meet in the middle. 这窗帘中间合不拢。</p>
<p><span class="vocabulary"><strong>attach</strong></span> [ə'tætʃ]
<span class="definition">vt.＆vi. [正式] attach to sb/sth 与某人或某事物有联系；把某事物与另一事物关联起来：</span>No one is suggesting that any health risks attach to this product. 没有人指出这款产品可能会危害健康。/ This does not attach any blame to you. 这事你一点责任也没有。</p>
<p><span class="vocabulary"><strong>bond</strong></span> [bɒnd]
<span class="definition">vt.＆vi. bond (A and B) (together) / bond (A) to B 使牢固地结合，把…紧紧地连接到…上：</span>This new glue bonds a variety of surfaces in seconds. 这种新型胶水可迅速粘牢各种表面。/ The atoms bond together to form a molecule. 原子结合形成分子。</p>
<p><span class="vocabulary"><strong>bind</strong></span> [baɪnd]
<span class="definition">vt. ~ A and B (together) / ~ A to B 将人员、组织机构等联合在一起（使其更好或更有效地生活或工作）：</span>Organizations such as schools and clubs bind a community together. 诸如学校、俱乐部等机构使社区成为一个整体。/ It is the memory and threat of persecution that binds them together. 遭受迫害的记忆和威胁把他们紧紧联系在一起。/ the social and political ties that bind the USA to Britain 将美国和英国紧紧相连的社会和政治纽带 / She thought that having his child would bind him to her forever. 她以为生了他的孩子就会永远把他留住。<span class="definition">vt.（化学物质或粒子）结合：</span>At present nobody understands why these three quarks which are in the proton are bound together. 目前还没有人知道质子里面的这三个夸克为什么会结合在一起。/ These may bind to receptor molecules on the surfaces of cells. 这些可能会在细胞表面和受体分子结合在一起。</p>
<p><span class="vocabulary"><strong>bridge</strong></span> [brɪdӡ]
<span class="definition">vt. 拥有两种极为不同的事物的一些共同品质，即结合（极为不同的两者）：</span>a therapy bridging the gap between traditional Chinese medicine and Western medicine 结合了传统中医和西医的一种疗法</p>
<p><span class="vocabulary"><strong>touch</strong></span> [tʌtʃ]
<span class="definition">vt.＆vi.（两个或两个以上的东西、表面等之间）没有间隙，即接触；触及：</span>Make sure the wires don’t touch. 一定不要让金属电线搭在一起。/ Don’t let your coat touch the wet paint. 你的外衣别蹭着还没干的油漆。/ Their faces were almost touching. 他们的脸几乎碰到一块儿了。/ A cyclist crashed when he touched wheels with another rider. 一名骑车人同另一名骑车人车轮相碰而摔倒。</p>
<p><span class="vocabulary"><strong>absorb</strong></span> [əb'zɔ:b; -sɔ:b]
<span class="definition">vt. 常用被动式，使（小事物）并入到（大事物）：</span>to absorb the influx of refugees 接纳涌入的难民 / This town has been absorbed into the city. 这个镇子已被并入了城市。/ These committees were absorbed into the local government machine. 这些委员会被并入到当地的政府机构中。</p>
<p><span class="vocabulary"><strong>lead</strong></span> [li:d]
<span class="definition">vi. lead from/to sth (to/from sth) 连接（两个物体或地方）：</span>the pipe leading from the top of the water tank 与水箱顶部相通的管道 / The wire led to a speaker. 这根电线连接着扬声器。</p>
<p><span class="vocabulary"><strong>articulate</strong></span> [ɑ:ˈtɪkjuleɪt; 美 ɑ:rˈt-]
<span class="definition">vi. ~ (with sth) [正式] 与另一者合成一个整体：</span>These courses are designed to articulate with university degrees. 这些课程旨在与大学学位接轨。<span class="definition">vt.&amp;vi. [术语] ~ (with sth) 用关节连接（从而能够移动）：</span>bones that articulate with others 与其他骨骼以关节相连的骨骼 / a robot with articulated limbs 关节型四肢机器人</p>
<p><span class="vocabulary"><strong>communicate</strong></span> [kə'mju:nɪkeɪt]
<span class="definition">vi. 两个房间相互挨着，且能从一个进入到另一个，即相连通：</span>a communicating door (= one that connects two rooms) 连通门</p>
<p><span class="vocabulary"><strong>string</strong></span> [strɪŋ]
<span class="definition">vt. 用线或细绳等把一系列小物体连（或串）在一起，相当于thread：</span>She had strung the shells on a silver chain. 她把贝壳串在一条银链子上。/ carbon atoms strung together to form giant molecules（比喻用法）连在一起构成巨分子的碳原子</p>
<p><span class="vocabulary"><strong>thread</strong></span> [θred]
<span class="definition">vt. 用长或细的东西把两个或更多物品串在一起，穿成串：</span>to thread beads (onto a string) （在绳子上）把珠子串起来</p>
<p><span class="vocabulary"><strong>wire</strong></span> ['waɪə]
<span class="definition">vt. 1 wire sb/sth up (to sth) / wire sb/sth to sth 将（某人或某事物）连接到一件设备上（尤指连接到磁带录音机、计算机系统等设备上）：</span>He was wired up to a police tape recorder. 他被连接到了警方的录音机上。/ She was wired up to a heart monitor. 她身上连着一个心脏监护仪。<span class="definition">2 用金属丝把…连在一起：</span>了解即可</p>
<p><span class="vocabulary"><strong>twin</strong></span> [twɪn]
<span class="definition">vt. 1 twin sth (with sth) 常用被动式，在两个城镇（或地区）之间建立紧密关系：</span>Oxford is twinned with Bonn in Germany. 牛津和德国的波恩结成了友好城市。<span class="definition">2 twin sth (with sth) 将两个人（或两个事物）紧密结合在一起：</span>The opera twins the themes of love and death. 这出歌剧把爱情与死亡的主题紧密结合在一起。</p>
<p><span class="vocabulary"><strong>couple</strong></span> ['kʌpl]
<span class="definition">vt. couple A (to B) / couple A and B together 常用被动式，把某事物的两个部分（如车辆或设备）连接起来：</span>The two train cars had been coupled together. 两节火车车厢已经挂上钩了。/ a problem that is coupled with poverty 一个与贫困相联系的问题</p>
<p><span class="vocabulary"><strong>pair</strong></span> [peə]
<span class="definition">vt. pair A with B / pair A and B (together) 常用被动式，指把两个人（或事物）配对，使成对：</span>All the shoes on the floor were neatly paired. 地板上的鞋子都整齐成双地摆着。/ The trainees will then be paired with experienced managers. 这些实习生之后将被配给有经验的经理们。</p>
<p><span class="vocabulary"><strong>marry</strong></span> ['mærɪ]
<span class="definition">vt. [正式] marry sth and/to/with sth 使两个不同的事物、观点等成功地结合，相当于unite：</span>The music business marries art and commerce. 音乐行当将艺术和商业结合在一起。</p>
<p><span class="vocabulary"><strong>conspire</strong></span> [kənˈspaɪə(r)]
<span class="definition">vi. ~ against sb/sth / ~ to do sth（事件）似乎共同导致不良后果：</span>Circumstances had conspired against them. 各种情况都凑在一起和他们作对。/ Everything conspired to make her life a misery. 她命运多舛，生活悲惨。/ History and geography have conspired to bring Greece to a moment of decision. 历史和地理因素共同将希腊推至做出抉择的紧要关头。/ But fateful forces beyond the band's control were to conspire against them. 然而，乐队无力控制的各种决定性力量将会对他们造成不利的影响。</p>
<p><span class="vocabulary"><strong>engage</strong></span> [ɪnˈgeɪdʒ]
<span class="definition">vt.&amp;vi. ~ (with sth)（使）机器零件相衔接或相啮合：</span>One cogwheel engages with the next. 齿轮一个个啮合在一起。/ The cogwheels are not engaging. 齿轮未啮合在一起。/ Engage the clutch before selecting a gear. 先踩离合器再挂挡。/ Press the lever until you hear the catch engage. 压下挡杆，直到听到挡挂好。/ a lesson in how to engage the four-wheel drive 如何使四轮驱动啮合的课程</p>
<p>相关词义延伸：
· bind还可指（使）粘合，凝结。</p>
<p>周边词汇补充：
· annex可指（用武力）吞并、占领（一个国家、地区等）；
· assimilate可指（一个国家、群体）将一个人同化；
· dock可指（使）两个宇宙飞船在太空对接。也可指将电脑连接到扩展坞。</p>
<p>☀ <span class="category"><strong>结合、连接的名词：</strong></span>
<span class="vocabulary"><strong>integration</strong></span> [ˌɪntɪˈgreɪʃn]
<span class="definition">n. 1 [U, C]（为使两者或两者以上的事物协同工作而对其进行的）整合、结合、一体化：</span>economic, monetary, political integration 经济一体化；货币一体化；政治一体化 / economic integration within the three communities 三个团体之间的经济一体化 / We are working to bring about closer political integration in the EU. 我们正致力于实现欧盟内部更加紧密的政治一体化。/ market integration 市场一体化 / a milestone in the process of European integration 欧洲一体化进程中的一座里程碑 / policies designed to promote global economic integration 旨在促进全球经济一体化的政策 / systems integration（计算机用语）系统整合 / integration between research and higher education 科研与高等教育之间的融合 / His music is an integration of tradition and new technology. 他的音乐结合了传统和新技术。<span class="definition">2 [U]（不同肤色、种族、宗教信仰等的人的）融合：</span>social integration 社会融合 / racial integration in schools 学校招收不同种族的学生 / measures to promote the social integration of mentally handicapped people 为帮助智障人士融入社会而采取的措施 / the integration of disabled students into the general education system 残疾学生融入普通教育系统 / He called for greater integration with Europe. 他呼吁与欧洲进行更大程度的融合。/ a move towards/toward greater internal integration in Europe 促进欧洲内部更紧密融合的举措</p>
<p><span class="vocabulary"><strong>combination</strong></span> [ˌkɒmbɪˈneɪʃn; 美 ˌkɑ:m-]
<span class="definition">n. 1 [U] 将两个或两个以上的事物结合或混合以形成一个整体的行为，即结合；联合：</span>the combination of science and art 科学与艺术的结合 / The firm is working on a new product in combination with several overseas partners. 这家公司与几家海外合伙人在联合开发新产品。<span class="definition">2 [C] 结合体；联合体：混合体：</span>His treatment was a combination of surgery, radiation and drugs. 对他的治疗是把手术、放射和药物治疗结合为一体。/ Technology and good management. That's a winning combination (= one that will certainly be successful). 技术加良好的管理，这是取胜的组合。/ The band played with a winning combination of gusto and precision乐队在演泰激情与精确性之间达到了水乳交融的境界。/ High debt and low earnings are a lethal combination. 高债务和低收入是致命的组合。/ an unusual colour/color combination 不同寻常的色彩组合 <span class="definition">3 [C]（用于开密码锁的）数字组合或字母组合：</span>I can't remember the combination. 我不记得密码锁的数码组合了。</p>
<p><span class="vocabulary"><strong>merger</strong></span> [ˈmɜ:dʒə(r); 美 ˈmɜ:rdʒ-]
<span class="definition">n. [C] ~ (between/of A and B) / ~ (with sth)（组织机构或公司企业的）合并：</span>a merger between Dynron and Energee 戴伦与埃纳杰两家企业的合并 / a merger between the two banks 两家银行的合并 / a merger between two of Britain's biggest trades unions 英国两个最大的工会的合并 our proposed merger with the university 我们与这所大学提议中的合并 / company, corporate merger 公司合并 / There has been a furry of corporate mergers and acquisitions. 近来刮起一阵公司合并和并购风潮。/ airline, bank, media merger 航空公司的合并；银行的合并；媒体的合并 / They threatened legal action to block the merger. 他们威胁说要采取法律行动来阻止合并。/ If the merger goes through, thousands of jobs will be lost. 如果合并得以完成，将会失去数千工作岗位。/ merger activity 合并行动 / merger plan, merger proposal 合并计划；合并提案 / merger discussions, merger negotiations, merger talks 合并谈判 / merger agreement, merger deal 合并协议 / merger announcement 合并公告 / They completed a merger with Monsanto. 他们完成了与孟山都公司的合并。</p>
<p><span class="vocabulary"><strong>connection</strong></span> [kə'nekʃən]
<span class="definition">n. 1 [U, C] connection (to sth)（行为意义上的）连接；（状态意义上的）处于被连接的状态：</span>Connection to the gas supply was delayed for three days. 接通煤气延迟了三天。<span class="definition">2 [C] 将两个部分连接起来的一个点，即连接点，尤指电力系统中的接头：</span>phone, mobile connection 电话接头；移动通信连接 / broadband, cable, Internet, wireless connection 宽带连接；电缆连接；互联网连接；无线连接 / If you break the connection, the light won’t come on. 如果断开连接，灯就不亮了。</p>
<p><span class="vocabulary"><strong>joint</strong></span> [dʒɔɪnt]
<span class="definition">n. [C] 一个物体的（尤指构成角的）接合处、接头（可以将两个或多个部分连接起来）：</span>watertight joint 水密接缝 / a joint between two lengths of copper 两段铜管之间的接缝</p>
<p><span class="vocabulary"><strong>attachment</strong></span> [əˈtætʃmənt]
<span class="definition">n. [U, C] 连接；连接物：</span>All cars built since 1981 have points for the attachment of safety restraints. 自1981年起生产的轿车都有安装安全保护装置的接头。/ They discussed the attachment of new conditions to the peace plans. 他们讨论把新条件加入到和平计划中去。/ They had to check the strength of the seat attachments to the floor of the plane. 他们需要检查座椅与飞机舱面固定接头的强度。</p>
<p><span class="vocabulary"><strong>bridge</strong></span> [brɪdӡ]
<span class="definition">n. [C] 在两个不同的事物之间起联系作用的一个事物，即桥梁、纽带：</span>a bridge between Occidental and Oriental culture 联结东西方文化的桥梁 / to build a bridge between doctor and patient 在医生和病人之间建立一条联系纽带</p>
<p><span class="vocabulary"><strong>identification</strong></span> [aɪ͵dentɪfɪ'keɪʃn]
<span class="definition">n. [U, C] identification (of sb) (with sb/sth) 在不同的人（或事物）之间建立紧密联系的过程，即密切联系：</span>the voters’ identification of the Democrats with high taxes 选民把民主党和高税收画上等号</p>
<p><span class="vocabulary"><strong>bond</strong></span> [bɒnd]
<span class="definition">n. [C] 两个事物结合在一起的方式，即结合，连接：</span>a firm bond between the two surfaces 两个面之间的牢固接合</p>
<p><span class="vocabulary"><strong>coalition</strong></span> [ˌkəʊəˈlɪʃn; 美 ˌkoʊə-]
<span class="definition">n. [U] 两个或多个团体的联合、结合：</span>They didn't rule out coalition with the Social Democrats. 他们不排除与社会民主党人结盟的可能性。</p>
<p><span class="vocabulary"><strong>federation</strong></span> [ˌfedəˈreɪʃn]
<span class="definition">n. [U] 结成联合会：</span>了解即可</p>
<p><span class="vocabulary"><strong>reunion</strong></span> [ri:ˈju:niən]
<span class="definition">n. [U] 重新成为一个群体（或组织机构），如重新结合、再度联合：</span>the reunion of the Church of England with the Church of Rome 英格兰圣公会和罗马天主教的再度联合 / reunion album, reunion concert, reunion show, reunion tour 重组专辑；重聚音乐会；重聚演出；重聚巡演 / reunion movie（美）（电视剧停播后原班人马的）电影版制作</p>
<p><span class="vocabulary"><strong>join</strong></span> [dӡɒɪn]
<span class="definition">n. [C] 两个事物被固定在一起的一个点，即连接点、连接处：</span>The two pieces were stuck together so well that you could hardly see the join. 这两块粘合得太好了，几乎看不出接缝。</p>
<p><span class="vocabulary"><strong>junction</strong></span> [ˈdʒʌŋkʃn]
<span class="definition">n. [C] 两条或多条电缆、河流或其它事物的接合点：</span>a telephone junction box 电话分线盒</p>
<p>相关词义延伸：
· coalition还可指两党或多党所形成的一个联合政府；
· reunion还可指（一群人，如家庭、学校及其他团体成员的久别之后的）重逢、团聚、聚会（是一种场合）。也可指（人们分开一段时间后的）相聚、团聚（是一种行为）；
· joint还可指关节。</p>
<p>☀ <span class="category"><strong>结合、连接、联合、联手的其它词性：</strong></span>
<span class="vocabulary"><strong>together</strong></span> [tə'ɡeðə]
<span class="definition">adv. 以使两个或多个事物相接触或相结合，如到一起：</span>He rubbed his hands together in satisfaction. 他满意地擦搓着双手。/ She nailed the two boards together. 她把两块木板钉在了一起。/ Mix the sand and cement together. 把沙子和水泥混合在一起。/ Taken together, these factors are highly significant. 这些因素综合起来看就很重要了。/ He has more money than the rest of us put together. 他的钱比我们所有人的加在一起还多。/ Get all the ingredients together before you start cooking. 把所有的材料放在一起再开始烹饪。</p>
<p><span class="vocabulary"><strong>joint</strong></span> [dʒɔɪnt]
<span class="definition">adj. [只用于名词前]（两人或两个以上的人）联合的、共同的：</span>a joint account (= a bank account in the name of more than one person, for example a husband and wife) 联合账户 / She and Frank had never gotten around to opening a joint account. 她和弗兰克还没有抽出时间去开联名账户。/ Jackie and Ben came to a joint decision as to where they would live. 关于他们将住哪里是杰姬和本共同决定的。/ The report was a joint effort (= we worked on it together). 这个报告是大家共同努力的结果。/ They finished in joint first place. 他们获得并列第一。/ They were joint owners of the house (= they owned it together). 他们共同拥有这栋房子。</p>
<p><span class="vocabulary"><strong>associate</strong></span> [ə'səʊʃɪeɪt]
<span class="definition">adj. 与某一专业领域（或职业、组织）联合的（或有关联的）：</span>an associate company in Japan 日本的一家联营公司</p>
<p><span class="vocabulary"><strong>attached</strong></span> [əˈtætʃt]
<span class="definition">adj. 连接到某事物上的：</span>Make sure all the wires remain firmly attached. 确保所有的电线都连接牢固。/ The ball was attached to a chain. 这个球连在一条链子上。</p>
<p><span class="vocabulary"><strong>allied</strong></span> [ˈælaɪd]
<span class="definition">adj.（经常用Allied）[只用于名词前]（国家、军队、政党等）同盟的、结盟的；（国与国协同作战）结盟的，联盟的；（第一次世界大战期间）协约国的；（第二次世界大战期间）同盟国的：</span>Italy joined the war on the Allied side in 1915. 1915年，意大利加入协约国参战。/ allied forces, allied troops 盟军；盟军部队 / They're backed by allied warplanes and tanks. 他们受到盟军战机和坦克的掩护。/ forces from three allied nations 来自三个同盟国的军队 / a think-tank allied to the right wing of the Democratic Party 与民主党右翼结盟的智囊团 / The US remains closely allied to Saudi Arabia. 美国与沙特阿拉伯的关系仍然很紧密。/ an offensive by seven loosely allied guerrilla groups 由七个关系松散的游击队组织发起的进攻 / The party is allied with the Communists. 该党与共产党人结成联盟。</p>
<p>相关词义延伸：
...
· web可指蜘蛛网；
· weld可指焊接。</p>
<p>· 表示“有关”的词群见[[01关系 涉及]]和[[03关于 有关]]
· 表示“共同”的词群见[[03共同 各自]]
