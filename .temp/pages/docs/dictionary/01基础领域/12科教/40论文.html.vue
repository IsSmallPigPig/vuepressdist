<template><div><p>☀ <span class="category"><strong>论文：</strong></span>
<span class="vocabulary"><strong>paper</strong></span> ['peɪpə]
<span class="definition">n. [C]（关于某一学科的）学术论文：</span>to publish a paper in the journal Nature 在《自然》杂志上发表一篇学术论文 / research, scientific, technical paper 研究论文；科学论文；技术论文 / scholarly paper 学术论文</p>
<p><span class="vocabulary"><strong>thesis</strong></span> [ˈθi:sɪs]
