...
<p><span class="vocabulary"><strong>index</strong></span> [ˈɪndeks]
<span class="definition">n. [C]（用以衡量…的一个）指标或量度：</span>The number of new houses being built is a good index of a country's prosperity. 新建房屋的数目是国家繁荣的一个有用指标。/ Weeds are an index to the character of the soil. 杂草是反映土壤特征的一个指标。/ The test results were used as an index of language proficiency. 考试结果被用作衡量语言水平的指标。</p>
<p><span class="vocabulary"><strong>proxy</strong></span> [ˈprɒksi; 美 ˈprɑ:ksi]
<span class="definition">n. [C] ~ for sth [术语]（测算用的）代替物，指标：</span>The number of patients on a doctor's list was seen as a good proxy for assessing how hard they work. 医生诊单上的病人数被看作是衡量他们工作努力程度的可靠指标。/ Price differences are used as a proxy for differences in quality. 一分钱一分货。</p>
<p><span class="vocabulary"><strong>canon</strong></span> [ˈkænən]
<span class="definition">n. [C] [正式] 广泛认可的标准、准则：</span>The very first canon of nursing is to keep the air inside as fresh as the air outside. 护理工作的首要原则是要保持室内空气像室外一样清新。</p>
<p><span class="vocabulary"><strong>principle</strong></span> ['prɪnsəpl]
<span class="definition">n. [C] 某事情、事物所基于的一条法则、规则或理论：</span>the basic principles of car maintenance 汽车保养的基本原则 / His novels reject chronology as an organizing principle. 他的小说放弃了以年代为序的布局原则。/ market, political principle 市场原则；政治原则 / the uncertainty principle 不确定性原则 / the principles and practice of writing reports 报告写作的理论与实践 / There are three fundamental principles of teamwork. 团队合作有三个基本原则。/ Discussing all these details will get us nowhere; we must get back to first principles. 一直谈这些细节不会有结果的；我们必须回到根本原则上来。/ I agree with you in principle, but we’ll need to discuss the details. 我原则上同意你的意见，但是我们需要讨论一下细节问题。</p>
<p><span class="vocabulary"><strong>law</strong></span> [lɔ:]
<span class="definition">n. [C] 机构（或活动）的规则：</span>the laws of the Church 教会的戒律 / The first law of kung fu is to defend yourself. 功夫的首要原则是自卫。/ the laws of cricket 板球规则</p>
<p><span class="vocabulary"><strong>rule</strong></span> [ru:l]
<span class="definition">n. [C] 基于某种体系（如一门科学或一门语言）而对可能情况做出的说明，即规则：</span>the rules of grammar 语法规则</p>
<p><span class="vocabulary"><strong>framework</strong></span> ['freɪmwə:k]
<span class="definition">n. [C] framework (of/for sth)（作为判断、决定等基础的）一系列信念、观点或准则：</span>The report provides a framework for further research. 报告提供了进一步研究的原则。</p>
<p><span class="vocabulary"><strong>policy</strong></span> ['pɒləsɪ]
<span class="definition">n. [C, U] 一个人在内心所遵从的原则或为人之道，是一种正式用法：</span>Honesty is the best policy.（谚语）诚实为上。/ She is following her usual policy of ignoring all offers of help. 她遵循着自己的一贯原则，对于他人的主动帮助一概不予理睬。</p>
<p><span class="vocabulary"><strong>absolute</strong></span> ['æbsəlu:t]
<span class="definition">n. [C] 被认为在任何条件下都属实或有效的一个想法或原理，可称为绝对真理：</span>Right and wrong are, for her, moral absolutes. 她认为，是与非是道德上的绝对准则。</p>
<p><span class="vocabulary"><strong>gospel</strong></span> [ˈgɒspl; 美 ˈgɑ:spl]
<span class="definition">n. [U] [非正式]（也可用gospel truth）绝对真理：</span>Is that gospel? 那是绝对真理吗？/ Don't take his word as gospel. 别把他的话当作绝对真理。/ The results were not to be taken as gospel. 别以为这些结果就一定是正确的。/ He wouldn't say this if it weren't the gospel truth. 要不是对此深信不疑，他不会说这样的话。</p>
<p>相关词义延伸：
...
· canon还可指某位作家的真作或精品；
· standard还可指被很多歌手所录制过的一首歌曲。</p>
<p>周边词汇补充：
· basis可指组织或安排事物的某种方式，即准则，基准，方式；
· fundamental可指基本规则、基本原则、基本原理；
· mainstream可指主流；
· decency的复数形式the decencies可指社会上为人们所接受的行为标准，如礼仪、行为准则；
· specification可指某事物的详细说明书（说明某事物如何被设计或制作），如规格。</p>
<p>☀ <span class="category"><strong>标准的形容词：</strong></span>
<span class="vocabulary"><strong>standard</strong></span> ['stændəd]
...
<p><span class="vocabulary"><strong>orthodox</strong></span> [ˈɔ:θədɒks; 美 ˈɔ:rθədɑ:ks]
...
<p>相关词义延伸：
· standard还可指（书籍或作者）为研究某一学科的大多数人所阅读的，即权威性的。也可指（拼写、发音、语法等）被认为是正确的并被大多数人所采用的，即标准的、规范的。</p>
<p>周边词汇补充：
· physical可指符合自然规律或法则的；
· regular可指形状均匀的，或形状端正整齐的。也可指标准尺寸的；中等大小的。还可指正规军的；亦可指（尤指动词或名词）按大多数形式的规则变化的，即规则的；
· mainstream可指主流的；
· provide可指（法律或规则）规定某事将发生或规定其必须发生，即规定。</p>
<p>· 表示“法律”、“规定”的词群见[[01法律 法规]]
