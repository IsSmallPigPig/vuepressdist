...
<p><span class="vocabulary"><strong>soluble</strong></span> [ˈsɒljəbl; 美 ˈsɑ:l-]
<span class="definition">adj. [正式]（一个问题）可解决的；可解的：</span>了解即可</p>
<p>相关词义延伸：
· solution还可指谜题或数学题的答案。</p>
<p>周边词汇补充：
· do可指找到…的答案（即解答）、解决某事；
· wrestle可指尝试（或努力）去处理（或解决）困难的事情（或问题）；
· outstanding可指（款项、工作、困难等）尚未支付的、尚未完成的、尚未解决的等；
· accommodation可指达成协议的过程。</p>
<p>· 表示“处理”的词群见[[02对待 处理]]
· 表示“采取”的词群见[[03应用 使用]]
· 表示“回答”、“回复”的词群见[[12回答 答复]]
· 表示“反应”、“回应”的词群见[[07反应 效果]]
· 表示“方法”的词群见[[04方法 方式]]
· 表示“成功”的词群见[[01成功 获胜]]</p>
</div></template>
