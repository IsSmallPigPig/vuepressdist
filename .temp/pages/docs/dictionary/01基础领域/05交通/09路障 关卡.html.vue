<template><div><p>☀ <span class="category"><strong>路障 关卡：</strong></span>
<span class="vocabulary"><strong>blockade</strong></span> [blɒˈkeɪd; 美 blɑ:ˈk-]
<span class="definition">n. [C] 阻止人员或车辆进出一个地方的一个障碍物，即路障：</span>The police set up blockades on highways leading out of the city. 警察在城市出口的公路上设下路障。</p>
...
<p><span class="vocabulary"><strong>barrier</strong></span> ['bærɪə]
<span class="definition">n. [C] 像栅栏一样，阻止人从一地运动到另一地的一个东西，即关卡、屏障、障碍物：</span>crash, safety（尤英）, security（英）barrier（公路的）防撞护栏；安全护栏 / There was a slow trickle of people through the barriers. 稀疏的人流缓慢地穿过关卡。/ Please show your ticket at the barrier.（英）请在检票口出示您的票。</p>
<p><span class="vocabulary"><strong>block</strong></span> [blɒk]
<span class="definition">n. [C, usually sing.] 使运动变得困难或不可能的事物，即阻碍、障碍物。与barrier词义极其相近。但barrier强调让通行纯粹变得不可能，而block除此之外还可指让通行虽然可以实现，但是很困难，即使通过也要付出极大代价，对通行主体造成极大的心理冲击和阻塞感：</span>了解即可</p>
...
<span class="definition">n. [C] 限速路墩：</span>road, speed, traffic hump (= a hump on a road that forces traffic to drive more slowly)（英）公路上的限速路墩</p>
<p>周边词汇补充：
· fence可指栅栏，围栏，篱笆。也可指（障碍赛马中的）障碍物。</p>
</div></template>
