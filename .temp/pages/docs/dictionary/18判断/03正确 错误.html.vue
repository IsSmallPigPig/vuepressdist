...
<p><span class="vocabulary"><strong>erroneous</strong></span> [ɪˈrəʊniəs; 美 ɪˈroʊ-]
<span class="definition">adj. [正式] 错误的；基于错误信息的：</span>erroneous assumptions 错误的假设 / They have arrived at some erroneous conclusions. 他们得出了一些错误的结论。/ erroneous idea 错误的想法 / erroneous impression 错误的印象 / erroneous interpretation 错误的解释 / erroneous belief 错信 / Some people have the erroneous notion that one can contract AIDS by giving blood. 一些人错误地认为献血会让人感染艾滋病。</p>
<p><span class="vocabulary"><strong>fallacious</strong></span> [fəˈleɪʃəs]
<span class="definition">adj. [正式]（思想、论据、道理）错误的（因其基于谬误）：</span>Their main argument is fallacious. 他们的主要论点是错误的。</p>
<p><span class="vocabulary"><strong>out</strong></span> [aʊt]
<span class="definition">adj. out (in sth)（计算、计量）不准确的：</span>Your guess was a long way out. 你的猜测完全错了。/ You were slightly out in your culculations. 你的计算出了点小错。/ The estimate was out by less than $30. 这个估计差了不到30美元。/ a few inches out 几英寸的误差</p>
<p>☀ <span class="category"><strong>错误的其它词性：</strong></span>
<span class="vocabulary"><strong>wrong</strong></span> [rɒŋ]
<span class="definition">adv. 用于动词之后，产生错误结果地，或产生不想要的结果地，反义词为right：</span>My name is spelt wrong. 我的名字给拼错了。/ The program won’t load. What am I doing wrong? 这程序载入不了。我哪里出错了？</p>
<p><span class="vocabulary"><strong>blunder</strong></span> [ˈblʌndə(r)]
...
<span class="definition">vt. 篡改（以欺骗人）：</span>to doctor the picture 篡改照片 / to doctor the figures 篡改数字</p>
<p><span class="vocabulary"><strong>mangle</strong></span> [ˈmæŋgl]
<span class="definition">vt. [常用被动式] （因发音、书写错误或表达不清晰而）扭曲，改变（词语、信息的意思）；破坏某事物（例如通过蹩脚的朗诵或演奏来糟蹋一首诗或一首乐曲）：</span>There is almost no phrase so simple that he cannot mangle it. 几乎再简单的话他也表达不清。/ They don't know what they're talking about and mangle scientific information. 他们不知所云，把科学知识讲得错误百出。</p>
<p>相关词义延伸：
· fault还可指挑错。</p>
<p>周边词汇补充：
...
· misread可指读错、误读。</p>
<p>· 表示“误解”、“曲解”的词群见[[01思考 考虑 理解 领会 明白]]
· 表示“违法”、“有罪”的词群见[[09犯罪 罪行]]
· 表示“不合适”的词群见[[03合适 适当]]
· 表示“不道德”的词群见[[01道德 品质]]
· 表示“故障”的词群见[[03破坏 修理]]
· 表示“缺点”、“缺陷”的词群见[[02优劣]]</p>
</div></template>
