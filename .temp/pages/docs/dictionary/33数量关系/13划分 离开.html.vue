<template><div><p>☀ <span class="category"><strong>划分、分割的动词和形容词：</strong></span>
<span class="vocabulary"><strong>divide</strong></span> [dɪ'vaɪd]
<span class="definition">vt.＆vi. divide (sth) (up) (into sth) 分开或分成各部分；使…分开或分成各部分。相当于split up：</span>The cells began to divide rapidly. 细胞迅速分裂。/ A sentence can be divided up into meaningful segments. 一个句子可以划分成有意义的各个部分。/ The physical benefits of exercise can be divided into three factors. 锻炼对身体的好处可以分成三个方面。/ Divide the pastry in half and roll out each piece. 把面团一分为二，把每块都擀平。/ This report is divided broadly into two parts. 该报告大致分为两部分。/ They were randomly divided into three groups. 他们被随机分成三组。/ the point where the river divides in two 河流的分岔点</p>
<p><span class="vocabulary"><strong>separate</strong></span> ['sepəreɪt]
<span class="definition">vt.＆vi. separate (sth) (from/and sth)（事物自己）划分成不同的部分或组；将某事物划分成不同的部分或组：</span>Stir the sauce constantly so that it does not separate. 不停地搅动沙司，免得出现分层。/ It is impossible to separate belief from emotion. 信仰和感情是分不开的。/ Separate the eggs (= separate the yolk from the white). 把蛋黄和蛋清分开。/ Make a list of points and separate them into ‘desirable’ and ‘essential’. 列出各点，把它们分成“可取的”和“绝对必要的”两类。</p>
<p><span class="vocabulary"><strong>split</strong></span> [splɪt]
<span class="definition">vt.＆vi. split (sth) (into sth) 划分成两个或多个部分；使某事物划分成两个或多个部分：</span>She split the class into groups of four. 她按四人一组把全班分成若干小组。/ The results split neatly into two groups. 结果恰巧分成两类。/ Split the coconut in half. 把椰子一分为二。/ He split the log into several pieces. 他把木头劈成几块。</p>
<p><span class="vocabulary"><strong>cut</strong></span> [kʌt]
<span class="definition">vt. cut sth (in/into sth) 用刀等将某物切成若干份：</span>to cut the apple in half 把苹果切成两半 / to cut the meat into slices 把肉切成片 / to cut the string 剪断绳子 / I can’t cut through this wood. 我劈不开这块木头。/ The bus was cut in two by the train. 那辆公交车被火车撞成了两截。</p>
<p><span class="vocabulary"><strong>segment</strong></span> [ˈsegmənt]
<span class="definition">vt. [常用被动式] [术语] 把某事物划分或分割成不同的部分：</span>Market researchers often segment the population on the basis of age and social class. 市场研究人员常常按年龄和社会阶层划分人口。/ The big six record companies are multinational, and thus can segment the world market into national ones. 六大唱片公司都是跨国经营，因此能够将世界市场按国家划分。/ The worm has a segmented body (= with different sections joined together). 这条虫子的身体是分节的。</p>
<p><span class="vocabulary"><strong>section</strong></span> ['sekʃn]
<span class="definition">vt. 将…划分或切分成若干部分：</span>It holds vegetables in place while they are being peeled or sectioned. 它在蔬菜被去皮或切分时将他们固定。</p>
<p><span class="vocabulary"><strong>subdivide</strong></span> [ˈsʌbdɪvaɪd; ˌsʌbdɪˈvaɪd]
<span class="definition">vt.&amp;vi. [常用被动式] ~ (sth) (into sth)（使）再分割成更小的领域、部分、群体等：</span>The verbs were subdivided into transitive and intransitive categories. 动词可细分为及物动词和不及物动词。</p>
<p><span class="vocabulary"><strong>portion</strong></span> [ˈpɔ:ʃn; 美 ˈpɔ:rʃn]
<span class="definition">vt. ~ sth (out) 把…分成若干份（或部分）：</span>The factory portions and packs over 12 000 meals a day. 这个工厂每天分装12 000多份饭食。/ Land was portioned out among the clans. 土地已分给了各个家族。</p>
<p><span class="vocabulary"><strong>halve</strong></span> [hɑ:v; 美 hæv]
<span class="definition">vt. 把…分成相等的两半：</span>Halve the pineapple and scoop out the inside. 将菠萝对半切开，挖出里面的果肉。</p>
<p><span class="vocabulary"><strong>zone</strong></span> [zəʊn]
<span class="definition">vt. 1 zone sth (for sth) 常用被动式，（根据某个目的）将一片土地划为某一用途：</span>The town centre was zoned for office development. 镇中心被划定为写字楼开发区。/ The land was zoned for commercial purposes. 这块地被划为商业用地。<span class="definition">2 将一片土地划分成若干更小的区域：</span>了解即可</p>
<p><span class="vocabulary"><strong>divisible</strong></span> [dɪˈvɪzəbl]
<span class="definition">adj. 可被划分为…类的：</span>Plants are divisible into three main groups. 植物可以划分为三大类。</p>
<p>☀ <span class="category"><strong>分摊、分配的动词：</strong></span>
<span class="vocabulary"><strong>share</strong></span> [ʃeə]
...
<span class="definition">vt. 1 divide sth (up/out) (between/among sb) 把…分成不同的部分并分配给不同的人等，即分配、分享、分担，相当于share (out)：</span>We divided the work between us. 我们共同分担这项工作。/ The money was divided equally among his sons. 这笔钱由他的儿子们平分了。/ Divide the sauce among 4 bowls. 把调味汁分到4个碗里。<span class="definition">2 divide sth (between A and B) 把（时间、精力等）分别用于不同的活动等：</span>He divides his energies between politics and business. 他把精力一部分用在政治上，一部分用在生意上。/ They divided their time between London and Boston. 他们一部分时间在伦敦，一部分时间在波士顿。</p>
<p><span class="vocabulary"><strong>split</strong></span> [splɪt]
<span class="definition">vt. split sth (between sb/sth) / split sth (with sb) 将某事物划分成两个或多个部分，并在不同的人们、活动等之间分摊或分担：</span>The cost has been split equally between three countries. 费用已由三个国家均分。/ to split the difference 折中 / She splits her time between Madrid and Washington. 她一半时间在马德里，一半时间在华盛顿。</p>
<p><span class="vocabulary"><strong>distribute</strong></span> [dɪ'strɪbju:t]
...
· distribute还可指向商店或其他经销处送货（以让其销售给终端客户），即分销。也可指（在一个区域内）散开或分布某事物（或某事物的不同部分）。</p>
<p>周边词汇补充：
...
· appropriate可指为某一用途而拿取（或给予）某事物（尤指金钱，此时可称为拨款）。</p>
<p>· 表示“份额”的词群见[[01整体 局部]]
...
<p><span class="vocabulary"><strong>insulate</strong></span> [ˈɪnsjuleɪt; 美 -səl-]
<span class="definition">vt. ~ sth (from/against sth) 用某种材料来隔热、隔音等：</span>Home owners are being encouraged to insulate their homes to save energy. 当局鼓励房主给住房加隔热装置以节约能源。/ Is there any way we can insulate our home from the noise? 有什么办法可以使我们的住宅隔音吗？/ to insulate the homes 对住宅进行隔热隔音处理 <span class="definition">vt. ~ sb/sth from/against sth 使…免除不愉快的经历或免受不良影响：</span>Their wealth had insulated them from reality. 财富将他们与现实隔离。/ They wonder if their community is no longer insulated from big city problems. 他们在想是否大城市的问题离自己的社区也已经不再遥远了。</p>
<p><span class="vocabulary"><strong>barricade</strong></span> [ˌbærɪˈkeɪd]
<span class="definition">vt. barricade yourself in/inside (sth) 把…堵住或隔离：</span>He had barricaded himself in his room. 他把自己关在房间里。/ The students have barricaded themselves into their dormitory building. 学生们把自己关在了宿舍楼里。/ About forty prisoners are still barricaded inside the wrecked buildings. 仍有大约40名囚犯被困在严重损毁的建筑物中。</p>
<p><span class="vocabulary"><strong>detach</strong></span> [dɪˈtætʃ]
<span class="definition">vt.&amp;vi. ~ (sth) (from sth) 将某事物从一个更大的事物上移除；从某事物上分离开来（即脱离某事物）：</span>Detach the coupon and return it as soon as possible. 将赠券撕下后尽快寄回。/ Detach the white part of the application form and keep it. 把申请表的白色部分撕下存底。/ One of the panels had become detached from the main structure. 一块镶板已从主体结构上脱落。/ The skis should detach from the boot if you fall. 要是你跌倒了，滑雪板就该脱离靴子。/ It is easy to detach the currants from the stems. 很容易就能把醋栗从梗上摘下来。<span class="definition">vt. ~ yourself (from sb/sth) [正式] 使自己挣脱某个人：</span>She detached herself from his embrace. 她挣脱了他的拥抱。<span class="definition">vt. ~ yourself (from sb/sth) [正式] 使自己从某个事件、问题等情况中挣脱出来：</span>I tried to detach myself from the reality of these terrible events. 我尽力使自己从这些可怕事件的现实中摆脱出来。/ It helps them detach themselves from their problems and become more objective. 这有助于他们从所面临的问题中跳出来，变得更客观一些。</p>
<p><span class="vocabulary"><strong>divorce</strong></span> [dɪ'vɔ:s]
<span class="definition">vt. [正式] divorce sb/sth from sth 常用被动式，将一个人、一个思想、一个主题等与…分开；使两个事物分离：</span>They believed that art should be divorced from politics. 他们认为艺术应该与政治分开。/ When he was depressed, he felt utterly divorced from reality. 他沮丧时感到被现实抛弃了。</p>
<p><span class="vocabulary"><strong>divide</strong></span> [dɪ'vaɪd]
<span class="definition">vt. 1 [正式] divide A from B 使（两个人或事物）分开或分离：</span>Can it ever be right to divide a mother from her child? 让母子分离难道还有对的时候？<span class="definition">2 divide sth (off) / divide A from B 是（两个人或事物之间的）真实或想象的分界线或障碍，相当于separate (off)：</span>A fence divides off the western side of the grounds. 篱笆把庭院的西面隔开。/ remote border areas dividing Tamil and Muslim settlements 把泰米尔人和穆斯林居住地分隔开的偏僻边界地区</p>
<p><span class="vocabulary"><strong>fence</strong></span> [fens]
<span class="definition">vt.（用栅栏、篱笆或围栏）围住或隔开：</span>His property is fenced with barbed wire. 他的房子四周围着带刺的铁丝网。/ to fence the wood 把小树林圈起来</p>
<p><span class="vocabulary"><strong>seal</strong></span> [si:l]
<span class="definition">vt. seal from 使与…隔绝：</span>The nuclear plant would be effectively sealed off from the world. 该核电厂将与外界完全隔离开。</p>
<p><span class="vocabulary"><strong>prize</strong></span> [praɪz]
<span class="definition">vt. [美] 用力量将某事物与其他事物分离开，相当于英式的prise：</span>了解即可</p>
<p>相关词义延伸：
· insulate还可指用某种材料来隔绝电流，即绝缘。</p>
<p>周边词汇补充：
· quarantine可指对动物或人进行隔离或检疫。</p>
<p>☀ <span class="category"><strong>分隔、分离的名词：</strong></span>
<span class="vocabulary"><strong>separation</strong></span> [sepə'reɪʃn]
<span class="definition">n. 1 [U, sing.] separation (from sb/sth) / separation (between A and B) 将人们或一些事物所做的分离、分割、隔离；所处的被分开（或独立）的状态：</span>the state’s eventual separation from the federation 那个州最终与联邦的脱离 / the need for a clear separation between Church and State 政教彻底分离的必要性 / the clear separation of powers between the executive and the legislature 行政和立法之间明确的权力分立 <span class="definition">2 [C] 人们之间彼此相互离别的一段时间，即离别：</span>They were reunited after a separation of more than 20 years. 他们离别20多年后重又聚首。/ the separation of children from their parents during the war 战争时期孩子与父母的离散 / She is visiting her family after a long separation. 她回家探望久别的家人。</p>
<p><span class="vocabulary"><strong>segregation</strong></span> [ˌsegrɪˈgeɪʃn]
...
<p><span class="vocabulary"><strong>separate</strong></span> ['sepəreɪt]
<span class="definition">adj. separate (from sth/sb) 自己形成一个独立单元的，不与其他事物联结的，即单独的，独立的，分开的：</span>separate bedrooms 独立卧室 / The school is housed in two separate buildings. 学校设在两栋独立的楼房内。/ Raw meat must be kept separate from cooked meat. 生肉和熟肉必须分开存放。/ The waste water is kept entirely separate from the rainwater. 废水与雨水保持完全分开。/ The two groups are essentially separate and independent. 这两个团体本质上是各自独立的。/ I kept my two lives very separate. 我把我的两种生活分得很清楚。/ to merge the two previously separate businesses 将两个先前彼此独立的企业合并 / They decided to go their separate ways after being together for five years. 在一起五年之后，他们决定分手。</p>
<p><span class="vocabulary"><strong>separable</strong></span> [ˈsepərəbl]
<span class="definition">adj. 1 ~ (from sth) 可分开的、可分离的、可分隔的：</span>Church and State were not easily separable in this period. 这个时期政教难分。/ The form of good literature is not separable from the content. 好的文学作品的形式与内容密不可分。/ The moral question is not entirely separable from the financial one. 道德问题和财政问题不能截然分开。/ Character is not separable from physical form but is governed by it. 性格和外表是分不开的，而且观其形知其性。<span class="definition">2 [语法]（短语动词）可分的、可分离的、可分开的：</span>The phrasal verb ‘tear up’ is separable because you can say ‘She tore the letter up’ or ‘She tore up the letter’. tear up是可以分开的短语动词，因为既可以说She tore the letter up，又可以说She tore up the letter。</p>
<p><span class="vocabulary"><strong>detached</strong></span> [dɪˈtætʃt]
<span class="definition">adj.（房子）不与其它房子相连接的，如独立式的：</span>了解即可</p>
<p><span class="vocabulary"><strong>self-contained</strong></span>
<span class="definition">adj. [英] [常用于名词前]（公寓等住宿场所）有自己的厨房、盥洗室和入口的，即独门独户的、设施齐全的：</span>self-contained accommodation 独门独户、设施齐全的住处 / The flat is completely self-contained. 这是一套设施非常齐全的公寓。</p>
<p><span class="vocabulary"><strong>parting</strong></span> [ˈpɑ:tɪŋ; 美 ˈpɑ:rt-]
<span class="definition">adj. [只用于名词前] 离别时说的（或做的）：</span>a parting kiss 临别之吻 / His parting words were ‘I love you’. 他临别的话是“我爱你”。/ Her parting words left him feeling empty and alone. 她分手时说的话让他感觉空虚孤独。</p>
<p><span class="vocabulary"><strong>estranged</strong></span> [ɪˈstreɪndʒd]
<span class="definition">adj. [正式] [常用于名词前]（夫妻）分居的：</span>his estranged wife Emma 他分居的妻子埃玛</p>
<p><span class="vocabulary"><strong>between</strong></span> [bɪ'twi:n]
<span class="definition">prep.（一条界线）分隔着两个地方：</span>the border between Sweden and Norway 瑞典和挪威之间的边界</p>
<p><span class="vocabulary"><strong>with</strong></span> [wɪð]
<span class="definition">prep. 表示与事物或人相分离：</span>Tom parted with his girlfriend in the park. 汤姆和他的女朋友在这个公园里分的手。</p>
<p>相关词义延伸：
· divorce还可指与某人离婚、判某人离婚；
· fence还可指对某人讲话时以聪明的方式来获得谈话优势，如搪塞、支吾、回避等；
· part还可指用梳子把头发梳成分头；
· separate还可指（与配偶或情侣）分居、使…产生分歧；
· separation还可指合法夫妻间的分居。</p>
<p>周边词汇补充：
...
· wall可指用墙把一个区域（如城镇）围住。</p>
<p>· 表示“阻挡”的词群见[[13阻挡 阻止]]
· 表示“阻塞”的词群见[[02畅通 阻塞]]
· 表示“各自”的词群见[[03共同 各自]]
· 表示“不同”的词群见[[01相异 相同]]</p>
<p>☀ <span class="category"><strong>分隔物：</strong></span>
<span class="vocabulary"><strong>barrier</strong></span> ['bærɪə]
<span class="definition">n. [C] barrier (between A and B) / barrier (against sth) 存在于两个事物或人之间，将彼此分隔开的东西，即屏障、分界线、隔阂：</span>a natural barrier between the city and the desert 这座城市和沙漠之间的一道天然屏障 / The mountains form a natural barrier between the two countries. 这条山脉是分隔两国的天然屏障。/ the barrier against air pollution 防止空气污染的一道屏障 / the barrier between ideal and reality 理想和现实之间的界线</p>
<p><span class="vocabulary"><strong>screen</strong></span> [skri:n]
<span class="definition">n. 1 [C]（固定或移动的）能隔出一间屋子（或把…挡起来）的隔板、屏风、幕帘、帐等：</span>The nurse put a screen around the bed. 护士绕床拉了一道帘子。/ There is a screen between the two beds. 两张床之间有一道帘子。/ The room was divided by a folding screen. 房间被一个折叠屏风分隔开。<span class="definition">2 [C] screen (of sth) 用来做掩蔽或起保护作用的事物：</span>We planted a screen of tall trees. 我们种下一排大树作为屏障。/ All the research was conducted behind a screen of secrecy.（比喻用法）整个研究始终是秘密进行的。</p>
<p><span class="vocabulary"><strong>partition</strong></span> [pɑ:ˈtɪʃn; 美 pɑ:rˈt-]
<span class="definition">n. [C] 房间内的一堵起隔断作用的墙或屏风：</span>partition walls 隔断墙 / new offices divided only by glass partitions 只用玻璃隔板隔开的新办公室 / The cafe was divided up by glass partitions. 咖啡馆内用玻璃隔成小空间。/ There were no partitions between the showers. 淋浴喷头之间没有任何东西分隔。/ Her taxicab has a thick perspex partition between the passengers' seats and the driver. 她的出租车里乘客座位和驾驶员之间装着厚厚的有机玻璃隔板。</p>
<p>相关词义延伸：
· screen还可指纱窗或纱门（用以将昆虫隔绝在室外同时保持空气流通的网状门窗）。</p>
<p>周边词汇补充：
· cushion可指处于两个表面之间（而将它们隔开）的一层某事物，即垫；
· fence可指栅栏，围栏，篱笆；
· trap可指赛狗运动中所用的一种隔栏（赛狗开始时把狗从中放出）；
· wall可指墙壁。也可指中空物体（如身体器官或动植物细胞等）的外壁。</p>
<p>· 表示“障碍物”的词群见[[13阻挡 阻止]]
· 表示“路障”的词群见[[09路障 关卡]]</p>
<p>☀ <span class="category"><strong>离开、离去的动词：</strong></span>
<span class="vocabulary"><strong>leave</strong></span> [li:v]
<span class="definition">vt.＆vi. 1 离开（某人或某地）。是一个基础和常规用词：</span>Come on, it’s time we left. 快点，我们该走了。/ They left for Scotland this morning. 他们今天早上动身前往苏格兰。/ My flight leaves in less than an hour. 我的航班一小时内起飞。/ My secretary has threatened to leave. 我的秘书扬言要离开。<span class="definition">2 离开（居住地点、所属的群体或工作单位）：</span>He left school with no qualifications. 他离开学校时没有拿到证书。/ I am leaving to concentrate on writing fiction. 我要离开，去专心写小说。</p>
<p><span class="vocabulary"><strong>retreat</strong></span> [rɪˈtri:t]
<span class="definition">vi. 离开、离去：</span>He watched her retreating figure. 他看着她的身影渐渐远去。/ The young nurse pulled a face at the Matron's retreating figure. 看着护士长离去的身影，这个年轻的护士做了个鬼脸。/ I heard her footsteps retreat down the hall. 我听见她沿走廊渐渐走远的脚步声。</p>
<p><span class="vocabulary"><strong>recede</strong></span> [rɪˈsi:d]
<span class="definition">vi. 从某人处（或从某个位置）逐渐远离、渐渐远去：</span>The sound of the truck receded into the distance. 卡车的声音渐渐在远处消失了。/ She watched his receding figure. 她看着他的身影渐渐远去。/ Luke's footsteps receded into the night. 卢克在夜色中渐行渐远。/ As she receded he waved goodbye. 她离开的时候他挥手告别。/ The January flood waters receded as fast as they had risen. 一月份的洪水涨得快退得也快。/ The water receded back to its mysterious depths. 水退回到神秘的深处。</p>
<p><span class="vocabulary"><strong>go</strong></span> [ɡəʊ]
<span class="definition">vi. 1 离开一个地方（而去另一个地方），相当于depart。是一个简单用词：</span>I must be going now. 我现在得走了。/ When does the train go? 火车什么时候开？/ Let’s go. 我们走吧。<span class="definition">2 go on sth 离开一个地方（去做不同的事）：</span>to go on a journey, to go on a tour 去旅行；去观光游览 / He has gone on leave for two weeks. 他休假两周了。</p>
<p><span class="vocabulary"><strong>stir</strong></span> [stɜ:(r)]
<span class="definition">vi. ~ from 用于否定式，表示离开（一个地方）：</span>She had not stirred from the house that evening. 她那天晚上没有离开过那座房子。/ There's something you could study without stirring from this room. 有些东西你不用离开这个房间也可以学习。</p>
<p><span class="vocabulary"><strong>desert</strong></span> [dɪ'zət]
<span class="definition">vt. 1 常用被动式，从某地离开（使该地变空），相当于abandon：</span>The villages had been deserted. 这些村庄已经荒无人烟了。/ The owl seems to have deserted its nest. 这只猫头鹰似乎不要这个窝了。/ Poor farmers are deserting their parched farm fields and coming here looking for jobs. 贫穷的农民丢下干旱的农田，来这里找工作。<span class="definition">2（某种品质在某人需要的时候）背离（这个人）：</span>Her courage seemed to desert her for a moment. 她一时间似乎失去了勇气。</p>
<p><span class="vocabulary"><strong>quit</strong></span> [kwɪt]
<span class="definition">vt.＆vi. 离开你所居住的那个地方，即迁出、搬离：</span>to quit the city 离开这座城市 / The landlord gave them all notice to quit. 房东通知他们都搬出去。</p>
<p><span class="vocabulary"><strong>skip</strong></span> [skɪp]
<span class="definition">vt. 悄悄地或突然地离开一个地方：</span>The murderer skipped the city. 杀人犯悄悄地离开了那座城市。</p>
<p><span class="vocabulary"><strong>dismiss</strong></span> [dɪs'mɪs]
<span class="definition">vt. 把某人打发走，或让其离开：</span>At 12 o’clock the class was dismissed. 12点下课了。</p>
<p><span class="vocabulary"><strong>detach</strong></span> [dɪˈtætʃ]
<span class="definition">vt. ~ yourself (from sb/sth) [正式] 使自己离开某些人：</span>Alexis saw his father detach himself from the group and walk away down the hill by himself. 亚历克西斯看到父亲离开那一群人，独自走下山去了。</p>
<p><span class="vocabulary"><strong>eject</strong></span> [iˈdʒekt]
<span class="definition">vt. [正式] ~ sb (from sth) 迫使某人离开一个地方，如驱逐、逐出、赶出：</span>Police ejected a number of violent protesters from the hall. 警察将一些暴力抗议者赶出了会议厅。/ Officials used guard dogs to eject the protesters. 官员们用警犬驱散抗议人群。/ They were summarily ejected by the security guard. 他们立刻被保安赶了出来。/ He was forcibly ejected from a restaurant. 他被强行逐出餐厅。</p>
<p><span class="vocabulary"><strong>evict</strong></span> [ɪˈvɪkt]
<span class="definition">vt. ~ sb (from sth)（尤指依法）将某人从房屋或土地上驱逐，赶出，逐出（通常因为被驱逐方违法或毁约）：</span>A number of tenants have been evicted for not paying the rent. 许多房客因不付房租被赶了出来。/ They were evicted from their apartment after their mother became addicted to drugs. 他们的母亲吸毒上瘾后，他们被从公寓里赶了出来。/ In the first week, the city police evicted ten families. 在第一周内，该市警方就驱逐了10个家庭。/ They were forcibly evicted from their home. 他们被强行逐出家门。</p>
<p><span class="vocabulary"><strong>exile</strong></span> [ˈeksaɪl; ˈegzaɪl]
<span class="definition">vt. [常用被动式] ~ sb (from…) 迫使某人从某个地方或情况中离开：</span>Michael was exiled to the kitchen for supper. 迈克尔被赶到厨房吃晚饭。</p>
<p><span class="vocabulary"><strong>expel</strong></span> [ɪkˈspel]
<span class="definition">vt. ~ sb/sth (from sth) 迫使某人离开一个国家或领地，即驱逐出境：</span>Foreign journalists are being expelled. 外国记者被驱逐出境。/ An American academic was expelled from the country yesterday. 昨天一位美国学者被逐出该国。/ They were told at first that they should simply expel the refugees. 一开始有人告诉他们应该直接将那些难民驱逐出境。/ They were forcibly expelled from their farm by the occupying authorities. 他们被占领当局强制驱逐出自己的农场。</p>
<p><span class="vocabulary"><strong>deport</strong></span> [dɪˈpɔ:t; 美 dɪˈpɔ:rt]
<span class="definition">vt. 把（罪犯或无合法居留权的人）驱逐出境：</span>a government decision earlier this month to deport all illegal immigrants 本月早些时候出台的将所有非法移民驱逐出境的政府决议 / More than 240 England football fans are being deported from Italy following riots last night. 昨晚的骚乱发生后有240多名英格兰球迷被驱逐出意大利。/ Many refugees were forcibly deported back to the countries they had come from.（deport尤为英式用法）许多难民被强制遣送回国。/ He was deported from Britain last week. 上星期他被英国驱逐出境。</p>
<p><span class="vocabulary"><strong>displace</strong></span> [dɪsˈpleɪs]
<span class="definition">vt. [常用被动式] 迫使（某人）离开家园：</span>Around 10 000 people have been displaced by the fighting. 大约1万人因战争而背井离乡。/ Most of the civilians displaced by the war will be unable to return to their homes. 许多因战乱而流离失所的百姓将无法重返家园。</p>
<p><span class="vocabulary"><strong>cleanse</strong></span> [klenz]
<span class="definition">vt.（军队）用武力将一群人从某地驱逐出去：</span>a sustained and systematic effort to ethnically cleanse the entire province 在全省范围开展的持续性、有计划的种族驱逐 / Many are refugees of three or four or even five other places where they've been cleansed from. 许多人是从其他三个、四个甚至五个地方驱逐出来的难民。</p>
<p><span class="vocabulary"><strong>drive</strong></span> [draɪv]
<span class="definition">vt. 迫使…向某个方向移动，即驱赶：</span>to drive the cattle into a fence 把牛赶入栅栏中 / to drive the enemy back 把敌人击退 / to drive refugees into another country 将难民驱赶到另一国</p>
<p><span class="vocabulary"><strong>herd</strong></span> [hɜ:d; 美 hɜ:rd]
<span class="definition">vt. 使某人或某事物朝某个方向移动：</span>They were herded together into trucks and driven away. 他们被一起赶上卡车开走了。/ He began to herd the prisoners out. 他开始将犯人集中在一起赶出来。<span class="definition">vt. 驱赶（牲畜）：</span>A boy herded half a dozen camels down towards the water trough. 一个男孩赶着六头骆驼朝饮水槽走去。</p>
<p><span class="vocabulary"><strong>flush</strong></span> [flʌʃ]
<span class="definition">vt.&amp;vi. 把（人或动物）驱赶出、把…赶出：</span>They flushed them out of their hiding places. 他们把他们从藏身之处赶了出来。/ The Guyana Defence Force is engaged in flushing out illegal Brazilian miners operating in the country. 圭亚那国防军正采取行动驱逐在本国作业的非法巴西矿工。</p>
<p><span class="vocabulary"><strong>sling</strong></span> [slɪŋ]
<span class="definition">vt.&amp;vi. [非正式] [常用被动式] 用武力使某人到某处，如遣送、押送；使某人离开某地，如撵走、驱逐：</span>They were slung out of the club for fighting. 他们因打架被赶出了俱乐部。</p>
<p><span class="vocabulary"><strong>clear</strong></span> [klɪə]
<span class="definition">vt. 使人们离开一个地方：</span>After the bomb warning, police cleared the streets. 接到有炸弹的警告后，警察疏散了街上的行人。</p>
<p><span class="vocabulary"><strong>discharge</strong></span> [dɪsˈtʃɑ:dʒ; 美 -ˈtʃɑ:rdʒ]
<span class="definition">vt. [常用被动式] ~ sb (from sth) 给予某人正式许可，让其离开一个地方：</span>Patients were being discharged from the hospital too early. 病人都过早获准出院。/ She had discharged herself against medical advice. 她不听医嘱擅自出院了。/ He has a broken nose but may be discharged today. 他鼻梁断了，但或许今天就能出院。/ He was discharged from the army following his injury. 他受伤后就退伍了。/ He was found guilty and dishonourably discharged from the army. 他被判有罪，被开除军籍。/ She was discharged from the police force for bad conduct. 她因行为不轨被清除出警察队伍。</p>
<p><span class="vocabulary"><strong>retire</strong></span> [rɪ'taɪə]
<span class="definition">vi. [正式] 离开一个地方（尤指去一个更安静或更私密的地方）：</span>The jury retired to consider the evidence. 陪审团退庭对证据进行评判。/ After dinner he likes to retire to his study. 晚饭后，他喜欢躲到书房里去。</p>
<p><span class="vocabulary"><strong>bounce</strong></span> [baʊns]
<span class="definition">vt. [尤美，非正式] bounce sb (from sth) 迫使某人离开一个地点等：</span>了解即可</p>
<p><span class="vocabulary"><strong>poach</strong></span> [pəʊtʃ; 美 poʊtʃ]
...
<p><span class="vocabulary"><strong>split</strong></span> [splɪt]
<span class="definition">vi. [旧时，非正式] 迅速离开一个地方：</span>Let’s split! 咱们快走吧！</p>
<p><span class="vocabulary"><strong>bail</strong></span> [beɪl]
<span class="definition">vi. [美，非正式] 离开一个地方，尤指迅速离开：</span>Sorry, I really have to bail. 对不起，我真得赶紧走了。</p>
<p><span class="vocabulary"><strong>diverge</strong></span> [daɪˈvɜ:dʒ; 美 -ˈvɜ:rdʒ]
<span class="definition">vi. [正式] ~ (from sth)（道路、线等）朝不同的方向分开，即分叉：</span>The coastal road diverges from the freeway just north of Santa Monica. 沿海公路与这条高速公路在圣莫尼卡以北处岔开。/ a course that diverged from the Calvert Island coastline. 从卡尔弗特岛海岸线叉开的一条路 / Where three roads diverge take the middle branch. 到三岔路口时走中间的道。/ We went through school and college together, but then our paths diverged.（比喻用法）我们从小学到大学一直在一起，但后来就分道扬镳了。/ The parallel lines appear to diverge. 这些平行线像是岔开了。<span class="definition">vi. [正式] ~ from sth 与原计划、原来预期的方向等产生差异，即偏离、违背：</span>to diverge from the norm 与常态不符 / He diverged from established procedure. 他违背了既定程序。/ His interests increasingly diverged from those of his colleagues. 他的兴趣和同事们越来越不一样了。/ This country's interests diverge considerably from those of other European countries. 该国的利益与其它欧洲国家的利益大不一样。</p>
<p><span class="vocabulary"><strong>veer</strong></span> [vɪə(r); 美 vɪr]
<span class="definition">vi.（尤指车辆）突然改变方向：</span>He veered left towards/toward them. 他向左转朝他们冲过去。/ The car veered off the road. 汽车偏离了路面。/ The bus veered onto the wrong side of the road. 公共汽车突然驶入了逆行道。/ Horrified commuters saw the lorry veer across the motorway and overturn. 惊恐万分的通勤者们看见那辆卡车突然冲向高速公路另一侧，接着翻倒在地。/ The plane veered off the runway and careered through the perimeter fence. 飞机突然偏离跑道，高速冲过了周围的护栏。/ The plane veered away to the left. 飞机突然调转方向往左侧飞去。/ The missile veered wildly off course. 导弹猛地转向，偏离了轨道。<span class="definition">vi.（交谈、行为方式、思考方式、态度、立场等）改变方向：</span>The debate veered away from the main topic of discussion. 争论脱离了讨论的主题。/ His emotions veered between fear and anger. 他的情绪变化不定，一会儿恐惧一会儿生气。/ He veered between the extremes of optimism and pessimism. 他时而极度乐观，时而悲观绝望。He is unlikely to veer from his boss's strongly held views. 他不可能背离他老板的强硬立场。/ I veered away from the set menu and went for the day's special of queen scallops. 我没有点套餐，而是要了当日的特供菜——皇后海扇贝。/ The play veers from loopy comedy to serious moralizing. 这部戏从怪诞的喜剧转成了严肃的道德说教。/ His poetry veered dangerously close to sentimentalism. 他的诗风陡然转至近乎伤感多愁，这种改变很危险。</p>
<p><span class="vocabulary"><strong>deviate</strong></span> [ˈdi:vieɪt]
<span class="definition">vi. ~ (from sth) 偏离；背离；违背：</span>The bus had to deviate from its usual route because of a road closure. 因为道路封闭，公共汽车只得绕道而行。/ They stopped you as soon as you deviated from the script. 一旦你偏离了剧本的内容，他们就会喊停。/ He planned his schedule far in advance, and he didn't deviate from it. 他提前很早就制订出了自己的进度表，然后从未偏离过它。/ He never deviated from his original plan. 他从未偏离自己最初的计划。/ We had to deviate significantly from our usual route. 我们不得不大大偏离我们通常走的路线。/ Output may deviate from the average by as much as 30%. 产量偏离平均水平可高达30%。</p>
<p><span class="vocabulary"><strong>dissolve</strong></span> [dɪˈzɒlv; 美 -ˈzɑ:lv]
<span class="definition">vt. 解散（团体或机构）：</span>The committee has been dissolved. 委员会已经解散了。/ The King agreed to dissolve the present commission. 国王同意解散目前的委员会。/ The civilian government was effectively dissolved. 文官政府实际上已经垮台。<span class="definition">vt. 解散议会：</span>The election was announced and parliament was dissolved. 宣布选举后，议会解散了。/ The present assembly will be dissolved on April 30th. 现在的议会将于4月30日解散。/ Kaifu threatened to dissolve the Parliament and call an election. 卡夫威胁要解散议会并举行选举。</p>
<p>相关词义延伸：
· displace还可指将某事物从其通常位置移开；
· diverge还可指（物种演变过程中）分化；
· exile还可指流放、放逐。也可指开除。</p>
<p>周边词汇补充：
· abstain可指离开、回避某事物。</p>
<p>☀ <span class="category"><strong>离开、离去的副词：</strong></span>
<span class="vocabulary"><strong>apart</strong></span> [ə'pɑːt]
<span class="definition">adv. 不在一起，分开，分离：</span>We’re living apart now. 我们现在不住在一起。/ Over the years, Rosie and I had drifted apart. 多年以来，我和罗西早已疏远。/ She keeps herself apart from other people. 她与其他人保持距离。/ I can’t tell the twins apart. 我分不出这一对双胞胎中谁是谁。/ What really sets Mr. Lee apart is that he comes from China. 真正使李先生与众不同的是他来自中国。/ It was the first time Jane and I had been apart for more than a few days. 这是我和简第一次分开超过了几天。</p>
<p><span class="vocabulary"><strong>away</strong></span> [ə'weɪ]
<span class="definition">adv. 1 去别处；朝向一个不同的方向：</span>Go away! 走开！/ An injured policeman was led away by colleagues. 一位受伤的警察被同事们带走了。/ Jason was away on a business trip. 杰森出差在外。<span class="definition">2 拿走：</span>If you take my work away I can’t be happy anymore. 如果你不让我工作，那我就再也高兴不起来了。</p>
<p><span class="vocabulary"><strong>out</strong></span> [aʊt]
<span class="definition">adv. 1 out (of sth) 将…（从一个地方、工作职位等）除掉，清除：</span>They want this government out. 他们想要这届政府下台。<span class="definition">2 out (of sth) 表示某人不再参与某事，即脱身、出局、淘汰、摆脱等：</span>to get out of the army 离开部队 / Brown goes on to the semi-finals but Lee is out. 布朗进入了半决赛，但李被淘汰了。</p>
<p><span class="vocabulary"><strong>off</strong></span> [ɔ:f, ɒf]
<span class="definition">adv. 离开（某地）：</span>I must be off soon. 我必须很快离开这里。/ Off you go! 你走吧！/ He ran off. 他跑开了。/ to drive off 开车离去 / She was off again, to Kenya. 她又走了，去肯尼亚。</p>
<p><span class="vocabulary"><strong>clear</strong></span> [klɪə]
<span class="definition">adv. clear (of sth) 离开某事物；不靠近或不接触某事物：</span>Stand clear of the train doors. 不要靠近火车门站立。/ He injured his arm as he jumped clear of the car. 他跳离汽车时手臂受了伤。/ By lap two Walker was two metres clear of the rest of the runners. 跑第二圈时，沃克已领先其他赛跑者两米。</p>
<p>☀ <span class="category"><strong>离开、离去的其它词性：</strong></span>
<span class="vocabulary"><strong>off</strong></span> [ɔ:f, ɒf]
<span class="definition">prep. 1 从某处离开：</span>I fell off the ladder. 我从梯子上跌了下来。/ to get off a train 下火车 / to keep children off the streets 不让孩子们上街 <span class="definition">2 [非标准英语或美国英语，非正式] off of 离开：</span>了解即可</p>
<p><span class="vocabulary"><strong>out</strong></span> [aʊt]
<span class="definition">prep. 1 out (of sth) 将…（从一个地方、工作职位等）除掉，清除：</span>He got thrown out of the restaurant. 他被逐出了餐馆。<span class="definition">2 out (of sth) 表示某人不再参与某事，即脱身、出局、淘汰、摆脱等：</span>Brown goes on to the semi-finals but Lee is out. 布朗进入了半决赛，但李被淘汰了。/ It was an awful job and I’m glad to be out of it. 那件差事简直是受罪，不过我很高兴摆脱掉了。</p>
<p><span class="vocabulary"><strong>outside</strong></span> ['aʊt'saɪd]
<span class="definition">prep. [美尤用outside of] 不是某事物的一部分，即不属于…：</span>The matter is outside my area of responsibility. 此事不属于我的职责范围。/ You may do as you wish outside working hours. 不在上班时间，你爱干什么就干什么。<span class="definition">adj. 只用于名词前，不属于本团体（或机构、国家等）的；与本团体无关的：</span>She has a lot of outside interests. 她有许多业余爱好。/ They felt cut off from the outside world. 他们觉得与外界隔绝了。</p>
<p><span class="vocabulary"><strong>clear</strong></span> [klɪə]
<span class="definition">adj. clear (of sb/sth) 不用于名词前，不接触某事物的，离开某事物的：</span>The plane climbed until it was clear of the clouds. 飞机爬升直至穿出了云层。/ Make sure you park your car clear of the entrance. 切莫把车停在入口处。</p>
<p><span class="vocabulary"><strong>aloof</strong></span> [əˈlu:f]
<span class="definition">adj. [名词前不可用] 置身事外的：</span>The Government is keeping aloof from the controversy. 政府对争论保持置身事外的态度。/ He has remained some-what aloof from the business of politics. 他一直对政治事务不太关心。/ I will hold myself aloof from wrong and corruption. 我会让自己远离错误和腐败。/ Some thought that Britain was standing aloof from Europe. 有些人认为英国与欧洲诸国保持距离。</p>
<p><span class="vocabulary"><strong>stray</strong></span> [streɪ]
<span class="definition">adj. [只用于名词前] 与同类中的其它事物或人相互分离的，如孤立的、离群的、走散的：</span>A civilian was killed by a stray bullet. 一个平民被流弹打死。/ a few stray hairs 几根散乱的头发 / She shrugged a stray lock of hair out of her eyes. 她把一缕散发从眼前甩开。<span class="definition">n. 1 [C] 走失的宠物（或家畜）；无主的宠物（或家畜）：</span>了解即可 <span class="definition">2 [C] 离群的一个人或事物、不在原位置的人或事物：</span>了解即可</p>
<p><span class="vocabulary"><strong>departure</strong></span> [dɪ'pɑːtʃə]
<span class="definition">n. [C, U] departure (from ...) 离开一地的行为；还可指此种离开的事例。即离开，与arrival相反：</span>his departure from the city 他离开这座城市</p>
<p><span class="vocabulary"><strong>retreat</strong></span> [rɪˈtri:t]
<span class="definition">n. [C, usually sing., U] 从一地的离开：</span>I decided to beat a hasty retreat. 我决定赶紧离开。/ I made a tactful retreat before they started arguing. 在他们开始争论前我巧妙地找机会离开了。</p>
<p><span class="vocabulary"><strong>eviction</strong></span> [ɪˈvɪkʃn]
<span class="definition">n. [U, C]（尤指依法对某人进行的）驱逐、驱离（使其离开一栋建筑物或一片土地）：</span>He was facing eviction, along with his wife and family. 他和妻子、家人正面临着被驱逐。/ They are facing eviction from their home. 他们面临着从家中被赶出的处境。/ He also criticized the evictions for being violent and ruthless. 他也批评这些驱逐暴力无情。/ illegal, unlawful（尤英）非法驱逐 / He claimed damages for unlawful eviction. 他要求对非法驱逐作出赔偿。/ forced eviction 强制驱逐 / eviction notice, eviction order（尤英）, eviction warrant（英）驱逐通知；驱逐令 / eviction proceedings 驱逐诉讼程序</p>
<p><span class="vocabulary"><strong>expulsion</strong></span> [ɪkˈspʌlʃn]
<span class="definition">n. [U, C] ~ (from…) 对某人的驱逐：</span>These events led to the expulsion of senior diplomats from the country. 这些事件导致一些高级外交官被驱逐出境。/ The government ordered the immediate expulsion of the two men. 政府命令立即将这两个人驱逐出境。/ the expulsion of Yemeni workers 对也门工人的驱逐 / her expulsion from the society 她被社会所抛弃</p>
<p><span class="vocabulary"><strong>deportation</strong></span> [ˌdi:pɔ:ˈteɪʃn; 美 -pɔ:rˈt-]
