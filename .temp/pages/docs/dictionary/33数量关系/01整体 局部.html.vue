<template><div><p>☀ <span class="category"><strong>所有、全部、一切的限定词和代词：</strong></span>
<span class="vocabulary"><strong>all</strong></span> [ɔ:l]
<span class="definition">det. 1 与复数名词连用，名词前可用the、this、that、my、her、his等，也可用数词。表示全部，所有，一切：</span>All horses are animals, but not all animals are horses. 所有的马都是动物，但并不是所有的动物都是马。/ All my plants have died. 我的花草全死光了。<span class="definition">2 与不可数名词连用，名词前可用the、this、that、my、her、his等，表示全部，所有，一切：</span>All wood tends to shrink. 所有的木头都会收缩。/ You’ve had all the fun and I’ve had all the hard work. 所有的快乐都让你享受了，所有的辛苦都让我尝尽了。/ He has lost all his money. 他失去了所有的钱。<span class="definition">3 只由一种事物组成的，或看起来只由一种事物组成的，即唯一；全是；仅仅：</span>The magazine was all advertisements. 这份杂志全是广告。/ She was all smiles. 她笑容满面。<span class="definition">4 无论什么，任何：</span>了解即可 <span class="definition">pron. 1 全部；所有；全体；一切等：</span>All of the food has gone. 食物全光了。/ They all enjoyed it. 他们都喜欢。/ His last movie was best of all. 他最近的那部电影是他所有电影中最好的。/ All is silent on the island now. 现在这个岛上一片寂静。<span class="definition">2 后常接不带that的关系从句（有时也可带that），指唯一的事物；所有的事物；一切：</span>All I want is peace and quiet. 我只要和平安宁。/ It was all that I had. 那就是我所拥有的一切。</p>
<p><span class="vocabulary"><strong>every</strong></span> ['evrɪ]
<span class="definition">det. 1 与单数名词连用，指一群事物或人中的所有成员，如每一个、每个：</span>Every day seemed the same to him. 对他来说似乎天天都一样。/ Every single time he calls, I’m out. 他每次打电话来我都不在家。<span class="definition">2 所有可能的，完全可能的：</span>We wish you every success. 我们祝你万事如意。/ He had every reason to be angry. 他完全有理由感到愤怒。</p>
<p><span class="vocabulary"><strong>whatever</strong></span> [wɒt'evə]
<span class="definition">det., pron. 任何一，每一；任何事物，一切事物：</span>Take whatever action is needed. 采取任何必要的行动。/ Do whatever you like. 你喜欢做什么就做什么。</p>
<p><span class="vocabulary"><strong>everyone</strong></span> ['evrɪwʌn]
<span class="definition">pron.（也可用everybody）每个人；所有人：</span>Everyone cheered and clapped. 人人都鼓掌欢呼。/ The police questioned everyone in the room. 警方盘问了房间里的每一个人。</p>
<p><span class="vocabulary"><strong>either</strong></span> ['aɪðə]
<span class="definition">det., pron. 1 两者中的任何一个：</span>You can park on either side of the street. 这条街两边都可停车。/ You can keep one of the photos. Either of them--whichever you like. 你可以保留一张照片。两张里任选一张——挑你喜欢的。<span class="definition">2 两者中的每个，每一方：</span>The offices on either side were empty. 两边的办公室都是空的。/ There’s a door at either end of the corridor. 走廊两端各有一道门。</p>
<p>☀ <span class="category"><strong>全部的形容词：</strong></span>
<span class="vocabulary"><strong>whole</strong></span> [həʊl]
<span class="definition">adj. 1 只用于名词前，全部的，完全的，所有的，整体的：</span>He spent the whole day writing. 他整整写了一天。/ We drank a whole bottle each. 我们每人都喝了整整一瓶。/ The whole country (= all the people in it) mourned her death. 举国都在为她的逝世哀悼。/ Let’s forget the whole thing. 咱们彻底忘掉这件事吧。/ She wasn’t telling the whole truth. 她没有把实情都讲出来。<span class="definition">2 只用于名词前，用于强调某事物的大小或重要性，如整个的，全部的：</span>We offer a whole variety of weekend breaks. 我们提供的周末假日活动丰富多彩，一应俱全。/ I can’t afford it--that’s the whole point. 我买不起，这就是全部的理由。<span class="definition">3 未被打破或损坏的，即完好无损的，完整的，相当于in one piece：</span>Owls usually swallow their prey whole (= without chewing it). 猫头鹰通常把猎物囫囵吞下。</p>
<p><span class="vocabulary"><strong>complete</strong></span> [kəm'pli:t]
<span class="definition">adj. 包含了所有必要部分等的，全部的，完整的，整个的：</span>I’ve collected the complete set. 我收集了全套。/ the complete works of Tolstoy 托尔斯泰全集 / a complete day 一整天 / You’ve made my life complete. 你使我的人生圆满。/ a complete account of the negotiations 全面的谈判报道 / A complete index provides easy reference to topics in the book. 完整的索引使得读者很容易查阅该书中讨论的主题。</p>
<p><span class="vocabulary"><strong>entire</strong></span> [ɪn'taɪə]
<span class="definition">adj. 只用于名词前，用以强调某事物的全部均包括在内，包括一切事物、每个人或每个部分的，全部的，完全的，整个的，相当于whole，此时二者未见明显差别：</span>the entire village 整个村庄 / the entire population 整个种群 / in my entire life 在我一生中 / I wasted an entire day on it. 我为此浪费了整整一天。</p>
<p><span class="vocabulary"><strong>integral</strong></span> [ˈɪntɪgrəl; ɪnˈteg-]
<span class="definition">adj. [常用于名词前] 完整的，某事物拥有其全部部分的：</span>an integral system 完整的系统</p>
<p><span class="vocabulary"><strong>full</strong></span> [fʊl]
<span class="definition">adj. 常用于名词前，完全的，完整的，详尽的，无遗失的：</span>Full details are available on request. 详情备索。/ I still don’t think we’ve heard the full story. 我还是认为我们未了解全部情况。/ a full refund 全额退回的款项 / full name 全名 / full membership 正式成员资格</p>
<p><span class="vocabulary"><strong>exhaustive</strong></span> [ɪgˈzɔ:stɪv]
<span class="definition">adj. 详尽的；全面的：</span>This list is not intended to be exhaustive. 这份清单不求详尽无遗。/ This is by no means an exhaustive list but it gives an indication of the many projects taking place. 这份清单肯定不全，但是列出了很多正在进行的项目。/ The report includes a seemingly exhaustive list of 160 benefits.这份报告似乎罗列尽了所有好处，共160条。</p>
<p><span class="vocabulary"><strong>detailed</strong></span> [ˈdi:teɪld; North American English also dɪˈteɪld]
<span class="definition">adj. 给出很多细节和很多信息的，如详细的、详尽的；对细节极其关注的：</span>detailed description, detailed analysis, detailed study 详细的描述；详细的分析；详细的研究 / He gave me detailed instructions on how to get there. 他详细地告诉我如何去那里。/ Yesterday's letter contains a detailed account of the decisions. 昨天的那封信里有对这些决议的详细说明。/ I started drawing up more detailed budgets. 我开始起草更详尽的预算方案。/ the exquisitely detailed carvings on the cathedral door 大教堂门上精巧细致的雕刻</p>
<p><span class="vocabulary"><strong>rounded</strong></span> [ˈraʊndɪd]
<span class="definition">adj. [常用于名词前] [褒] 全面的；全面发展的；一应俱全的；完善的：</span>a smooth rounded taste 舒爽醇厚的口味 / a fully rounded education 非常全面的教育 / his carefully organised narrative, full of rounded, believable and interesting characters 他的叙述结构严谨，不乏形象丰满、真实有趣的人物 / a well-rounded, well-educated and highly intelligent man 全面发展、受过良好教育的聪明过人的男子</p>
<p><span class="vocabulary"><strong>general</strong></span> ['dӡenərəl]
<span class="definition">adj. 1 指未限定在一个人或事物的一个部分或一个方面的，即整体的，全身的，全面的：</span>a general anaesthetic 全身麻醉 / The building was in a general state of disrepair. 整座建筑处于失修状态。<span class="definition">2（条目、项目或活动）多种的，或不重要以致没必要被各自提及的：</span>general costs 总的花费</p>
<p><span class="vocabulary"><strong>comprehensive</strong></span> [ˌkɒmprɪˈhensɪv; 美 ˌkɑ:m-]
<span class="definition">adj. 包含可能涉及的全部（或几乎全部）事项、细节、事实、信息等的，如详尽的、全面的：</span>a comprehensive list of addresses 详尽的地址目录 / The list is fairly comprehensive. 这份清单相当全面。/ The Rough Guide to Nepal is a comprehensive guide to the region. 《尼泊尔概况》是一本全面介绍该地区的旅游指南。/ a comprehensive study 全面的研究 / comprehensive insurance (= covering all risks) 综合保险</p>
<p><span class="vocabulary"><strong>gross</strong></span> [grəʊs; 美 groʊs]
<span class="definition">adj. [只用于名词前] 未将任何数量剔除的，即总的、毛的：</span>gross weight (= including the container or wrapping) 毛重 / gross income, gross wage (= before taxes, etc. are taken away)（税前等的）总收益；（税前等的）总工资 / Investments showed a gross profit of 26%. 投资毛利为26%。/ a fixed rate account guaranteeing 10.4% gross interest or 7.8% net until October 10月份之前保证10.4%的毛利或7.8%的纯利收益的固定利率账户 / National Savings gross sales in June totalled £709 million. 6月份国民储蓄机构的总销售额为7.09亿英镑。/ gross cost 总费用</p>
<p><span class="vocabulary"><strong>global</strong></span> [ˈgləʊbl; 美 ˈgloʊbl]
<span class="definition">adj. [常用于名词前] 整体的、全面的、包含了某事物的各部分的：</span>We need to take a more global approach to the problem. 我们需要更全面地看这个问题。/ global searches on the database 在数据库中的全程检索 / They sent a global email to all staff. 他们向全体职员发了一封统一的电邮。/ the global view, the ability to make wider decisions based on a knowledge of all the facts, not just some of them. 大局观——基于全部而非部分事实做出更加宏观的决定的能力 / a global vision of contemporary societies 对当代社会的总体看法</p>
<p><span class="vocabulary"><strong>blanket</strong></span> ['blæŋkɪt]
<span class="definition">adj. 只用于名词前，包括或影响到所有可能的情形或人员的：</span>a blanket ban on tobacco advertising 烟草广告的全面取缔 / a blanket refusal 完全拒绝</p>
<p>相关词义延伸：
· comprehensive还可指（教育）接收各种资质的学生的，即综合性的。</p>
<p>周边词汇补充：
· elaborate可指非常复杂且详尽的；
· intact可指完好无损的。</p>
<p>☀ <span class="category"><strong>全部、整体的名词：</strong></span>
<span class="vocabulary"><strong>whole</strong></span> [həʊl]
<span class="definition">n. 1 [C] 某事物的整体，整个：</span>Four quarters make a whole. 四个四分之一构成一个整体。/ She was struggling to organize her ideas into a coherent whole. 她尽力将自己的想法组织成一个连贯的整体。/ Unemployment is higher in the north than in the country as a whole. 北方的失业率要高于全国总体水平。<span class="definition">2 [sing.] the whole of sth 某事物所拥有的全部、全体或所有：</span>The effects will last for the whole of his life. 这些将会持续影响他的一生。/ The project involved the whole of the university. 该项目涉及整所大学。/ The library takes up the whole of the first floor. 整个二楼都用作图书馆。/ Technology permeates the whole of our lives. 技术渗入到我们生活的各个方面。</p>
<p><span class="vocabulary"><strong>integrity</strong></span> [ɪnˈtegrəti]
<span class="definition">n. [U] [正式] 完整、完好：</span>structural integrity 结构上的完整 / The country is fighting to preserve its territorial integrity. 这个国家正在为维护领土完整而战斗。/ Separatist movements are a threat to the integrity of the nation. 分离主义运动对国家统一是个威胁。/ data integrity（计算机用语）数据完整性 / It's up to the user to ensure the integrity of the data they enter. 保证所输入数据的完整性是用户的职责。/ We all have an interest in maintaining the integrity of the ecosystem. 维护生态体系的完整关乎我们每个人的利益。/ The project threatens the integrity of one of the world's most important wetlands. 这一工程威胁到世界上最重要的一片湿地的完整。/ concerns that data integrity has been compromised 对数据完整性已遭到损坏的担忧 / Nuclear weapons have the capability to destroy the physical integrity of the planet. 核武器具有摧毁地球实体完整性的威力。</p>
<p><span class="vocabulary"><strong>sum</strong></span> [sʌm]
<span class="definition">n. [sing.]（也可用sum total）the ~ of sth 全部，一切（尤指数量不大）：</span>This is the sum of my achievements so far. 这就是我目前的全部成就。/ 'Public opinion' is only the sum of the views of thousands of people like yourself. “舆论”只是所有像你一样的成千上万人的意见的总和。/ The sum of evidence points to the crime resting on them. 所有证据都表明该犯罪乃他们所为。</p>
<p><span class="vocabulary"><strong>lot</strong></span> [lɒt]
<span class="definition">n. [sing.] [非正式] the lot或the whole lot，指全部数量的人或事物：</span>He’s bought a new PC, colour printer, scanner--the lot. 他买了新的个人电脑、彩色打印机、扫描仪，样样齐备。/ Get out of my house, the lot of you! 你们别待在我家里，通通给我滚出去！/ That’s the lot! (= that includes everything) 全都在这儿了。/ She bought the whole lot. 她全部买了下来。</p>
<p><span class="vocabulary"><strong>work</strong></span> [wə:k]
<span class="definition">n. [C] the works 复数，指所有的事物，全套物品：</span>We went to the chip shop and had the works: fish, chips, gherkins, mushy peas. 我们去薯条店吃了套餐：炸鱼、炸薯条、小黄瓜、豆泥。</p>
<p><span class="vocabulary"><strong>bag</strong></span> [bæɡ]
<span class="definition">n. [C, usually sing.] 指一次所猎获的全部鸟或动物：</span>了解即可</p>
<p><span class="vocabulary"><strong>umbrella</strong></span> [ʌm'brelə]
<span class="definition">n. [C] 包含了很多个不同部分或元素的一个东西，即整体，总体，综合体等：</span>Many previously separate groups are now operating under the umbrella of a single authority. 许多原本分散的团体现在正在单一的权威领导下运作。/ umbrella company, umbrella group, umbrella organization（均为比喻用法）大型公司；庞大集团；伞状组织 / umbrella name, umbrella term, umbrella title（均为比喻用法）统称；总称；总标题 / the broad umbrella of alternative medicine 替代疗法的大框架</p>
<p><span class="vocabulary"><strong>system</strong></span> ['sɪstəm]
<span class="definition">n. [C] 被连接在一起（或在一起运行）的一组事物，如一套设备等，即系统：</span>rail, river, communication, cable, monitoring, warning, security, delivery, control, language, digital, computer, information, electrical, exhaust, heating, missile, irrigation system 铁路系统；水系；通信系统；有线系统；监控系统；警报系统；安全系统； 配送系统；控制系统；语言系统； 数字系统；计算机系统；信息系统；电气系统；排气系统；供热系统；导弹系统；灌溉系统 / The game has a complex scoring system. 该游戏有着复杂的计分体系。</p>
<p><span class="vocabulary"><strong>world</strong></span> [wə:ld]
<span class="definition">n. [usually sing.] 通常与形容词连用，指某个种类中的一切事物，某种生命或存在：</span>the natural world 自然界 / They are a couple in the real world as well as in the movie. 他们在电影和现实生活中都是一对夫妇。/ They had little contact with the outside world. 他们与外界没有什么联系。/ fantasy, fictional, inner, private world 幻想世界；虚构的世界；内心世界；个人世界 / She lives in her own little world. 她生活在自己的小天地里。/ material, physical world 物质世界 / simulated, virtual, digital, spiritual, spirit world 模拟世界；虚拟世界；数字世界；精神世界；阴间</p>
<p>相关词义延伸：
· sum还可指数学中可指数量的加和、总和。</p>
<p>周边词汇补充：
· organism可指（各部分彼此相依赖的）有机体系；
· gross的复数形式grosses可指144个为一组的事物，可称为一罗。也可尤为美式用法，指某事物（尤指影片）赚得的毛收入、总收入；
· comprehensive可指（英国为各种资质的学生设立的）综合中学。</p>
<p>☀ <span class="category"><strong>全部的其它词性：</strong></span>
<span class="vocabulary"><strong>altogether</strong></span> [͵ɔ:ltə'ɡeðə]
<span class="definition">adv. 在提出一些不同的内容之后，用于引出一个总结，如总之，总而言之：</span>The food was good and we loved the music. Altogether it was a great evening. 吃的不错，音乐我们也喜欢。总之，那天晚上过得非常愉快。</p>
<p><span class="vocabulary"><strong>gross</strong></span> [grəʊs; 美 groʊs]
<span class="definition">adv.（数量）未将任何数量剔除地，即总共：</span>She earns £25 000 a year gross. 她一年总收入为25 000英镑。</p>
<p><span class="vocabulary"><strong>complete</strong></span> [kəm'pli:t]
<span class="definition">vt. 使某事物完整或完美：</span>I only need one more card to complete the set. 我只差一张卡片就配齐全套了。</p>
<p>相关词义延伸：
...
<p><span class="vocabulary"><strong>anatomy</strong></span> [əˈnætəmi]
<span class="definition">n. [C, U] 动植物的结构、构造：</span>He had worked extensively on the anatomy of living animals. 他在活体解剖方面经验丰富。</p>
<p>相关词义延伸：
· framework还可指一栋建筑物（或一个物体）的框架、结构（起支撑作用，同时构成了其形状）；
· anatomy还可指解剖学。</p>
<p>· 表示“几何结构”的词群见[[01图形 形状]]
· 表示“建筑结构”的词群见[[08建筑结构 建筑构造]]
· 表示“实体结构”的词群见[[02实体 结构]]
· 表示“语法结构”的词群见[[15语法 结构]]</p>
<p>☀ <span class="category"><strong>组成的动词：</strong></span>
<span class="vocabulary"><strong>comprise</strong></span> [kəmˈpraɪz]
<span class="definition">vt.（不用于进行时）是（某事物的）组成部分，即组成、构成。相当于make sth up：</span>Older people comprise a large proportion of those living in poverty. 在那些生活贫困的人中，老年人占有很大的比例。/ Women comprise 44% of hospital medical staff. 女性占医院医护人员的44%。/ the multitude of ideas, ambitions and regrets that comprises the culture of Russia today 构成现今俄罗斯文化的众多观点、抱负和遗憾</p>
<p><span class="vocabulary"><strong>form</strong></span> [fɔ:m]
<span class="definition">vt. 构成：</span>the articles that formed the basis of Randolph’s book 构成伦道夫的书的基础的那些文章</p>
<p><span class="vocabulary"><strong>compound</strong></span> [ˈkɒmpaʊnd; 美 ˈkɑ:m-]
<span class="definition">vt. be compounded of/from sth [正式] 由…构成或形成：</span>The DNA molecule is compounded from many smaller molecules. 脱氧核糖核酸分子是由许多更小的分子组成的。</p>
<p><span class="vocabulary"><strong>structure</strong></span> [ˈstrʌktʃə(r)]
<span class="definition">vt. ~ sth (around sth) 使形成体系；系统安排；精心组织：</span>a very loosely structured organization 结构相当松散的组织 / The company is structured into two divisions. 该公司由两个部门组成。/ The organization is structured according to business principles. 该机构是按照商业原则组织起来的。/ The nation was structured as a federation of states. 整个国家形成了州联邦的体系。/ a complex but highly structured complaints procedure 一个复杂但高度结构化的投诉程序 / By structuring the course this way, we're forced to produce something the companies think is valuable. 这样制定发展规划后，我们不得不生产各公司认为有价值的东西。/ The exhibition is structured around the themes of work and leisure. 展览是围绕工作与休闲的主题来布置的。/ Make use of the toys in structured group activities. 在精心安排的分组活动中可以使用这些玩具。/ How well does the teacher structure the lessons? 老师对课程组织安排得如何？/ The teaching is structured around three topics. 教学围绕三个话题组织展开。/ She had structured her arguments very carefully. 她的论据组织得很周密。/ a tightly structured drama 编排紧凑的剧本 / Relations between women and men are structured by gender. 男女之间的关系是建立在性别差异基础上的。</p>
<p><span class="vocabulary"><strong>figure</strong></span> ['fɪɡə]
<span class="definition">vi. figure (as sth) (in/among sth) 无被动形式，指出现于…或被包括于…中，是某个进程、情况等的一部分（常是重要部分），相当于feature：</span>Environmental protection figured prominently in the report. 环境保护出现在报告中的显要位置。/ Nuclear disarmament is likely to figure prominently in the talks. 核裁军很可能是这次会谈的重点。/ He didn’t think their suggestions figure at all. 他认为他们的意见无足轻重。/ It did not figure high on my list of priorities. 这不在我最优先处理的事项之内。/ Vegetables hardly figure at all in their diet. 他们的食谱中几乎见不到蔬菜。/ This man did not figure among the suspects. 这名男子不在嫌疑犯之列。</p>
<p>相关词义延伸：
· compound还可指混合、掺和。</p>
<p>☀ <span class="category"><strong>组成、构成的名词和形容词：</strong></span>
<span class="vocabulary"><strong>composition</strong></span> [͵kɒmpə'zɪʃn]
<span class="definition">n. [U] 成分；构成方式：</span>the chemical composition of the mixture 该混合物的化学成分 / mineralogical composition 矿物成分 / the composition of the committee 委员会的组成 / the changing composition of the workforce 劳动力不断变化的构成 / age, class, family, species composition 年龄构成；阶层构成；家庭构成；物种构成</p>
<p><span class="vocabulary"><strong>constitution</strong></span> [͵kɒnstɪ'tju:ʃn]
<span class="definition">n. 1 [U, C] 某事物的构成或组织方式，为正式用法。与structure同义，如：</span>the genetic constitution of cells 细胞的基因构造 <span class="definition">2 [U] 组成，构成，为正式用法，语义相当于establishment或setting up，如：</span>He recommended the constitution of a review committee. 他建议设立审查委员会。</p>
<p><span class="vocabulary"><strong>make-up</strong></span>
<span class="definition">n. [sing.] ~ (of sth) 组成成分；构成方式：</span>the make-up of a TV audience 电视观众的构成 / the page make-up of a text (= the way in which the words and pictures are arranged on a page)（术语）文本的版面设计 / The ideological make-up of the unions is now radically different from what it had been. 协会的思想观念与过去截然不同。/ the chemical make-up of the oceans and atmosphere 海洋与大气的化学构造 / biological make-up 生理结构 / physical make-up 体质</p>
<p><span class="vocabulary"><strong>compound</strong></span> [ˈkɒmpaʊnd; 美 ˈkɑ:m-]
<span class="definition">adj. [只用于名词前] [术语] 由两个或两个以上事物构成的，即复合的：</span>a compound adjective, such as fair-skinned 复合形容词，如fair-skinned / A compound sentence contains two or more clauses. 复合句包含两个或多个从句。/ the compound eye of a wasp 黄蜂的复眼 / a tall shrub with shiny compound leaves 长有油光闪亮的复叶的高株灌木 / the compound microscope 复式显微镜</p>
<p><span class="vocabulary"><strong>composite</strong></span> [ˈkɒmpəzɪt; 美 kəmˈpɑ:zət]
<span class="definition">adj. [只用于名词前] 由不同部分组成的；由不同材料制成的：</span>a composite picture (= one made from several pictures) 拼图 / Galton devised a method of creating composite pictures in which the features of different faces were superimposed over one another. 高尔顿发明了一种把不同人的五官相互叠加在一起的制作合成照片的方法。/ Through interviews and old photos we put together a composite picture of life in the village a hundred years ago. 通过采访和获得的老照片，我们拼出了一副一百年前该村庄的生活图画。<span class="definition">n. [C] 由不同部分组成的事物；由不同材料制成的事物：</span>The document was a composite of information from various sources. 这份文件是不同来源信息的综合。</p>
<p>相关词义延伸：
· composition还可指美术（如绘画或摄影）中对人或物体的安排布置（美术中可称作构图）；
· compound还可指化合物。也可指复合词；
· composite还可为美式用法，相当于Identikit，即艾登蒂基特容貌拼图（根据目击者描述拼制出人的面部像，尤指警方要捉拿的人）。</p>
<p>· 表示“包含”的词群见[[06包含 构成]]
· 表示“参加”、“加入”的词群见[[12参加 加入]]</p>
<p>☀ <span class="category"><strong>部分、局部的名词：</strong></span>
<span class="vocabulary"><strong>part</strong></span> [pɑːt]
<span class="definition">n. 1 [U] part of sth 部分。是一个基础用词，也是一个常规用词，含义最为广泛，也最常用：</span>We spent part of the time in the museum. 我们花了一部分时间在博物馆。/ Part of the building was destroyed in the fire. 大楼的一部分毁于火灾。/ Part of me feels sorry for him. 我有点同情他。/ The worst part was having to wait three hours. 最糟糕的是要等三个小时。<span class="definition">2 [C] 某事物的一个片段、部分或一点儿：</span>the early part of her life 她年轻的时候 / The novel is good in parts. 小说的一些章节不错。/ We’ve done the difficult part of the job. 我们已完成了工作的困难部分。<span class="definition">3 [U] 成员；成分：</span>You need to be able to work as part of a team. 你必须能作为团队的一员去工作。</p>
<p><span class="vocabulary"><strong>proportion</strong></span> [prəˈpɔ:ʃn; 美 -ˈpɔ:rʃn]
...
<p><span class="vocabulary"><strong>component</strong></span> [kəm'pəʊnənt]
<span class="definition">n. [C] 某事物的组成部分：</span>Our software is becoming a standard component of many computer systems. 我们的软件正在成为许多计算机系统的标准组成部分。/ chemical, genetic component 化学成分；基因成分 / course component 课程组成部分 / The plan has three main components. 该计划有三个主要组成部分。/ a crucial component in our success 我们成功的一个重要因素</p>
<p><span class="vocabulary"><strong>section</strong></span> ['sekʃn]
<span class="definition">n. [C] 某事物被划分后所形成的各部分之一：</span>That section of the road is still closed. 那段公路依旧封闭。/ the tail section of the plane 飞机的尾部 / large sections of the forest 大片森林 / I skipped the section on garden design. 我跳过了园艺设计那部分。/ fiction section（图书馆、书店等）小说分区 / You’ll find the book in the music section. 你可以在音乐区找到这本书。</p>
<p><span class="vocabulary"><strong>piece</strong></span> [pi:s]
<span class="definition">n. 1 [C] piece (of sth)（尤与of和不可数名词连用）从…上所切下或分离出的一定数量的某事物：</span>a piece of string 一截绳子 / the best piece of land 最好的一块土地 / Cut the ham into pieces. 把火腿切成片。<span class="definition">2 [C, usually pl.] 碎片，碎块等：</span>tiny pieces of glass 碎玻璃渣 / The boat had been smashed to pieces on the rocks. 小船在岩石上撞得粉碎。/ This chair comes to pieces. 这把椅子散架了。/ She tore the letter into tiny pieces. 她把信撕得粉碎。/ The book breaks the information into bite-sized pieces.（比喻用法）这本书是把信息掰开了揉碎了讲的。<span class="definition">3 [C]（尤与of和不可数名词连用）某种类型中的一个，尤指一套中的一件或一台等：</span>a piece of clothing 一件衣服 / a piece of furniture 一件家具 / a piece of luggage 一件行李 / a piece of equipment 一台设备 <span class="definition">4 [sing.] [尤美] piece of sth 某事物的一个部分或份额：</span>companies seeking a piece of the market 争取市场份额的公司</p>
<p><span class="vocabulary"><strong>fragment</strong></span> [ˈfrægmənt]
<span class="definition">n. [C] 碎片、片段：</span>Police found fragments of glass near the scene. 警方在现场附近发现了玻璃碎片。/ The shattered vase lay in fragments on the floor. 打碎的花瓶在地上成了一堆碎片。/ fragments of pottery 陶器碎片 / rock fragment 岩石碎块 / fragments of metal in my shoulder 我肩膀里的几块金属碎片 / I overheard a fragment of their conversation. 我无意中听到他们谈话的只言片语。/ She read everything, digesting every fragment of news. 她什么都看，对新闻的每个片段都细细品味。/ a fragment of information 一个信息碎片 / We had difficulty in piecing together the fragments of her story. 我们很难把她那支离破碎的故事片段拼合起来。</p>
<p><span class="vocabulary"><strong>shred</strong></span> [ʃred]
<span class="definition">n. [usually pl.]（撕或切的）小薄片：</span>shreds of paper 碎纸片 / the tattered shreds of their flag 他们的旗帜的碎片 / Just a few shreds of cloth were left. 只剩下一些碎布条。/ His jacket had been torn to shreds by the barbed wire. 他的夹克被铁丝网挂得稀烂。/ Cut the cabbage into fine long shreds. 将卷心菜切成又细又长的丝。/ Cut the orange peel into fine shreds. 把橘子皮切成细丝。/ Their economy is in shreds.（比喻用法）他们的经济千疮百孔。/ Their case was torn to shreds by the defence lawyer.（比喻用法）他们的论据被辩护律师驳得体无完肤。</p>
<p><span class="vocabulary"><strong>bit</strong></span> [bɪt]
<span class="definition">n. [C] [尤英]（某个更大事物的）一部分：</span>a big bit of stone 一大块石头 / The best bit of the trip was seeing the Grand Canyon. 这次旅行最精彩的一段就是游览大峡谷。/ a nice bit of fish 一块儿不错的鱼 / I read it, but I skipped the boring bits. 我读过了，但跳过了乏味的部分。/ He managed to get odd bits of work, but no regular job. 他设法找了些零工，但没有固定的工作。/ Listen to the interview again and pick out the bits you want to use in the article. 再听一遍采访，选出你想用在文章里的内容。/ All the crockery had been smashed to bits. 所有的陶器都给摔成了碎片。/ do your bit（非正式用法）尽自己的那部分责任</p>
<p><span class="vocabulary"><strong>sector</strong></span> [ˈsektə(r)]
<span class="definition">n. [C] 部分：</span>a sector of the population 人口的一部分</p>
<p><span class="vocabulary"><strong>strand</strong></span> [strænd]
<span class="definition">n. [C]（观点、计划、故事、理论等的）部分：</span>There had been two strands to his tactics. 他的策略分两个部分。/ There are three main strands to the policy. 该政策有三个主要部分。</p>
<p><span class="vocabulary"><strong>share</strong></span> [ʃeə]
<span class="definition">n. 1 [C, usually sing.] 在两人或更多人之间所分得的某事物的一部分，即一份，是一个常规用词：</span>to have a bigger share of the market 获得更大的市场份额 / You should receive a large share of the profits. 很大一部分利润应该归你。<span class="definition">2 [sing.] share (of sth)（在若干人参加的一项活动中）某人所占的一份：</span>We all did our share. 我们都尽力了。/ Everyone must accept their share of the blame. 每个人都必须承担自己那份责任。<span class="definition">3 [sing.] share (of sth)（对于一个人来说）数额正常（或数额可接受）的一份某事物：</span>I’ve had my share of luck in the past. 以前，命运也不算亏待我。/ Everyone wants to claim their share of fame and fortune. 所有人都追逐名利。/ She has seen her share of suffering. 她遭报应，吃了不少苦。/ The industry has had its fair share of problems. 这个行业也有其本身的问题。</p>
<p><span class="vocabulary"><strong>portion</strong></span> [ˈpɔ:ʃn; 美 ˈpɔ:rʃn]
<span class="definition">n. 1 [C] 部分：</span>Only a small portion of the budget is spent on books. 购书只占预算的一小部分。/ Salaries take up a considerable portion of our total budget. 薪水占我们整个预算相当大的一部分。/ The central portion of the bridge collapsed. 桥的中段坍塌了。/ Damage was confined to a small portion of the castle. 城堡仅有一小部分受损。/ a substantial/significant portion of the population 人口中的一大部分/重要部分 / I have spent a fairly considerable portion of my life here. 我生命中相当长的一段时光是在这里度过的。<span class="definition">2 [C]（足够一个人吃的）食物的一份：</span>double, generous, large 双份；大份 / small, tiny portion 小份 / individual portion 一人份 / Eat smaller portions at regular intervals. 定期吃一小部分。/ He asked for a large portion of salad. 他要了一大份色拉。/ a generous portion of meat 一大份肉 / Desserts can be substituted by a portion of fresh fruit. 餐后甜点可以用一份新鲜水果代替。/ She cut the cake into six small portions. 她把蛋糕切成了六小份。/ The portions were generous. 每份饭菜分量都很足。<span class="definition">3 [usually sing.] 与人分享或分担的一份。相当于share：</span>You must accept a portion of the blame for this crisis. 你必须承担这次危机的一部分责任。</p>
<p><span class="vocabulary"><strong>slice</strong></span> [slaɪs]
<span class="definition">n. [C] [非正式] 某事物的一个部分或份额：</span>a large slice of the market 一大块市场份额 / a fair slice of the budget 相当一部分预算 / a large slice of the profits 一大块利润 / a slice of life（电影、戏剧、书籍等）反映现实生活的一个侧面 / a slice of the pie（金钱、利润等的）一部分 / a slice of luck（英）运气 / Many investors are hoping to grab a slice of the action. 许多投资者都希望分得一杯羹。</p>
<p><span class="vocabulary"><strong>cut</strong></span> [kʌt]
<span class="definition">n. [C]（尤指钱的）份数，份额。不太常用：</span>The agency has taken a cut of the money awarded to its client. 这个代理商已从奖给其客户的钱中抽取了一份。/ He takes a cut of the profits. 他获得了一份利润。</p>
<p><span class="vocabulary"><strong>split</strong></span> [splɪt]
<span class="definition">n. [sing.] 从某事物中划分出的一个部分（如份额）：</span>He demanded a 50–50 split in the profits. 他要求利润对半分。</p>
<p><span class="vocabulary"><strong>segment</strong></span> [ˈsegmənt]
<span class="definition">n. [C] 从其他部分中分离出来的部分（该部分可以单独考量）：</span>She cleaned a small segment of the painting. 她擦干净了这幅画的一小部分。/ Lines divided the area into segments. 这一地区用线条分成了若干部分。/ the third segment of his journey 他此行的第三程 / the poorer segments of society 社会中的较贫穷阶层 / Three-to-five day cruises are the fastest-growing segment of the market. 3 至 5 天的乘船游览是该市场中发展最快的部分。/ Women's tennis is the market leader in a growing market segment — women's sports. 女子网球正引领着一个逐渐壮大的市场——女子运动市场。</p>
<p><span class="vocabulary"><strong>allotment</strong></span> [əˈlɒtmənt; 美 əˈlɑ:t-]
<span class="definition">n. [正式] 分配给某人的某事物的数量：</span>Water allotments to farmers were cut back in the drought. 在干旱时期配给农民的水量减少。/ His meager allotment of gas had to be saved for emergencies. 他分到的那一点点煤气必须留着急用。</p>
<p><span class="vocabulary"><strong>rest</strong></span> [rest]
<span class="definition">n. 1 [sing.] the rest (of sth) 某事物剩余的部分，即其余：</span>the rest of my life 我的余生 / the rest of the day 后半天 / Take what you want and throw the rest away. 把你想要的拿走，其余的扔掉。<span class="definition">2 [pl.] the rest (of sth) 其余的人或事物；其他：</span>The first question was difficult, but the rest were pretty easy. 第一个问题很难，但其余的都相当简单。</p>
<p><span class="vocabulary"><strong>remainder</strong></span> [rɪˈmeɪndə(r)]
<span class="definition">n. 1 [sing.]（通常用the remainder）其余的人员、事物或时间：</span>I kept some of his books and gave away the remainder. 我保留了一些他的书，其他的都送人了。/ He gulped down the remainder of his coffee. 他把剩下的咖啡一口气喝了下去。/ I spent the remainder of the day feeling terrible. 我那天余下的时间里心情都很糟糕。/ the remainder of your life 余生 <span class="definition">2 [C] 被剩下的图书：</span>了解即可</p>
<p><span class="vocabulary"><strong>contribution</strong></span> [͵kɒntrɪ'bju:ʃn]
<span class="definition">n. [C] contribution (to sth) / contribution [toward(s) sth/doing sth] 一部书、一本杂志、一个广播节目、一次讨论等的一部分：</span>Each of these writers has made an individual contribution to the discussion. 这些作家在这场讨论中个个都发了言。/ All contributions for the May issue must be received by Friday. 所有要在五月这一期发表的稿件必须在星期五以前寄到。</p>
<p><span class="vocabulary"><strong>half</strong></span> [hɑːf]
<span class="definition">n. [C]（体育比赛、音乐会等的）半场或半局：</span>No goals were scored in the first half. 上半场没有得分。</p>
<p><span class="vocabulary"><strong>way</strong></span> [weɪ]
<span class="definition">n. [C] 部分（用于构成合成词）：</span>a simple three-way division 一种简单的三分法</p>
<p><span class="vocabulary"><strong>conglomerate</strong></span> [kənˈglɒmərət; 美 -ˈglɑ:m-]
<span class="definition">n. [sing.] [正式] 组合成一个整体的一些事物或部分：</span>了解即可</p>
<p>相关词义延伸：
· segment还可指（柑橘、柠檬等的）瓣。也可在几何学中表示从圆形中分离出来的一部分，即弓形、圆缺。亦可在语音学中表示一个词可以划分出的最小语音部分，即音段；
· sector还可指（尤指一国经济的）领域、行业、部门。也可指阶层。亦可指（尤指处于军事管制之下的）区域、地带。</p>
<p>周边词汇补充：
· instalment可指（报章连载小说的）一节；（电视连续剧的）一集；（分步执行的计划的）一步；
· crumb可指从大块食物上掉落的碎屑，尤指面包屑或蛋糕屑；
· snippet可指一小条消息。也可指一小段交谈、音乐等。</p>
<p>☀ <span class="category"><strong>部分的其它词性：</strong></span>
<span class="vocabulary"><strong>some</strong></span> [sʌm, səm, sm]
<span class="definition">pron. some (of sb/sth) 所考虑的全部数量中的一部分，即有些，有的，部分等：</span>All these students are good, but some work harder than others. 所有这些学生都不错，但有的用功多些，有的用功少些。</p>
<p><span class="vocabulary"><strong>half</strong></span> [hɑːf]
<span class="definition">det., pron. half the time, fun, trouble, etc. 某事物（如时间、乐趣、麻烦等）的最大一部分：</span>half the fun of gardening 园艺的最大乐趣 / Half the time you don’t even listen to what I say. 你大部分时间甚至没听我说的话。</p>
<p><span class="vocabulary"><strong>part</strong></span> [pɑːt]
<span class="definition">adv. 常构成复合词，指由两部分构成；在一定程度上；部分地：</span>She’s part French, part English. 她是英法血统各半。/ His feelings were part anger, part relief. 他感到既愤怒，又解脱。</p>
<p><span class="vocabulary"><strong>partly</strong></span> ['pɑːtlɪ]
<span class="definition">adv. 一定程度上；部分地：</span>He was only partly responsible for the accident. 他对这次事故只负有部分责任。</p>
<p><span class="vocabulary"><strong>half</strong></span> [hɑːf]
<span class="definition">adv. 部分地：</span>The chicken was only half cooked. 鸡只煮了半熟。/ His eyes were half closed. 他的双眼半闭着。/ His refrigerator frequently looked half empty. 他的冰箱经常看上去有点儿空。</p>
<p><span class="vocabulary"><strong>partial</strong></span> [ˈpɑ:ʃl; 美 ˈpɑ:rʃl]
<span class="definition">adj. 部分的、不完全的：</span>It was only a partial solution to the problem. 那只是部分地解决了这个问题。/ a partial eclipse of the sun 日偏蚀 / He managed to reach a partial agreement with both republics. 他设法与两个共和国都达成了部分协议。/ a partial ban on the use of cars in the city 市内部分地段轿车禁行令 / His efforts met with only partial success. 他的努力只获得了部分成功。/ The information we have is somewhat partial. 我们得到的信息不怎么全面。/ The resulting assessment is necessarily partial and subjective. 评估结果难免会有偏颇和带有主观性。</p>
<p><span class="vocabulary"><strong>patchy</strong></span> [ˈpætʃi]
<span class="definition">adj.（美式英语也用spotty）不完整的：</span>a patchy knowledge of Spanish 对西班牙语一知半解 / It was a patchy performance. 那是一场素质不齐的演出。/ The evidence is patchy. 证据不充分。/ The local provision of facilities is extremely patchy. 当地提供的设施极不充分。</p>
<p><span class="vocabulary"><strong>incomplete</strong></span> [ˌɪnkəmˈpli:t]
<span class="definition">adj. 不完整的：</span>an incomplete set of figures 一组不完整的数字 / Spoken language contains many incomplete sentences. 口语中有很多不完整的句子。/ European political union would be incomplete without a defence element. 如果没有防御体系，欧洲政治联盟就不完整。/ Her collection remained incomplete. 她的收藏还是不全。/ Any view of Shostakovich is seriously incomplete without knowledge of these recordings. 如果不了解这些唱片，关于肖斯塔科维奇的任何观点都是极不全面的。/ We begin with a brief and necessarily incomplete review of UK statistics. 我们先简要地回顾一下英国的统计数字，当然并不全面。</p>
<p><span class="vocabulary"><strong>component</strong></span> [kəm'pəʊnənt]
<span class="definition">adj. 组成的：</span>the component parts 组成部分</p>
<p><span class="vocabulary"><strong>constituent</strong></span> [kənˈstɪtjuənt; 美 -tʃu-]
<span class="definition">adj. [只用于名词前] [正式] 组成的、构成的一个整体的：</span>to break something up into its constituent parts/elements 把某物分离为各个组成部分（或要素）/ a plan to split the company into its constituent parts and sell them separately. 把公司按组成部分分割后分别出售的计划 / the leaders of Russia's constituent republics 俄联邦各成员国的领导人</p>
<p>相关词义延伸：
...
· body可指某事物（尤指建筑物、交通工具、书籍、文章等）的主体或主要部分。</p>
<p>· 表示“零件”、“部件”的词群见[[05零件 部件]]
· 表示“部门”的词群见[[05分支 部门]]
· 表示“阶层”的词群见[[21阶级 阶层]]
