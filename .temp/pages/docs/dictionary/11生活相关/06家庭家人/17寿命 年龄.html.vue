<template><div><p>☀ <span class="category"><strong>寿命 年龄：</strong></span>
...
<span class="definition">n. 1 [C, U] 人的年龄。是此义的常规用词：</span>She lived to the age of 75. 她活到了75岁。 / retirement age 退休年龄 / children of school age 学龄儿童 / mental age 心理年龄 / age structure 年龄结构（或年龄分布）<span class="definition">2 [C, U] 一个人的年龄段：</span>at an early age 幼年 / young age 年轻时代（或童年）/ middle age 中年 / 30 is an awkward age. 30岁是个尴尬的年龄。/ When you get to my age you get a different perspective on life. 你到我这个年纪时就会对人生有不同的看法。</p>
<p><span class="vocabulary"><strong>year</strong></span> [jə:]
<span class="definition">n. [C, usually pl.] 年龄，年纪。常与数字联用，表示具体的年龄（而age则无此限制）：</span>He was 14 years old when it happened. 这件事情发生的时候，他14岁。/ In his later years, he drifted away from politics. 他晚年逐渐远离了政治。</p>
<p><span class="vocabulary"><strong>at</strong></span> [æt]
<span class="definition">prep.（某人做某事时）在…岁：</span>She got married at 25. 她25岁结的婚。/ He left school at the age of 16. 他16岁便离开了学校。</p>
<p><span class="vocabulary"><strong>old</strong></span> [əʊld]
<span class="definition">adj. be ... years, months, etc. old 年龄为…：</span>The baby was only a few hours old. 婴儿才出生几个小时。/ fifteen years old 十五岁 / How old is this building?（拟人用法）这座建筑已有多少年了？/ He’s the oldest player in the team. 他是队里年龄最大的队员。</p>
<p><span class="vocabulary"><strong>chronological</strong></span> [ˌkrɒnəˈlɒdʒɪkl; 美 ˌkrɑ:nəˈlɑ:dʒ-]
<span class="definition">adj. [正式] ~ age 按时间计算的（年龄）（相对于身体、智力或情感等方面的发展而言）：</span>了解即可</p>
<p><span class="vocabulary"><strong>under</strong></span> ['ʌndə]
<span class="definition">prep. 在某个年龄以下：</span>jobs for those under 35 适合35岁以下人士的工作 / Nobody under 18 is allowed to play the game. 未满18岁者不得玩本游戏。<span class="definition">adv. 在某个年龄以下：</span>children aged 12 and under 12岁及以下的儿童</p>
<p>相关词义延伸：
· age还可指事物的年龄。</p>
<p>周边词汇补充：
· majority可指成年的法定年龄；
