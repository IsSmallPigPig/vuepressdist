...
<span class="definition">n. [C]（人生的）一件事件或情况；（小说的）事件或情况：</span>I still remember that episode from my childhood. 我依然记得自己童年时期的那一件事。/ This episode is bound to be a deep embarrassment for Washington. 这一事件肯定会让华盛顿非常难堪。</p>
<p><span class="vocabulary"><strong>list</strong></span> [lɪst]
<span class="definition">n. [C]（按一定顺序排列的）系列事项：</span>High on the list of public demands is to end military control of broadcasting. 高居公众要求事项前列的是结束对广播的军事控制。</p>
<p><span class="vocabulary"><strong>repeat</strong></span> [rɪ'pi:t]
<span class="definition">n. [C] 与以前发生的事件极其相似的一次事件：</span>A repeat of the 1906 earthquake could kill up to 11 000 people. 如果再次发生1906年的地震，可能会有多达11000人死亡。/ She didn’t want a repeat performance of what had happened the night before. 她不想让前一天晚上的事再次发生。/ a repeat order（商业用语）续订货单</p>
<p><span class="vocabulary"><strong>saga</strong></span> [ˈsɑ:gə]
<span class="definition">n. [C] 一长串的事件或冒险经历，或者对此事件或冒险经历的讲述或记述：</span>the continuing saga of unexpected failures by leading companies 几家龙头公司突然接连倒闭 / the saga of how I missed the plane（幽默用法）有关我如何误了飞机的一连串倒霉事儿</p>
<p><span class="vocabulary"><strong>show</strong></span> [ʃəʊ]
<span class="definition">n. [sing.] 组织或执行事务的一个场面（或一次事件），为非正式用法：</span>She runs the whole show. 整个这一摊儿都归她管。/ I won’t interfere--it’s your show. 我不想插手——这归你管。</p>
<p><span class="vocabulary"><strong>stroke</strong></span> [strəʊk; 美 stroʊk]
<span class="definition">n. [C] ~ (of sth) 成功的事件：</span>It was a stroke of luck that I found you here. 我在这儿看见你纯属运气。/ It didn't rain, which turned out to be a stroke of luck. 天没下雨，结果成了件幸事。</p>
<p>相关词义延伸：
· affair还可指桃色事件、暧昧关系；
