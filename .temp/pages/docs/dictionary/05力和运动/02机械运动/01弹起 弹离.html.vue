<template><div><p>☀ <span class="category"><strong>弹起 弹离：</strong></span>
<span class="vocabulary"><strong>bounce</strong></span> [baʊns]
<span class="definition">vt.＆vi. 从撞击的表面弹起或弹离：</span>The ball bounced twice before he could reach it. 球弹了两次他才接到。/ She bounced the ball against the wall. 她对着墙打球。/ Short sound waves bounce off even small objects. 短声波即使遇到小物体都会发生反射。/ The light bounced off the river and dazzled her. 河面上波光粼粼，令她目眩。/ The idea had been bouncing around in my head for some time.（比喻用法）有一段时间，这个念头一直在我的脑海里挥之不去。<span class="definition">n. [C] 弹起：</span>one bounce of the ball 球的一次弹起</p>
...
<p>相关词义延伸：
· rebound还可指（价格等）（下降后）回升、反弹。也可指（不振之后的）复兴、振作。</p>
<p>· 表示“弹跳”的词群见[[04走跑跳踢 跺脚劈叉]]
· 表示“弹性”、“弹力”的词群见[[09力学 运动]]</p>
</div></template>
