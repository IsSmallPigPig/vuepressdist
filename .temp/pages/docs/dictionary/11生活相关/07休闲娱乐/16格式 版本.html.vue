<template><div><p>☀ <span class="category"><strong>格式 版本：</strong></span>
<span class="vocabulary"><strong>format</strong></span> ['fɔ:mæt]
<span class="definition">n. [C] 电影、音乐录制品等的格式：</span>His latest album is available on all formats. 他的最新专辑有各种格式可以买到。/ digital format 数码格式 / DVD format DVD格式</p>
