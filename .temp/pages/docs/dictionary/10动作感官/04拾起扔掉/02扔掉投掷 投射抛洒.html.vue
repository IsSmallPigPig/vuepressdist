<template><div><p>☀ <span class="category"><strong>扔掉投掷 投射抛洒：</strong></span>
<span class="vocabulary"><strong>cast</strong></span> [kɑːst]
<span class="definition">vt. [文学]（尤指用力）将某人或某事物扔（或投、掷、抛等）向某地：</span>The box was cast into the river. 盒子被扔进了河里。/ to cast anchor 抛锚停泊</p>
...
· pitch还可指（在棒球运动中）将（球）投给击球员。</p>
<p>周边词汇补充：
· dash可指将…猛地投掷到…的表面，或击打…的表面（常由于动作太猛而造成物体破碎）。即猛掷、猛摔；
· over可指板球运动中的一轮投球（由同一个投球手连续投出的六个球）；project还可指从一个边缘或平面突出来。</p>
<p>· 表示“抛弃”的词群见[[21禁止 放弃 容忍 忍受 克制]]</p>
</div></template>
