<template><div><p>☀ <span class="category"><strong>次数 重复：</strong></span>
<span class="vocabulary"><strong>frequency</strong></span> [ˈfri:kwənsi]
<span class="definition">n. [U, C] 某事的发生率、重复率：</span>Accidents of this sort are happening with increasing frequency. 此类事故发生得越来越频繁了。/ Fatal road accidents have decreased in frequency over recent years. 近年来致命交通事故发生率已经下降。/ The drug can reduce the frequency and severity of attacks. 这种要能降低发病的次数和严重程度。/ The frequency of Kara's phone calls increased rapidly. 卡拉的电话飞速增多。/ The tanks broke down with increasing frequency. 坦克越来越频繁地熄火。/ a society with a low frequency of stable marriages 婚姻稳定率低的社会 / The program can show us word frequency (= how often words occur in a language). 这个程序可给我们显示词频。</p>
<p><span class="vocabulary"><strong>rate</strong></span> [reɪt]
<span class="definition">n. [C] 某事发生的频率：</span>New diet books appear at a rate of nearly one a week. 饮食方面的新书以几乎每周一本的频率出版。</p>
<p><span class="vocabulary"><strong>time</strong></span> [taɪm]
<span class="definition">n. [C]（做某事或某事发生的）次，回；还可指时机：</span>every time 每次 / next time 下次 / He failed his driving test three times. 他考了三次驾驶执照都没通过。/ When was the last time you saw her? 你上次是什么时候见到她的？</p>
...
<span class="definition">adv. 仅仅一次；一次：</span>I’ve only been there once. 我只去过那里一次。/ He cleans his car once a week. 他每周洗一次汽车。<span class="definition">pron. 一次：</span>“Have they been to visit you yet?”--“Just the once, yeah.” “他们已经去看过你了吗？”——“来过，就那一次。”</p>
<p><span class="vocabulary"><strong>recur</strong></span> [rɪˈkɜ:(r)]
...
· reproduce可指再次产生；以相同的方式使某事再次发生。</p>
<p>· 表示“节奏”的词群见[[14快慢]]
· 表示“重说”、“复述”的词群见[[09重说 复述]]</p>
</div></template>
