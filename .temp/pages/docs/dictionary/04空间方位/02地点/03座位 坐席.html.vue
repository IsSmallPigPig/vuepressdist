...
<span class="definition">n. [C] 剧院中的包厢；法庭中的专席（均与其他人的座位分开）等：</span>a box at the opera 歌剧院的包厢 / jury, witness box 陪审团席；证人席 / soundproof box 隔音室 / commentary（英）, press box 解说员席；新闻记者席 / private box 私人包厢</p>
<p><span class="vocabulary"><strong>place</strong></span> [pleɪs]
<span class="definition">n. [C] 位置；座位等（尤指可为人或车辆所占用，或正被占用的位置）：</span>Come and sit here--I’ve saved you a place. 到这儿来坐吧。我给你留了个座位。/ The boy returned to his place. 男孩回到了自己的座位上。/ She showed them to their places. 她领他们入座。</p>
<p><span class="vocabulary"><strong>head</strong></span> [hed]
<span class="definition">n. [C] 单数名词，the head of the table 指桌子周围最重要的一个座位，即上座：</span>to sit at the head of the table 坐在上座</p>
<p>相关词义延伸：
· seat还可指（椅子等的）可坐的部位。</p>
<p>周边词汇补充：
· bench可指法官所坐的席位、（英国议会的）某一群政治家所坐的一个席位、当运动员休息时（此刻未进行比赛）所坐的一些座位（可称为运动员休息区）；
· throne可指（国王、女王的）宝座；
· perch可指高的座位。</p>
<p>· 表示“建筑”的词群见[[01建筑 房屋]]</p>
</div></template>
