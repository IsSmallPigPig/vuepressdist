...
· carbon可表示（文件、信件等的）复写本（即用复写纸印出来的文件、信件等），相当于carbon copy。</p>
</div></template>
