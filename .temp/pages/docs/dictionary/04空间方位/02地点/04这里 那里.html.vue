<template><div><p>☀ <span class="category"><strong>这里 那里：</strong></span>
<span class="vocabulary"><strong>here</strong></span> [hɪə]
<span class="definition">adv. 1 用于动词或介词后，表示在这里，向这里，到这里（这里指的是一个地方）：</span>I live here. 我住这儿。/ Put the box here. 把箱子放在这里。/ if you will just sign here 如果你愿意就在这里签字 <span class="definition">2 在这一点（例如时间点、情况或主题的一个节点）上：</span>The countdown to Christmas starts here. 现在开始圣诞节倒计时。/ Economic recovery is here. 经济复苏现在开始了。/ Here the speaker paused to have a drink. 讲到这里，演讲人停下来喝了口水。/ It’s here that we come up against the difference of approach. 正是在这一点上我们遇到方法上的分歧。</p>
