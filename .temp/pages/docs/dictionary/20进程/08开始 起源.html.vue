...
<span class="definition">vi. 是…的结果，即起源于…：</span>Ethiopia’s art springs from its early Christian as well as its Muslim heritage. 埃塞俄比亚的艺术起源于其早期的基督教和穆斯林教遗产。<span class="definition">vt. spring sth (on sb) 让某人意想不到地去做某事：</span>She sprang a surprise by winning the tournament. 这次比赛她获得冠军，爆了个大冷门。</p>
<p><span class="vocabulary"><strong>come</strong></span> [kʌm]
<span class="definition">vi. 1 来自（某个地方或事物）：</span>Nearly half the students come from overseas. 几乎一半学生来自海外。/ Chocolate comes from the cacao tree. 巧克力来自可可树。<span class="definition">2 源自：</span>There is a feeling of power that comes from driving fast. 开快车可以产生力量感。/ Some good might come of all this gloomy business. 某种好的结果也许会从这种惨淡的经营中产生。</p>
<p><span class="vocabulary"><strong>born</strong></span> [bɔ:n]
<span class="definition">vt. 仅用于被动式，且不用by，指（思想、组织机构、感情等）产生，诞生：</span>The idea was born in his study. 这个想法是在他的书房里产生的。/ The CIA was born at that time. 中央情报局那时便诞生了。/ He acted with a courage born (out) of desperation. 绝望驱使他鼓起勇气，做出行动。/ The movement was born in the university. 该运动诞生于这所大学。</p>
<p><span class="vocabulary"><strong>originate</strong></span> [əˈrɪdʒɪneɪt]
<span class="definition">vi. [正式] 在某地或某种情况中头一次发生或出现，即起源、发源于：</span>The disease is thought to have originated in the tropics. 这种疾病据说起源于热带地区。/ The disease originated in Africa. 这种病源于非洲。/ All carbohydrates originate from plants. 所有的碳水化合物均来自植物。/ He believes that all religions originated from a single source. 他认为所有的宗教都有同一个本源。</p>
...
· renewal可指（中断后的）重新开始。</p>
<p>☀ <span class="category"><strong>开始、起源的其它词性：</strong></span>
<span class="vocabulary"><strong>rooted</strong></span> [ˈru:tɪd]
<span class="definition">adj. ~ in sth 起源于…的；由…产生的；受某事的强烈影响的：</span>His problems are deeply rooted in his childhood experiences. 他的问题的祸根在于他童年的经历。/ The crisis is rooted in deep rivalries between the two groups. 这场危机的根源是这两个群体之间积怨已深的敌对情绪。/ powerful songs rooted in traditional African music 起源于传统非洲音乐的打动人心的歌曲</p>
<p><span class="vocabulary"><strong>from</strong></span> [frɒm]
<span class="definition">prep. 1 起始于某地：</span>the train from London 从伦敦开来的火车 / He began to walk away from her. 他开始离她而去。/ to flee from the room 逃离那个房间 <span class="definition">2 起源于，来源于，出自：</span>I’m from China. 我来自中国。/ a representative from the Israeli embassy 以色列大使馆的一位代表 / documents from the sixteenth century 十六世纪的文献 / quotations from Shakespeare 莎士比亚语录 / heat from the sun 来自太阳的热量 / the man from the company 这家公司的人 <span class="definition">3 表示从某个位置或观点：</span>You can see the lake from here. 从这里可以看见那片湖。/ from a financial point of view 从财务的观点看 <span class="definition">4 from sth (to sth) 表示幅度或范围，即从…（到…）：</span>The temperature varies from 38 degrees to minus 15. 温度在38度到零下15度之间变化。/ The store sells everything from snacks to toys. 这家商店出售的商品从零食到玩具应有尽有。/ Conditions vary from school to school. 各所学校的情况不同。<span class="definition">5 from sth (to sth) 表示改变发生之前的状态或形式，即从…（到…）：</span>Things have gone from bad to worse. 情况越来越糟。/ to translate from English to Chinese 从英语译成汉语 / to be back from work 下班回来 / You need a break from routine. 你需要从日常的工作中解脱出来，去休息一下。</p>
...
<span class="definition">prep. 1 [非标准英语或美国英语，非正式] off of 来源于；从：</span>I got it off of my brother. 这是我从我弟弟那里弄到的。<span class="definition">2 从某人那里得到：</span>I don’t really get a lot of information, and if I do I get it off Mark. 我真没得到很多信息，即便有也是从马克那里得到的。</p>
<p><span class="vocabulary"><strong>by</strong></span> [baɪ]
<span class="definition">prep. 用于补充信息，所补充的信息可以是关于某人来自何地：</span>by birth 在血统上（或祖籍等）</p>
<p>相关词义延伸：
...
· from还可指…由…原料制成。也可表示两地的距离。亦可用于区别二者，即与…不同。</p>
<p>周边词汇补充：
...
· light可指“点火”；
· reference可指书籍或论文等材料中的引文（该引文出自于一本书、一首诗、一部戏剧等）。也可指（注明引文出处的）注释。</p>
