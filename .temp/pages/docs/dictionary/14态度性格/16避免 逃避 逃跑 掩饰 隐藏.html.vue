<template><div><p>☀ <span class="category"><strong>避免、免于的动词：</strong></span>
<span class="vocabulary"><strong>avoid</strong></span> [ə'vɒɪd]
<span class="definition">vt. 防止（或避免）坏事发生。是“避免”的常规用词，最为常用：</span>The accident could have been avoided. 这起事故本来是可以避免的。/ The name was changed to avoid confusion with another firm. 改名是为了避免和另一家公司混淆。/ to avoid soil being washed away 防止土壤流失 / to avoid conflict 避免冲突 / I scrupulously avoid artificial additives when I buy food. 购买食品时我仔细地避开有人工添加剂的食物。/ They narrowly avoided defeat in the semifinal. 他们在半决赛中险些败下阵来。</p>
<p><span class="vocabulary"><strong>avert</strong></span> [əˈvɜ:t; 美 əˈvɜ:rt]
<span class="definition">vt. 防止（坏事或危险的事发生）：</span>Disaster was narrowly averted when two airliners almost collided above Detroit. 两架班机差点儿在底特律上空相撞，险些酿成大祸。/ He managed to avert the closure of the factory. 他设法使工厂免于倒闭。/ He did his best to avert suspicion. 他尽量避嫌。/ Talks with the teachers' union over the weekend have averted a strike. 周末与教师工会举行的谈判避免了一场罢工。/ A fresh tragedy was narrowly averted yesterday. 昨天险些酿成一场新的悲剧。</p>
<p><span class="vocabulary"><strong>save</strong></span> [seɪv]
<span class="definition">vt. 使…免于令人不快的活动或经历：</span>The prize money saved her from having to find a job. 她得到的奖金使她不用非得去找工作。/ Thanks for sending that letter for me--it saved me a trip. 多谢你替我把那封信寄了——省得我跑一趟。</p>
<p><span class="vocabulary"><strong>spare</strong></span> [spεə]
<span class="definition">vt. 1 spare sb/yourself (from) sth 为…免除或省去（痛苦、麻烦等）令人不快的经历：</span>He wanted to spare his mother any anxiety. 他不想让母亲有丝毫的担忧。/ Please spare me the gruesome details. 那些让人毛骨悚然的细节就请你不要讲了。/ to spare a trip 免得跑一趟 / I wanted to spare Tom the embarrassment of discussing this subject. 我想使汤姆免遭讨论这个话题的尴尬。<span class="definition">2 [正式] 幸免：</span>During the bombing only one house was spared. 在轰炸中，只有一座房子幸免。/ The storm largely spared Houston and surrounding districts. 暴风雨基本未危害到休斯敦及其周边地区。/ The children were spared from the virus. 孩子们没被病毒感染。</p>
<p><span class="vocabulary"><strong>beat</strong></span> [bi:t]
<span class="definition">vt. 避免或逃避某事。不过远不如avoid常用：</span>If we go early we should beat the traffic. 我们早点出发就会避开交通拥挤。</p>
<p><span class="vocabulary"><strong>cover</strong></span> ['kʌvə]
<span class="definition">vt. cover yourself (against sth) 采取行动以使自己免遭责备：</span>One reason doctors take temperatures is to cover themselves against negligence claims. 医生测量体温的一个原因是免得被指玩忽职守而遭受索赔。</p>
<p>☀ <span class="category"><strong>避免、免于的其它词性：</strong></span>
<span class="vocabulary"><strong>freedom</strong></span> ['fri:dəm]
<span class="definition">n. [U] freedom (from sth) 不受（或免除）某事物影响的状态：</span>freedom from fear, freedom from pain, freedom from hunger 免于恐惧；免于痛苦；免于饥饿</p>
<p><span class="vocabulary"><strong>liberty</strong></span> ['lɪbətɪ]
<span class="definition">n. [C] 免除：</span>liberty from the abuse of police power 免遭滥用警察权力之苦</p>
<p><span class="vocabulary"><strong>avoidable</strong></span> [əˈvɔɪdəbl]
<span class="definition">adj. 可避免的：</span>Many deaths from heart disease are actually avoidable. 许多因心脏病造成的死亡实际上是可以避免的。/ More than a quarter of the avoidable deaths in the developing world are caused by TB. 发展中国家的可避免死亡中超过四分之一是由肺结核引起的。/ The tragedy was entirely avoidable. 那场悲剧是完全可以避免的。/ Most accidents are easily avoidable. 大多数事故是容易避免的。</p>
<p><span class="vocabulary"><strong>immune</strong></span> [ɪˈmju:n]
<span class="definition">adj. 1 [名词前不常用] ~ (to sth) 不受某事影响的：</span>She's quite immune to criticism. 批评对她起不了什么作用。/ Whilst Marc did gradually harden himself to the poverty, he did not become immune to the sight of death. 尽管马克逐渐对贫困现象无动于衷，但他对于死亡的惨象还是不免动容。/ Football is not immune to economic recession. 足球不可能不受到经济衰退的影响。/ Children are far from immune to the cruelty that is latent in all humans. 每个人本性中都潜藏着残忍的一面，儿童也不例外。<span class="definition">2 [名词前不常用] ~ (from sth) 受保护；免除；豁免：</span>Members of the Bundestag are immune from prosecution for corruption. 德国联邦议院的成员可免受贪腐罪的起诉。/ No one is immune from scandal. 谁都难免会有丑闻。/ He seems to believe that the president is somehow immune from criticism. 他似乎相信总统出于某种原因可以免受批评。</p>
<p><span class="vocabulary"><strong>impervious</strong></span> [ɪmˈpɜ:viəs; 美 -ˈpɜ:rv-]
<span class="definition">adj. ~ to sth 不受某事物影响的：</span>impervious to pain 能忍受疼痛的 / She seems almost impervious to the criticism from all sides. 对于来自各方的指责，她似乎无动于衷。/ The political system there has been impervious to all suggestions of change. 那里的政治体制对于所有的改革建议一概置之不理。/ She was impervious to his charms. 对他的魅力她无动于衷。</p>
<p><span class="vocabulary"><strong>unaffected</strong></span> [ˌʌnəˈfektɪd]
...
<p><span class="vocabulary"><strong>insulated</strong></span> [ˈɪnsjuleɪtɪd; 美 -səl-]
<span class="definition">adj. 免于不快经历的：</span>We are largely insulated from significantly higher costs. 我们基本上未受显著增加的成本的影响。/ The wealthy feel completely insulated from an economic downturn. 富人们完全感受不到经济衰退的影响。/ Many financial institutions are now insulated against higher interest rates. 许多金融机构现在都不受高利率的不利影响。</p>
<p><span class="vocabulary"><strong>from</strong></span> [frɒm]
<span class="definition">prep. 表示防止某事发生，如使免遭，使免受：</span>He saved her from drowning. 他把她从水中救了出来，使她免遭淹死。</p>
<p>周边词汇补充：
· excuse可指允许某人不去做（其正常情况下应该做的）某事；
· before可用于警告或威胁某人，说坏事有可能发生，即不然，以免。</p>
<p>· 表示“避开话题”的词群见[[17避开话题 转移话题 支吾结巴 轻描淡写]]
· 表示“赦免”的词群见[[08原谅 宽恕 仁慈 慷慨 同情]]</p>
<p>☀ <span class="category"><strong>躲避、逃避、逃走的动词：</strong></span>
<span class="vocabulary"><strong>avoid</strong></span> [ə'vɒɪd]
<span class="definition">vt. 1 躲开或避开（某人或某事物）；尝试不去做某事（即避免做某事）：</span>He’s been avoiding me all week. 整整一个星期他一直在回避我。/ to avoid my eyes 躲避我的目光 / I left early to avoid the rush hour. 我早早动身以避开交通高峰时刻。/ to avoid mentioning his divorce 避免提及他离婚的事 / He avoided answering the question. 他避开了这个问题，没有回答。<span class="definition">2 避免自己撞到某东西：</span>She swerved to avoid a bicycle. 她猛打方向盘以免撞上一辆自行车。/ He ducked to avoid a low branch. 他迅速低下头以免撞上矮树枝。</p>
<p><span class="vocabulary"><strong>dodge</strong></span> [dɒdʒ; 美 dɑ:dʒ]
<span class="definition">vt.&amp;vi.（快速移动以）闪开、躲开、避开某人或某事物：</span>He ran across the road, dodging the traffic. 他躲开来往的车辆跑过马路。/ He desperately dodged a speeding car trying to run him down. 他拼命地闪身躲开一辆试图撞倒他的疾驰的汽车。/ He dodged amongst the seething crowds of men. 他在川流不息的人群中东躲西闪。/ We dodged behind a pillar out of sight of the tourists. 我们躲到柱子后面，避开了观光者的视线。/ The girl dodged behind a tree to hide from the other children. 这女孩闪身躲到树后不让其他孩子看见。<span class="definition">vt. 逃避某事，尤指用欺诈的方式故意逃避：</span>He dodged his military service. 他弄虚作假逃避了服兵役。/ She tried to dodge paying her taxes. 她想方设法逃税。</p>
<p><span class="vocabulary"><strong>avert</strong></span> [əˈvɜ:t; 美 əˈvɜ:rt]
<span class="definition">vt. ~ your eyes, gaze, face (from sth)（因为不想看而）转移目光、背过脸：</span>He looked up, and she quickly averted her gaze. 他抬起头，她就迅速转过眼睛看别处了。/ He avoids any eye contact, quickly averting his gaze when anyone approaches. 他避免任何眼神接触，一有人靠近就把目光迅速移开。/ He kept his eyes averted. 他的眼睛滴溜溜乱转。/ She averted her eyes from the terrible scene in front of her. 她背过脸，不去看面前可怕的场面。/ They hastily averted their faces to hide their giggles. 他们迅速转过脸去以掩饰他们的傻笑。</p>
<p><span class="vocabulary"><strong>shun</strong></span> [ʃʌn]
<span class="definition">vt. 避开某人或某事物：</span>She was shunned by her family when she remarried. 她再婚后家里人都躲着她。/ From that time forward everybody shunned him. 从那时候起，每个人都有意回避他。/ He has always shunned publicity. 他一直有意避开媒体的关注。</p>
<p><span class="vocabulary"><strong>keep</strong></span> [ki:p]
<span class="definition">vi. keep off sth、keep away from sth或keep out of sth 可指避开…。一般表示一种状态：</span>to keep off sweet foods 不吃甜食</p>
<p><span class="vocabulary"><strong>shelter</strong></span> ['ʃeltə]
<span class="definition">vi. shelter (from sth) 待在一个安全的地方使自己免遭恶劣天气或危险，即躲避（风雨或危险）：</span>We sheltered from the rain in a doorway. 我们在一个门口处避雨。</p>
<p><span class="vocabulary"><strong>miss</strong></span> [mɪs]
<span class="definition">vt. 避开（不愉快的事）：</span>If you go now you should miss the crowds. 你如果现在走就可以避开人群。/ He fell and just missed knocking the whole display over. 他摔了一跤，差一点把全部展品碰翻。</p>
<p><span class="vocabulary"><strong>abstain</strong></span> [əbˈsteɪn]
<span class="definition">vi. ~ (from sth) [印度英语] 离开、回避某事物：</span>The workers who abstained from work yesterday have been suspended. 昨天旷工的工人被暂时停职。</p>
<p><span class="vocabulary"><strong>eschew</strong></span> [ɪsˈtʃu:]
<span class="definition">vt. [正式] 故意避开、避免、回避：</span>Although he appeared to enjoy a jet-setting life, he eschewed publicity and avoided nightclubs. 虽然他看上去好像很享受那种常乘飞机四处旅行的奢华生活，但是他不喜欢被人关注，也不去夜总会。</p>
<p><span class="vocabulary"><strong>flinch</strong></span> [flɪntʃ]
<span class="definition">vi. ~ from 回避、不愿意做：</span>The world community should not flinch in the face of this challenge. 国际社会在面对这一挑战时不应该回避。/ He has never flinched from harsh financial decisions. 在艰难的财政决策面前他从没有退缩过。/ She won't flinch from speaking her mind.（比喻用法）她不会讳言自己的想法。</p>
<p><span class="vocabulary"><strong>duck</strong></span> [dʌk]
<span class="definition">vt.＆vi. 1 duck (down) / duck (behind/under sth) 低下头或弯下身体，以免被看到或被击中：</span>to duck down behind the wall 在墙后面弓着身子 / to duck his head 低下他的头 <span class="definition">2 duck (out of) sth 逃避职责或责任，含贬义：</span>to duck the question 回避问题 <span class="definition">vt. 通过将头或身体移开来躲避…：</span>to duck the blow 躲过一击 <span class="definition">vi. 快速移动到某处，以避免被看见：</span>to duck into the room 躲进房间</p>
<p><span class="vocabulary"><strong>escape</strong></span> [ɪ'skeɪp]
<span class="definition">vi. escape (from sb/sth) 从监狱或其他不让你离开的地方逃走，逃跑，逃出，无被动式。是此义的常规用词：</span>Two prisoners have escaped. 两名犯人逃走了。/ I was lucky to escape with minor injuries. 我只受了一点轻伤逃出来真是万幸。<span class="definition">vt.＆vi. 逃避（坏的或危险的处境或事物）：</span>to escape punishment 逃脱惩罚 / to escape from the burning car 从燃烧的汽车里逃出来 / He narrowly escaped being killed. 他险些丧命。/ The city largely escaped bombing in the campaign. 这次战役中，该市几乎未遭轰炸。/ to escape the fact 回避事实 / to escape responsibility 逃脱责任 / to escape into a dreamworld of his own 躲进他自己的梦幻世界 / to escape the freezing winter 躲过寒冷的冬天</p>
<p><span class="vocabulary"><strong>flee</strong></span> [fli:]
<span class="definition">vt.＆vi. flee (from) sb/sth / flee (to ... /into ...)（尤因对潜在危险恐惧而）迅速离开一个人或地方，也可指因心情不好而离开一个地方或人，即逃离，无被动式。具有一种匆忙和仓皇的色彩。且具有一定的情感和文学色彩：</span>They fled to Britain when the war started. 战争初始他们逃到英国。/ to flee in panic 仓皇而逃 / to collect your possessions and flee like the wind 收拾好财物赶快离开 / The children fled in terror as the hay caught fire. 干草着火了，孩子们吓得四散而逃。/ The burglars fled empty-handed. 窃贼两手空空地逃走了。</p>
<p><span class="vocabulary"><strong>retreat</strong></span> [rɪˈtri:t]
<span class="definition">vi. 放弃，远离（计划、生活方式等）；逃到一个更安静或更安全的地方，如隐退、逃避、躲避：</span>Bored with the conversation, she retreated to her bedroom. 她厌倦了这样的交谈，躲进了自己的卧室。/ She retreated from the busy office to her own room. 她从繁忙的办公室中躲到了自己的屋子里。/ He retreated into his own world. 他躲进了自己的世界中。/ He retreated into a world of fantasy. 他遁入了幻想世界。/ I believe people should live in houses that allow them to retreat from the harsh realities of life. 我认为人们所居住的房子应该能让他们远离残酷的现实生活。/ From bouncing confidence she had retreated into self-pity. 她从信心百倍变得自怜自哀。</p>
<p><span class="vocabulary"><strong>bolt</strong></span> [bəʊlt; 美 boʊlt]
<span class="definition">vi.（常指人或动物因受惊吓）迅速逃跑：</span>The pig rose squealing and bolted. 那头猪突然嗷嗷叫着狂奔起来。/ I made some excuse and bolted for the exit. 我编了个借口后便向出口冲去。<span class="definition">vi.（人）跑开，尤指逃跑：</span>When he saw the police arrive, he bolted down an alley. 他看见警察来了，便从小巷逃走了。</p>
<p><span class="vocabulary"><strong>desert</strong></span> [dɪ'zət]
<span class="definition">vt.＆vi. 未经许可而擅自离开部队：</span>Large numbers of soldiers deserted as defeat became inevitable. 战败已成定局，许多士兵开小差跑了。</p>
<p><span class="vocabulary"><strong>lose</strong></span> [lu:z]
<span class="definition">vt.（从某人或某事物处）逃脱，逃走。其后并不加介词from，而是直接加“追赶者”等词，因此翻译为“摆脱”更合适。相当于evade或shake off。不太常用：</span>We managed to lose our pursuers in the darkness. 我们设法在黑暗中摆脱了追赶者。</p>
<p><span class="vocabulary"><strong>fly</strong></span> [flaɪ]
<span class="definition">vt.＆vi. [正式] 从…逃走或逃跑。是一种形象化用法。不太常用：</span>The criminal has flown the scene of the crime. 罪犯已经逃离了犯罪现场。</p>
<p><span class="vocabulary"><strong>elude</strong></span> [iˈlu:d]
<span class="definition">vt.（尤指机敏地）成功躲避或从…处逃脱：</span>The two men managed to elude the police for six weeks. 这两个男人想方设法逃避警方追捕达六个星期。</p>
<p><span class="vocabulary"><strong>break</strong></span> [breɪk]
<span class="definition">vi. break free (from sb/sth)（人或物体）从某处逃脱（从而不再受困）。是一个简单用词。还算常用：</span>He finally managed to break free from his attacker. 他终于设法摆脱了袭击他的人。/ She broke free by thrusting her elbow into his chest. 她用胳膊肘猛杵他的胸部挣脱了开来。</p>
<p><span class="vocabulary"><strong>cut</strong></span> [kʌt]
<span class="definition">vt. cut sb (from sth) 割断束缚某人的绳子等物品（而让其逃跑）：</span>The driver was cut from the wreckage. 司机是别人将汽车残骸割开后被救出的。</p>
<p><span class="vocabulary"><strong>pull</strong></span> [pʊl]
<span class="definition">vt.＆vi.（尤指用力地）朝某个方向移动身体或身体部位：</span>He tried to kiss her but she pulled away. 他想吻她，但她却抽身躲开了。/ She pulled back her hand. 她把手缩了回来。/ John finally managed to pull himself free. 约翰最后设法挣脱开了。/ The thief pulled himself away and ran off. 那个小偷脱身跑掉了。</p>
<p><span class="vocabulary"><strong>funk</strong></span> [fʌŋk]
<span class="definition">vt. [英，非正式] 因害怕或某事困难而逃避去做此事：</span>If he funks it, he will confirm the impression of cowardice given by his recent letter. 如果他对此畏缩，那就会证实他在最近一封信里表现出来的怯懦。</p>
<p><span class="vocabulary"><strong>evade</strong></span> [ɪˈveɪd]
<span class="definition">vt. 从某人或某事物处逃脱，或避免遇到某人：</span>He managed to evade capture and escaped over the border. 他设法摆脱了追捕并逃过了边境。For two weeks they evaded the press. 他们有两周一直避而不见记者。/ They narrowly evaded a police car which was approaching. 他们险些没避开赶过来的警车。/ Under the pretence of lighting a candle, she evades him and disappears. 她假装点蜡烛，避开他消失了。/ She turned and gazed at the river, evading his eyes. 她转身凝视着那条河，避开他的目光。<span class="definition">vt. 逃避，规避（尤指法律或道德责任）：</span>to evade payment of taxes 逃税 / By his own admission, he evaded taxes as a Florida real-estate speculator. 他亲口承认自己在佛罗里达从事房地产投机生意时逃过税。/ Delegates accused them of trying to evade responsibility for the failures of the past five years. 代表们指责他们企图逃避过去5年中多次失败应负的责任。/ She is trying to evade all responsibility for her behaviour. 她在试图逃避应为自己的行为承担的所有责任。<span class="definition">vt. 回避（处理某事）：</span>Too many companies, she says, are evading the issue. 她说太多公司都在回避这个问题。</p>
<p><span class="vocabulary"><strong>fend</strong></span> [fend]
<span class="definition">vt.&amp;vi. fend off sb/sth 避开，回避（难题、批评等）：</span>He had struggled to pay off creditors but couldn't fend them off any longer. 他曾想方设法还债主的钱，但却再也躲不过他们了。</p>
<p><span class="vocabulary"><strong>circumvent</strong></span> [ˌsɜ:kəmˈvent; 美 ˌsɜ:rk-]
<span class="definition">vt. [正式] 设法回避、规避（困难或规则）：</span>They found a way of circumventing the law. 他们找到了规避法律的途径。/ Military planners tried to circumvent the treaty. 军事策略家们企图绕开这一条约。/ to circumvent problem 回避问题 <span class="definition">vt. [正式] 躲避、回避，尤指躲避欲伤害自己的人：</span>Roosevelt occasionally attempted to circumvent him. 罗斯福偶尔会试图避开他。</p>
<p><span class="vocabulary"><strong>shirk</strong></span> [ʃɜ:k; 美 ʃɜ:rk]
<span class="definition">vt.&amp;vi. ~ (from) (sth/doing sth)（尤指因为太懒惰而）逃避（自己该做的事），如逃避责任、偷懒：</span>to shirk duty 逃避责任 / We in the Congress can't shirk our responsibility. 我们作为国会议员不能逃避责任。/ She never shirked her responsibilities. 她从不逃避自己的职责。/ The Government will not shirk from considering the need for further action. 政府不会回避考虑采取进一步行动的需要。/ Discipline in the company was strict and no one shirked. 公司有严格的纪律，没有人偷懒。/ A determined burglar will not shirk from breaking a window to gain entry. 一个决计要下手的窃贼会不惜破窗而入。</p>
<p><span class="vocabulary"><strong>elude</strong></span> [iˈlu:d]
<span class="definition">vt.（某事物）使某人达不到；使某人不记得；使某人不理解：</span>He was extremely tired but sleep eluded him. 他累极了，却睡不着。/ They're a popular band but chart success has eluded them so far. 他们是一支很受欢迎的乐队，但到目前为止还未能在每周流行唱片榜上取得佳绩。/ At 62, Brian found the celebrity and status that had eluded him for so long. 布赖恩在62岁时获得了多年来未能得到的名望和地位。/ Finally he remembered the tiny detail that had eluded him the night before. 他终于想起了前一天晚上想不起来的细节。/ The appropriate word eluded him. 他找不到合适的字眼。</p>
<p><span class="vocabulary"><strong>evade</strong></span> [ɪˈveɪd]
...
· fend还可指抵挡，挡开，避开（攻击）。</p>
<p>周边词汇补充：
· bypass可指绕开（或避开）一个地方；
· cower可指因恐惧而蜷缩、退缩；
· shrink可指由于害怕或震惊而从某事物处退缩回来或从其移开，相当于cower；
· recoil可指身体因恐惧或厌恶而从某处快速退缩。</p>
<p>☀ <span class="category"><strong>躲避、逃避、逃走的名词：</strong></span>
<span class="vocabulary"><strong>shelter</strong></span> ['ʃeltə]
<span class="definition">n. [U] shelter (from sth) 对…（如雨、危险或攻击）的躲避：</span>to take shelter from the storm 躲避暴风雨 / to seek shelter from the gunfire 躲避炮火 / The great tree gave shelter from the wind. 这棵大树挡住了风。/ She was standing in the shelter of the doorway. 她正躲在门口。/ shelter for the night 过夜的地方 / tax shelter（比喻用法）避税手段</p>
<p><span class="vocabulary"><strong>escape</strong></span> [ɪ'skeɪp]
<span class="definition">n. 1 [C, U] escape (from sth) 从一个地方或一种令人不快或危险的处境中的逃脱、逃跑、逃离：</span>an escape from a prison 从监狱中逃出 / escape route 逃跑路线 / escape vehicle 逃逸交通工具 / escape hatch, escape ladder 安全舱；应急梯 / an escape plan 逃生计划 / He had a narrow escape from gunfire. 他从炮火中死里逃生。<span class="definition">2 [sing., U] 逃避现实，逃避责任，即短时间对不快之事或困难之事的忘记，也可叫解脱：</span>For her travel was an escape from the boredom of her everyday life. 对她来说，旅行是为了从乏味的日常生活中暂时解脱出来。/ There was no hope of escape from her disastrous marriage. 她无望从不幸的婚姻中解脱出来。</p>
<p><span class="vocabulary"><strong>flight</strong></span> [flaɪt]
...
<p><span class="vocabulary"><strong>dodge</strong></span> [dɒdʒ; 美 dɑ:dʒ]
<span class="definition">n. [C] 逃避的诡计：</span>a tax dodge 逃税花招 / When it comes to getting off work, he knows all the dodges. 说到请假歇班，他什么花招都想得出。</p>
<p><span class="vocabulary"><strong>out</strong></span> [aʊt]
<span class="definition">n. [sing.] 回避（不得不去做的事情）的方法：</span>to desperately look for an out 拼命寻找一条脱身之计</p>
<p><span class="vocabulary"><strong>retreat</strong></span> [rɪˈtri:t]
<span class="definition">n. [C, usually sing., U] ~ (from/into sth) 隐退、逃避、躲避（到一个更安静或更安全的地方）：</span>Is watching television a retreat from reality? 看电视是对现实的一种逃避吗？/ her retreat into a fantasy world of her own 她躲进了自己的虚幻世界</p>
<p><span class="vocabulary"><strong>refuge</strong></span> [ˈrefju:dʒ]
<span class="definition">n. [U]（行为和想法的）逃避，躲避：</span>All too often, they get bored, and seek refuge in drink and drugs. 太多的时候，他们觉得无聊就在酒精和毒品中寻求慰藉。/ As the situation at home got worse she increasingly took refuge in her work. 随着家庭情况的恶化，她越来越在工作中寻求慰藉。/ Father Rowan took refuge in silence. 罗恩神父以沉默来逃避。</p>
<p><span class="vocabulary"><strong>fugitive</strong></span> [ˈfju:dʒətɪv]
<span class="definition">n. [C] ~ (from sb/sth) 逃跑者、逃亡者：</span>a fugitive from justice 逃犯 / one of the most wanted fugitives sought by the Italian police 意大利警方通缉的要犯之一</p>
<p>☀ <span class="category"><strong>避难：</strong></span>
<span class="vocabulary"><strong>asylum</strong></span> [əˈsaɪləm]
<span class="definition">n. [U]（也可用正式的political asylum）政治庇护、政治避难：</span>political asylum 政治避难 / temporary asylum 暂时的庇护 / She fled the country, and is now seeking asylum in Sweden. 她逃离了该国，目前正在瑞典寻求庇护。/ Over 400 people have been refused asylum. 400多人没有获准政治避难。/ bogus asylum seekers 假的寻求避难者 / asylum application, asylum case, asylum claim 避难申请；避难案例；避难要求 / an application for asylum 避难申请 / Those fleeing from the war have the right to asylum. 因战争而逃亡的人有权得到庇护。/ There was a nationwide debate on whether the asylum laws should be changed. 对是否应该修改政治避难法展开了一场全国性的大辩论。/ He applied for asylum in 1987 after fleeing the police back home. 1987年他在本国逃脱警察追捕后，就申请了政治庇护。</p>
<p><span class="vocabulary"><strong>political asylum</strong></span>
...
<p><span class="vocabulary"><strong>cover</strong></span> ['kʌvə]
<span class="definition">vt. 1 cover sth (with sth) 把…放在…上面或前面以对其进行隐藏，即掩盖，遮盖：</span>She covered her face with her hands. 她双手掩面。/ She used twigs to cover up the hole. 她用小树枝盖住洞口。/ He covered the body with a cloth. 他用一块布盖住那具尸体。/ He laughed to cover his nervousness.（比喻用法）他哈哈大笑以掩饰紧张的心情。/ to cover his embarrassment（比喻用法）掩饰他的尴尬 <span class="definition">2（某事物）盖住另一事物以对其进行隐藏，即掩盖，遮盖：</span>Her hair partially covered her face. 她的头发把脸遮住了一部分。</p>
<p><span class="vocabulary"><strong>mask</strong></span> [mɑːsk]
<span class="definition">vt. 1 掩藏感情、气味、事实等（使其他人不能确切知道）：</span>to mask his agitation 掩饰他的不安 / She masked her anger with a smile. 她以微笑掩饰怒火。<span class="definition">2 遮掩…（使人不能注意到或认出来…）：</span>the smoke that masked the enemy 遮住敌人的烟雾 / Varnish tends to mask the natural grain of the wood. 罩光漆往往会遮盖木材的天然纹理。</p>
<p><span class="vocabulary"><strong>screen</strong></span> [skri:n]
<span class="definition">vt. screen sth/sb (from sth/sb)（把…放在某人或事物的前面或周围来）隐藏（该人或事物），相当于shield：</span>Most of the road behind the hotel was screened by an apartment block. 旅馆后面那条路的大部分都被一排公寓楼挡住了。</p>
<p><span class="vocabulary"><strong>camouflage</strong></span> [ˈkæməflɑ:ʒ]
<span class="definition">vt. 掩饰、隐瞒（一种感情或情况）：</span>He has never camouflaged his desire to better himself. 他从不掩饰自己的上进心。/ I think that there has been an attempt to camouflage what really happened. 我认为,有人试图掩盖事情的真相。/ Her size was camouflaged by the long loose dress she wore. 她穿的那件宽松长裙掩饰了她的身材。</p>
<p><span class="vocabulary"><strong>disguise</strong></span> [dɪsˈgaɪz]
<span class="definition">vt. 掩饰、隐藏（使其不能被认出）：</span>She made no attempt to disguise her surprise. 她毫不掩饰自己的惊奇。/ He made no attempt to disguise his liking for her. 他毫不掩饰对她的好感。/ She made several thinly disguised attacks on the president. 她在演说中对总统作了几次几乎不加掩饰的抨击。She couldn't disguise the fact that she felt uncomfortable. 她无法掩饰她那不安的心情。/ You cannot disguise what you are doing from your family. 你所做的事对家人是掩盖不了的。</p>
...
<p><span class="vocabulary"><strong>cache</strong></span> [kæʃ]
<span class="definition">vt. 把某些事物（尤指武器）藏在一个秘密的地方：</span>了解即可</p>
<p><span class="vocabulary"><strong>secrete</strong></span> [sɪˈkri:t]
<span class="definition">vt. [正式] ~ sth (in sth) 隐藏、藏匿某事物，尤指藏匿小东西：</span>The drugs were secreted in the lining of his case. 毒品藏在他的皮箱内衬中。/ She secreted the gun in the kitchen cabinet. 她把枪藏在橱柜里。</p>
<p><span class="vocabulary"><strong>tuck</strong></span> [tʌk]
<span class="definition">vt.&amp;vi. 把某事物隐藏在一个小空间，尤指藏起来或使其更安全或舒适：</span>The pool was tucked away behind a screen of trees. 水池隐藏在一排屏风似的树后。</p>
<p><span class="vocabulary"><strong>ambush</strong></span> [ˈæmbʊʃ]
<span class="definition">vt. 伏击、埋伏：</span>The guerrillas ambushed them near the bridge. 游击队员在大桥附近伏击了他们。/ The Guatemalan army says rebels ambushed and killed 10 patrolmen. 危地马拉军方说叛乱分子伏击打死了10名巡逻兵。/ She was ambushed by reporters.（比喻用法）记者突然一拥而上采访她。</p>
<p><span class="vocabulary"><strong>palm</strong></span> [pɑ:m]
<span class="definition">vt. 把硬币、纸牌等藏在手中（尤指玩戏法）：</span>了解即可</p>
<p>相关词义延伸：
· camouflage还可指通过将自己与周围环境打扮得相似（或与别的事物相似）来进行军事伪装；
· disguise还可指伪装（使别人认不出）。</p>
<p>☀ <span class="category"><strong>掩饰、隐藏、掩盖、埋伏的名词：</strong></span>
<span class="vocabulary"><strong>hiding</strong></span> [ˈhaɪdɪŋ]
<span class="definition">n. [U] 隐藏；躲藏：</span>After the trial, she had to go into hiding for several weeks. 审讯后她不得不躲藏了几个星期。/ He had gone into hiding just after war broke out. 战争刚一爆发他就躲了起来。/ He only came out of hiding ten years after the war was over. 战争结束十年之后他才露面。/ After the car had passed by they came out of hiding. 车子开过后，他们从藏身的地方走了出来。/ The fugitive had spent five weeks in hiding. 逃亡者已经躲藏了五个星期。/ Gray is thought to be in hiding near the France/Italy border. 他们认为格雷藏在法国和意大利边境附近。/ Hundreds of people are said to have gone into hiding to avoid arrest. 据说有几百人为躲避逮捕而藏了起来。</p>
<p><span class="vocabulary"><strong>cover</strong></span> ['kʌvə]
<span class="definition">n. [C, usually sing.] cover (for sth) 看起来诚实、正直或真实，实则对某人的真实身份、感情或违法事情起到掩盖作用的活动或行为，即掩饰：</span>spies operating under diplomatic cover 以外交身份为掩护进行活动的间谍 / The guard believed her cover story. 卫兵相信了她的假话。/ The club is a cover for various criminal activities. 该俱乐部为各种犯罪活动提供掩护。/ He realized his cover had been blown. 他意识到自己的身份已经暴露了。/ Her over-confident attitude was a cover for her nervousness. 她以过分自信的态度来掩饰她紧张的心情。</p>
<p><span class="vocabulary"><strong>cover-up</strong></span>
<span class="definition">n. [C, usually sing.] 对罪行或错误的掩饰（以防止其被公众知晓）：</span>Government sources denied there had been a deliberate cover-up. 政府方面否认了有故意掩饰的行为。/ General Schwarzkopf denied there'd been any cover-up. 施瓦茨科普夫将军否认曾经有任何掩饰行为。/ government cover-up 政府的隐瞒行为 / Military leaders were involved in a massive cover-up. 军事首脑们卷入了一起重大的隐瞒真相事件。/ cover-ups by the police 警方隐瞒真相的行为 / allegations of a cover-up, claims of a cover-up 对于隐瞒真相的指控</p>
<p><span class="vocabulary"><strong>mask</strong></span> [mɑːsk]
<span class="definition">n. [usually sing.]（对真实性格或感情的）隐藏，掩饰：</span>His mask cracked, and she saw for an instant a violent man. 他的伪装破碎了，她瞬间看到了一个狂暴的男人。/ Her face was a blank mask. 她脸上装出一副漠无表情的样子。/ the mask of friendliness 友善的面具 / a mask for his lack of confidence 掩饰他的缺乏自信</p>
<p><span class="vocabulary"><strong>curtain</strong></span> ['kə:tn]
<span class="definition">n. [C, usually sing.] 覆盖、隐藏或保护某事物的一个东西，即覆盖物、隐蔽物、防护物：</span>a curtain of rain, a curtain of smoke 雨幕；烟幕 / She pushed back the curtain of hair from her eyes. 她把头发从眼前拢到脑后。</p>
<p><span class="vocabulary"><strong>canopy</strong></span> [ˈkænəpi]
<span class="definition">n. [C]（固定或悬挂在床、座位等上面的）装饰性遮罩，罩盖：</span>canopy bed（尤美）带罩篷的床 / glass canopy 玻璃顶盖</p>
<p><span class="vocabulary"><strong>cloak</strong></span> [kləʊk; 美 kloʊk]
<span class="definition">n. 1 [sing.] [文学] 遮盖物；掩蔽物：</span>Today most of England will be under a cloak of thick mist. 今天，英格兰大部分地区将被浓雾笼罩。/ They left under the cloak of darkness. 他们在黑暗的掩护下离开了。<span class="definition">2 [sing.] 真相的掩盖物，如伪装、幌子：</span>Preparations for the wedding were made under a cloak of secrecy. 婚礼的准备工作是秘密进行的。</p>
<p><span class="vocabulary"><strong>screen</strong></span> [skri:n]
<span class="definition">n. [C] screen (of sth) 用来做掩蔽的事物：</span>All the research was conducted behind a screen of secrecy.（比喻用法）整个研究始终是秘密进行的。</p>
<p><span class="vocabulary"><strong>camouflage</strong></span> [ˈkæməflɑ:ʒ]
<span class="definition">n. [U, sing.] 对事实的故意隐瞒：</span>Her angry words were camouflage for the way she felt. 她以气愤的言辞掩盖自己的真实感情。</p>
<p><span class="vocabulary"><strong>cache</strong></span> [kæʃ]
<span class="definition">n. [C] 隐藏的储存物（如武器），秘密贮存物：</span>A huge arms cache was discovered by police. 警方发现了大批私藏的军火。/ a cache of weapons and explosives 一批隐藏的武器和炸药</p>
<p><span class="vocabulary"><strong>veil</strong></span> [veɪl]
<span class="definition">n. [sing.] [正式] 让人不能了解真相的事物，如掩饰、借口、托词：</span>Their work is carried out behind a veil of secrecy. 他们的工作是在秘密掩护下进行的。/ The country is ridding itself of its disgraced prime minister in a veil of secrecy. 这个国家暗地里正试图把失势的首相赶下台。/ It would be better to draw a veil over what happened next (= not talk about it). 后来发生的事情还是不谈为妙。/ The clamour to draw a veil over the minister's extra-marital activities reeks of hypocrisy. 想要掩饰部长婚外情的喧嚣叫嚷之声让人倍感虚伪。/ The chilling facts behind this veil of silence were slow to emerge. 沉默背后的骇人真相慢慢显露出来。/ The government has decided to lift the veil on its plans. 政府决定公开各项计划。</p>
<p><span class="vocabulary"><strong>ambush</strong></span> [ˈæmbʊʃ]
<span class="definition">n. [C, U] 伏击某人、埋伏：</span>enemy ambush 敌军的埋伏 / The soldiers set up an ambush on the road. 士兵在路上设了埋伏。/ They staged an ambush on an army patrol. 他们策划了对一支陆军巡逻队的伏击。/ We ran into an ambush in the valley. 我们在山谷里中了埋伏。/ Two soldiers were killed in a terrorist ambush. 两名士兵遭到恐怖分子伏击而死亡。/ The soldiers lay in ambush for the enemy troops. 战士们趴在埋伏圈里，等着敌军的到来。/ They were lying in ambush, waiting for the aid convoy. 他们埋伏起来，等着袭击增援车队。/ The gunmen, lying in ambush, opened fire, killing the driver. 埋伏的枪手开枪打死了司机。/ A policeman has been shot dead in an ambush. 一次伏击中一名警察中弹身亡。</p>
<p>相关词义延伸：
· canopy还可指延伸以至像房顶一样覆盖一片区域的东西，尤指树枝形成的华盖状的东西（即树冠）。也可指飞机的座舱盖；
· camouflage还可指军事上的伪装（如用油彩、叶子或网对士兵或武器进行的伪装）。也可指动物的保护色或保护形状；
· veil还可指（尤指女用的）薄而透明的面纱（用于保护或隐藏面部，或作为帽子的一部分）。</p>
<p>周边词汇补充：
· anonymity可指匿名、不公开姓名。</p>
<p>☀ <span class="category"><strong>掩饰、隐藏、掩盖的其它词性：</strong></span>
<span class="vocabulary"><strong>behind</strong></span> [bɪ'haɪnd]
<span class="definition">prep. 是某种情况的幕后人员、原因或事件：</span>What’s behind that happy smile? 为什么会笑得那么开心？/ the man behind the plan 该计划的策划人 / the man behind the killing 这起谋杀案的幕后策划者</p>
<p><span class="vocabulary"><strong>beneath</strong></span> [bɪ'ni:θ]
<span class="definition">prep. 在（表面）之下（被隐藏或不明显）：</span>emotional strains beneath the surface 表面下的情感压力 / Somewhere deep beneath the surface lay a caring character. 在其外表下心灵深处的某个地方保留着一种关爱别人的品格。<span class="definition">adv. 在（或到）…下面（或下方）：</span>Her careful make-up hid the signs of age beneath. 她细腻的化妆掩盖了妆容下年龄的痕迹。</p>
<p><span class="vocabulary"><strong>underlying</strong></span> [ˌʌndəˈlaɪɪŋ; 美 -dərˈl-]
...
<span class="definition">adj. [正式] 没有实体形状的：</span>an immaterial God 无形的上帝</p>
<p>相关词义延伸：
