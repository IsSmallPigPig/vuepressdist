<template><div><p>☀ <span class="category"><strong>同时 伴随：</strong></span>
<span class="vocabulary"><strong>meanwhile</strong></span> ['mi:nwaɪl]
...
<span class="definition">adv. 同时。不如meanwhile常用：</span>They both spoke together. 他们两人同时发言。/ All together now : ‘Happy birthday to you …’（非正式用法）现在大家一齐唱：“祝你生日快乐…”</p>
...
<span class="definition">vt. 伴随其他事而发生（或出现）：</span>strong winds accompanied by heavy rain 狂风夹着暴雨 / Each pack contains a book and accompanying CD. 每包内装书一本，并附光盘一张。</p>
<p><span class="vocabulary"><strong>accompaniment</strong></span> [əˈkʌmpənimənt]
<span class="definition">n. [C] [正式] ~ (to sth) 伴随某事而发生的事：</span>High blood pressure is a common accompaniment to this disease. 这种病通常伴随有高血压。/ The women's medical school opened in 1874, to the accompaniment of much ridicule. 女子医学院在一片嘲笑声中于 1874年创立。/ The sun was back, with its accompaniment of dust and flies. 太阳重新露了出来，灰尘和苍蝇也随之出现。</p>
<p><span class="vocabulary"><strong>attend</strong></span> [ə'tend]
<span class="definition">vt. [正式] 与某事同时发生，即伴随某事而发生：</span>She dislikes the loss of privacy that attends TV celebrity. 她不喜欢成为电视名人后随之失去个人隐私。</p>
<p><span class="vocabulary"><strong>to</strong></span> [tu:]
<span class="definition">prep. 伴随或随同（某事的发生）：</span>He left the stage to prolonged applause. 他在经久不息的掌声中退下了舞台。</p>
...
<span class="definition">adj. 同时发生的：</span>parallel trends 并行发展的趋势 <span class="definition">vt. 与…同时发生：</span>The rise in unemployment is paralleled by an increase in petty crime. 在失业率上升的同时，轻度犯罪也跟着增长。/ Often there are emotional reasons paralleling the financial ones. 经济原因常常伴有情感原因。</p>
<p><span class="vocabulary"><strong>concurrent</strong></span> [kənˈkʌrənt; 美 -ˈkɜ:r-]
<span class="definition">adj. ~ (with sth) 同时存在或发生的，即并存的、同时发生的：</span>He was imprisoned for two concurrent terms of 30 months and 18 months. 他被判处30个月和18个月的监禁，合并执行。/ He will actually be serving three concurrent five-year sentences. 实际上，他将服3个5年徒刑，合并执行。/ Galerie St. Etienne is holding three concurrent exhibitions. 圣艾蒂安美术馆同时举办3场展览。</p>
<p><span class="vocabulary"><strong>simultaneous</strong></span> [ˌsɪmlˈteɪniəs; 美 ˌsaɪml-]
<span class="definition">adj. 与其他事同时发生（或同时被完成）的：</span>simultaneous translation, simultaneous interpreting 同声传译 / The theatre will provide simultaneous translation in both English and Chinese. 剧院将提供英语和汉语的同声翻译。/ There will be simultaneous transmission of the concert on TV and radio. 电视和收音机将同步转播这场音乐会。/ the simultaneous release of the book and the album 书和唱片专辑的同步发行 / simultaneous orgasm 同时达到的性高潮 / There were several simultaneous attacks by the rebels. 反叛者同时发动了几起攻击。</p>
<p><span class="vocabulary"><strong>alongside</strong></span> [ə'lɒŋ'saɪd]
<span class="definition">prep. 与…同时：</span>Traditional beliefs still flourish alongside a modern urban lifestyle. 现代城市生活方式盛行的同时，传统信念仍然大行其道。</p>
<p><span class="vocabulary"><strong>while</strong></span> [waɪl]
<span class="definition">conj. 与（其他事件发生的时间）同时：</span>You can go swimming while I’m having lunch. 我吃午饭时你可以去游泳。/ shoes mended while you wait 在你等候的时候修的鞋</p>
<p><span class="vocabulary"><strong>with</strong></span> [wɪð]
<span class="definition">prep. 随着…而发生：</span>With the time passing by, ... 随着时间的流逝，…</p>
<p><span class="vocabulary"><strong>as</strong></span> [æz]
<span class="definition">conj. 当另一件事正在发生时，即随着，表示一个时间段：</span>He sat watching her as she got ready. 他一直坐着看她准备停当。/ As she grew older she gained in confidence. 随着年龄的增长她的信心增强了。</p>
<p><span class="vocabulary"><strong>synchronize</strong></span> [ˈsɪŋkrənaɪz]
<span class="definition">vt.&amp;vi. ~ (sth) (with sth)（使）与某事同时发生；（使）与某事物以相同的速度移动：</span>The timing of the attack was synchronized with the ambassador’s arrival. 攻击时间与大使抵达的时间同步。/ The sound track did not synchronize with the action. 声迹与动作不同步。/ Synchronise the score with the film action. 配乐和电影情节进行同步合成。/ It was virtually impossible to synchronise our lives so as to take holidays and weekends together. 想让我们的生活步调保持一致好一起去度假和过周末几乎是不可能的事。/ Let's synchronize our watches (= make them show exactly the same time). 咱们对一下表吧。</p>
<p>相关词义延伸：
· parallel还可指同时涉及若干项计算处理过程的，即并行的。</p>
</div></template>
