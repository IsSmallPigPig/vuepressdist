<template><div><p>☀ <span class="category"><strong>过程流程 程序手续：</strong></span>
☀ <span class="category"><strong>过程、流程、程序、手续的名词：</strong></span>
<span class="vocabulary"><strong>process</strong></span> ['prəʊses]
...
· proceeding可指诉讼程序（此时常用复数）。其复数形式也可指事件或一系列行动。</p>
