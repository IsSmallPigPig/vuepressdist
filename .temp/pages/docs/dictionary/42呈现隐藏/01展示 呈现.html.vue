...
<span class="definition">vt. 展示能力：</span>Becoming your own person releases your creativity. 保持自己的本色才有助于发挥自身创造力。</p>
<p><span class="vocabulary"><strong>flash</strong></span> [flæʃ]
<span class="definition">vt. [非正式] 向某人快速地出示，显示（如亮一下证件）：</span>He flashed his pass at the security officer. 他向保安员亮了一下通行证。<span class="definition">vt.＆vi. flash (sth) (up)（在电视屏幕、计算机屏幕等上面）出现很短的时间，即闪现，显示；也可指使…在屏幕上闪现，显示：</span>His name was flashed up on the screen. 屏幕上显示出了他的名字。/ The figures flash up on the scoreboard. 数字闪现在记分牌上。</p>
<p><span class="vocabulary"><strong>flicker</strong></span> [ˈflɪkə(r)]
<span class="definition">vi.（情绪、思想等）短时间闪现、一闪而过：</span>Anger flickered in his eyes. 他眼中闪现出一股怒火。/ A smile flickered across Vincent's grey features. 文森特苍白的面孔上掠过一丝微笑。/ a shadow of disquiet flickering over his face 他脸上闪过的不安的阴影</p>
<p><span class="vocabulary"><strong>card</strong></span> [kɑːd]
<span class="definition">vt. [美，非正式]（如购买酒类饮料的时候）让一个人出示其身份证以核查其年龄：</span>了解即可</p>
<p><span class="vocabulary"><strong>tender</strong></span> [ˈtendə(r)]
<span class="definition">vt. [正式] ~ sth (to sb) 将某事物正式提供给某人，如出示：</span>He took his wallet from his inside coat pocket and tendered the permit. 他从外套内兜里掏出钱包，出示了许可证。</p>
<p><span class="vocabulary"><strong>give</strong></span> [ɡɪv]
<span class="definition">vt. 公开进行…或表演…：</span>She gave a reading from her latest volume of poetry. 她朗诵了她最近出版的诗集里的一首诗。/ Kotto gives a stupendous performance. 科托奉上了一场令人惊叹的演出。/ to give a press conference 举行记者招待会</p>
<p><span class="vocabulary"><strong>produce</strong></span> [prə'dju:s]
<span class="definition">vt. 1 给出证据、论点等：</span>to produce evidence 给出证据 <span class="definition">2 produce sth (from/out of sth) 出示，展示，使…从某处出现：</span>He produced a letter from his pocket. 他从口袋里掏出一封信来。/ At the meeting the finance director produced the figures for the previous year. 会上，财务总监出示了前一年的数字。</p>
<p><span class="vocabulary"><strong>prove</strong></span> [pru:v]
<span class="definition">linking verb.（在一段时间后）发现（或被发现）是，相当于turn out：</span>The opposition proved too strong for him. 这个对手过于强劲，使得他难以招架。/ Shares in the industry proved a poor investment. 事实证明投资这个行业的股票是一个失败。/ The promotion proved to be a turning point in his career. 这次晋升证明是他职业生涯的一个转折点。<span class="definition">vt. 1 prove yourself (to sb) 向别人展示自己在某方面的才能或能力：</span>He constantly feels he has to prove himself to others. 他时常觉得自己必须向人一展身手。<span class="definition">2 prove yourself sth/to be sth 向别人展示你是某类人或你有某种品质：</span>He proved himself determined to succeed. 他向人证明了自己不达目的不罢休。</p>
<p><span class="vocabulary"><strong>project</strong></span> ['prɒdʒekt, 'prəʊ-]
<span class="definition">vt. project (yourself) 把某人（如自己）或某事物以某种方式呈现给他人，尤指给人良好印象，即表现：</span>to project a positive image of the company 树立公司的正面形象 / She projects an air of calm self-confidence. 她表现出镇定自若的神态。/ He projected himself as a man worth listening to. 他装成很有见地的样子。</p>
<p><span class="vocabulary"><strong>represent</strong></span> [͵reprɪ'zent]
<span class="definition">vt. 1 represent sb/sth (as sb/sth)（尤指在图画、图片或图表中）展示某人或某事物，还可称为描绘，相当于depict：</span>The carvings represent a hunting scene. 这些雕刻作品描绘了一幅狩猎的场面。/ The book purported to represent the lives of ordinary people. 这本书声称旨在展现普通人的生活。/ The results are represented in fig.3 below. 结果如下面的图3所示。/ to represent an image accurately 精确显示图像 / It is not clear what these symbols were intended to represent. 这些符号代表什么还不清楚。<span class="definition">2 [正式] represent sb/sth (as sth) 以某种方式（尤指可能不公平地）呈现或描述某人或某事物：</span>The risks were represented as negligible. 他们把风险说得微不足道。/ The movie represents women as victims. 该影片把妇女表现为受害者。</p>
<p><span class="vocabulary"><strong>make</strong></span> [meɪk]
<span class="definition">vt. 表现；描绘或刻画等：</span>You’ve made my nose too big (= for example in a drawing). 你把我的鼻子画得太大了。/ He makes King Lear a truly tragic figure. 他把李尔王刻画成一个真正的悲剧人物。</p>
...
<p><span class="vocabulary"><strong>depict</strong></span> [dɪˈpɪkt]
...
<p><span class="vocabulary"><strong>portray</strong></span> [pɔ:ˈtreɪ; 美 pɔ:rˈt-]
...
<span class="definition">vt. [正式] 在头脑中唤起（形象）：</span>The novel vividly evokes the life of the Irish in Australia. 这部小说生动地再现了在澳大利亚的爱尔兰人的生活。</p>
<p><span class="vocabulary"><strong>say</strong></span> [seɪ]
<span class="definition">vt.＆vi. 无被动语态，（书面材料或可见的东西）提供某信息或某指示：</span>The notice said ‘Keep Out’. 告示上写着“禁止入内”。/ The clock said four minutes past eleven when we set off. 我们出发时，时钟显示十一点过四分。/ The instructions say (that) we should leave it to set for four hours. 说明书上说我们应让它凝结四小时。/ The book doesn’t say where he was born. 书上没说他是在哪儿出生的。/ The guidebook says to turn left. 旅游指南上说应向左拐。</p>
<p><span class="vocabulary"><strong>speak</strong></span> [spi:k]
<span class="definition">vi. sth speak for itself 可指（自己）会说话；（本身）能说明问题：</span>The figures speak for themselves--bleak prospects at home and a worsening outlook for exports. 这些数字本身就能说明问题——国内暗淡的前景和日益糟糕的出口展望。</p>
<p><span class="vocabulary"><strong>tell</strong></span> [tel]
<span class="definition">vt.（文章、标记等）提供关于…的信息，即说明，显示：</span>The advertisement told us very little about the product. 这则广告提供的产品信息很少。/ The sound of his breathing told her (that) he was asleep. 她从他呼吸的声音中听出来他睡着了。</p>
<p><span class="vocabulary"><strong>indicate</strong></span> ['ɪndɪkeɪt]
<span class="definition">vt.（不用通过言语的方式）显示信息：</span>The results are indicated in Table 2. 结果列在表2中。</p>
<p><span class="vocabulary"><strong>picture</strong></span> ['pɪktʃə]
<span class="definition">vt. 常用被动式，指将…显示在照片或图片上，用照片或图片来显示：</span>The panda is pictured being in good health. 照片显示，这只熊猫健康状况不错。</p>
<p><span class="vocabulary"><strong>plot</strong></span> [plɒt]
<span class="definition">vt. 用图表或计划来展示…的发展方式（或暗示其发展方向）：</span>Greenhouse temperature can be plotted against plant growth. 可以用图表显示温室的温度相对于植物生长的情况。</p>
<p><span class="vocabulary"><strong>read</strong></span> [ri:d]
<span class="definition">vi. 某事物（例如标牌）上面写着…：</span>The sign read ‘No Parking’. 告示牌上写着“禁止泊车”。/ The poem reads as follows ... 那首诗是这样写的…</p>
<p><span class="vocabulary"><strong>bear</strong></span> [beə]
<span class="definition">vt. [正式] 显示或带有（某个标记或特征）：</span>to bear the marks of bullet holes 带有子弹的痕迹 / to bear his signature 有他的签名 / to bear a seal 盖有印章</p>
<p><span class="vocabulary"><strong>assume</strong></span> [ə'sju:m]
<span class="definition">vt. [正式] 开始拥有某种品质或外观，即呈现出（外观或品质），相当于take on：</span>This matter has assumed considerable importance. 这件事看来相当重要。/ In the story the god assumes the form of an eagle. 在这个故事中神以鹰的形象出现。</p>
<p><span class="vocabulary"><strong>realise</strong></span> ['rɪəlaɪz, 'ri:-]（美realize）
<span class="definition">vt. [正式]（给予书面信息或说明）产生出能被看到或听到的东西，即把…变为现实：</span>The stage designs have been beautifully realized. 舞台设计得到了完美的体现。</p>
<p><span class="vocabulary"><strong>greet</strong></span> [ɡri:t]
<span class="definition">vt. 常用被动式，（景象、声音、气味）在某一时刻成为第一个被看到、听到或闻到的对象：</span>When she opened the door she was greeted by a scene of utter confusion. 她打开门，一片混乱不堪的景象呈现在她的眼前。</p>
<p><span class="vocabulary"><strong>package</strong></span> ['pækɪdӡ]
<span class="definition">vt. package sb/sth (as sth) 以某种方式来呈现…，即把…包装成…：</span>an attempt to package news as entertainment 把新闻包装成娱乐形式的尝试</p>
<p>相关词义延伸：
...
· indicate还可指（用灯光或手臂）表明你的交通工具要改变方向，即打行车转向信号。</p>
<p>周边词汇补充：
...
<span class="definition">n. [U, C] 一事物在另一事物中的表现：</span>The new concept of form reached its fullest expression in the work of Picasso. 形式的新概念在毕加索的作品中得到了最充分的表达。/ the highest expression of human creativity 人类创造力的最高表现 / artistic, creative, literary, musical expression 艺术的表现；创造性的表现；文学的表现；音乐的表现</p>
<p><span class="vocabulary"><strong>tribute</strong></span> [ˈtrɪbju:t]
<span class="definition">n. [sing.] ~ to sth/sb（良好效果或影响的）体现，显示：</span>His recovery is a tribute to the doctors' skill. 他的康复充分显示了各位医生高超的医术。/ His success has been a tribute to hard work, to professionalism. 他的成功充分体现了他的勤劳苦干和敬业精神。/ It is a tribute to Mr Chandler's skill that he has fashioned a fascinating book out of such unpromising material. 钱德勒先生竟然以如此不被看好的素材写出了一本引人入胜的书，这充分证明了他的写作技巧。/ The bridge is a remarkable tribute to the skill of the early engineers. 这座桥标志着早期工程师们的杰出技艺。</p>
<p><span class="vocabulary"><strong>manifestation</strong></span> [ˌmænɪfeˈsteɪʃn]
...
<p><span class="vocabulary"><strong>exhibit</strong></span> [ɪgˈzɪbɪt]
<span class="definition">vt.（为了得到别人的羡慕、关注或信任而）公开炫耀：</span>Other women seemed content and even exhibited their bellies with pride. 其他女人似乎很满足，甚至还骄傲地炫耀她们的肚腩。/ He seems to want to exhibit his shame. 他似乎想要让大家知道自己感到羞愧。</p>
<p><span class="vocabulary"><strong>parade</strong></span> [pəˈreɪd]
<span class="definition">vt. 炫耀、展示（情感、品质、成就等）：</span>They parade their virtuous beliefs and hide their vices. 他们大秀美德并掩盖自己的罪恶。/ Women were not supposed to parade their ambition nakedly. 女性被认为不应该赤裸裸地展示其雄心。/ He is not one to parade his achievements. 他不是一个爱炫耀自己成就的人。<span class="definition">n. [C, usually sing.] ~ of wealth, knowledge, etc. [常贬] 展示，尤指炫耀地展示（财富、知识等）：</span>了解即可</p>
<p>相关词义延伸：
· display还可指表演一种技能。也可指 计算机屏幕上的显示、显像，也可指显示器。亦可指（雄性的鸟兽）为求偶而做出的炫耀行为；
· expression还可指数学表达式。</p>
<p>周边词汇补充：
...
· showroom可指展销商品（尤指汽车和电子产品）的一个大型商店，如展销厅。</p>
<p>· 表示“存在”的词群见[[01存在 不在]]
· 表示“出席”的词群见[[02出席 缺席]]
...
<p>☀ <span class="category"><strong>似乎、好像的其它词性：</strong></span>
<span class="vocabulary"><strong>like</strong></span> [laɪk]
<span class="definition">conj. [非正式] 好像，仿佛，似乎：</span>She acts like she owns the place. 她的举动就像那地方是她的一样。</p>
<p><span class="vocabulary"><strong>apparent</strong></span> [ə'pærənt]
<span class="definition">adj. 常用于名词前，看起来是真的但实际上可能不是，即貌似的、表面上的，相当于seeming：</span>My parents were concerned at my apparent lack of enthusiasm for school. 我看来对上学不感兴趣，这使父母担心。</p>
<p><span class="vocabulary"><strong>outward</strong></span> ['aʊtwəd]
<span class="definition">adj. 只用于名词前，看起来的，表面的，外表的，而非实际上的：</span>Mark showed no outward signs of distress. 马克在外表上没有现出沮丧的神色来。/ To all outward appearances they were perfectly happy. 从表面上看他们显得无比幸福。/ She simply observes the outward forms of religion. 她只是表面上信教而已。</p>
<p>· 表示“像、相似”的词群见[[01相异 相同]]</p>
</div></template>
