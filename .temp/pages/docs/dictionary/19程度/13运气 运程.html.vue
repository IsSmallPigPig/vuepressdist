...
<span class="definition">n. [C] [非正式]（美也用sweeps）赌博中可指赌金全赢制（即获胜者将获得其余参赌者全部赌资的一种赌博形式），相当于sweepstake：</span>了解即可</p>
<p><span class="vocabulary"><strong>dice</strong></span> [daɪs]
<span class="definition">n. [U] 掷骰游戏；掷骰赌博：</span>We played dice all night. 我掷了一夜的色子。</p>
<p><span class="vocabulary"><strong>roll</strong></span> [rəʊl]
<span class="definition">n. [C] 掷骰子：</span>The order of play is decided by the roll of a dice. 比赛顺序是通过掷骰子决定的。</p>
<p><span class="vocabulary"><strong>throw</strong></span> [θrəʊ]
<span class="definition">n. [C] 掷色子：</span>It’s your throw. 轮到你掷（色子）了。</p>
<p><span class="vocabulary"><strong>main</strong></span> [meɪn]
<span class="definition">n. [C]（骰子游戏的）一掷：</span>了解即可</p>
<p><span class="vocabulary"><strong>dice</strong></span> [daɪs]
<span class="definition">n. [C]（也可用die，不过die尤用于美式英语）骰子、色子：</span>a pair of dice 一对骰子 / loaded dice 灌铅骰子 / to shake the dice 摇骰子 / You decide who's going to start by throwing the dice. 通过掷骰子来决定谁先开始。/ dice game 骰子游戏 / You move forward according to the number on the dice. 根据骰子上的数字往前走。/ The roll of the dice went against them. 掷出的骰子对他们不利。</p>
<p><span class="vocabulary"><strong>die</strong></span> [daɪ]
<span class="definition">n. [C] [尤美] 骰子（如赌场用的骰子）：</span>了解即可</p>
<p><span class="vocabulary"><strong>draw</strong></span> [drɔ:]
<span class="definition">n. 1 [usually sing.] [美也用drawing] draw (for sth) 抽奖；抽签，抓阄（如体育比赛中抽签以选择对手）：</span>the draw for the first round of the World Cup 世界杯第一轮抽签 / The draw for the raffle takes place on Sunday. 星期日进行抽彩。<span class="definition">2 [C] [美常用drawing] 抽奖：</span>a prize draw 抽奖</p>
<p><span class="vocabulary"><strong>drawing</strong></span> [ˈdrɔ:ɪŋ]
<span class="definition">n. 1 [sing.] [美] 抽彩、抽奖或抽签的行为：</span>了解即可 <span class="definition">2 [C] [美] 抽奖活动：</span>了解即可</p>
<p><span class="vocabulary"><strong>raffle</strong></span> [ˈræfl]
...
<p><span class="vocabulary"><strong>raffle</strong></span> [ˈræfl]
<span class="definition">vt. 在抽奖活动中送出（奖品）：</span>During each show we will be raffling a fabulous prize. 每场表演期间，我们将以抽彩方法送出大奖。</p>
<p><span class="vocabulary"><strong>ticket</strong></span> ['tɪkɪt]
<span class="definition">n. [C] 彩票，奖券：</span>lottery, raffle ticket 彩票；兑奖券 / winning ticket 中奖的彩票</p>
<p><span class="vocabulary"><strong>dividends</strong></span> [ˈdɪvɪdend]
<span class="definition">n. [C] [英] 足球彩票的彩金：</span>了解即可</p>
<p><span class="vocabulary"><strong>gambler</strong></span> [ˈgæmblə(r)]
<span class="definition">n. [C] 经常在赌牌或赌马的人，如赌徒：</span>He was a compulsive gambler (= found it difficult to stop). 他嗜赌成癖。/ professional gambler 职业赌徒</p>
<p>相关词义延伸：
· chip还可指谈判中的筹码、讨价还价的资本；
· draw还可指（由抽签决定对手的）一系列比赛（如体育比赛）。</p>
<p>周边词汇补充：<br>
· nap可指赛马专家给出的建议（即哪匹马最有可能赢），即赛马情报、赛马结果预测。</p>
<p>· 表示“赌球”、“赌马”的词群见[[34观赛 赌球]]
· 表示“冒险”的词群见[[06冒险 风险]]</p>
</div></template>
