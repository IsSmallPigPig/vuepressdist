...
<span class="definition">adj. 只用于名词前，从中心（或某个点）向外的：</span>outward movement 向外的运动 / outward investment 对外投资 / Managers need to become more outward-looking. 管理人员需要有更广阔的视野。</p>
<p><span class="vocabulary"><strong>outwards</strong></span> ['aʊtwədz]（英）（英、美还用outward）
<span class="definition">adv. outwards (from sth) 向外，朝外，远离中心（或某个点）：</span>The door opens outwards. 这个门向外开。/ Factories were spreading outwards from the old heart of the town. 工厂从旧城中心逐渐向外扩展。</p>
<p><span class="vocabulary"><strong>outdoors</strong></span> ['aʊt'dɔ:z]
<span class="definition">adv. 在户外，在室外（而非在建筑物内）：</span>to eat outdoors 在户外用餐 / to walk outdoors 到户外散步</p>
<p><span class="vocabulary"><strong>offside</strong></span> [ˌɒfˈsaɪd; 美 ˌɔ:f-; ˌɑ:f-]
<span class="definition">adj. [英]（车辆在靠左交通中的）（车辆）外侧的：</span>the offside mirror 右侧镜</p>
<p><span class="vocabulary"><strong>offside</strong></span> [ˈɒfsaɪd; 美 ˈɔ:f-; ˈɑ:f-]
<span class="definition">n. [U]（车辆在靠左交通中的）（车辆的）外侧：</span>The offside was damaged. 车辆外侧受损。</p>
<p><span class="vocabulary"><strong>external</strong></span> [ɪkˈstɜ:nl; 美 ɪkˈstɜ:rnl]
<span class="definition">adj. 1（某事物或某人的）外部的，位于（某事物或某人的）外部的：</span>the external walls of the building 建筑物的外墙 / The lotion is for external use only (= only for the skin and must not be swallowed). 此涂液仅限外用。/ internal and external allergic reactions 内外变态反应 <span class="definition">2 发生或来自于一个外部的地方、组织机构、情形等的：</span>A combination of internal and external factors caused the company to close down. 内外因结合导致了公司的倒闭。/ external pressures on the economy 外部因素对经济的压力 / Many external influences can affect your state of mind. 许多外在因素都可能影响人的心情。/ a reaction to external events 对外界事件的反应 / Such events occur only when the external conditions are favorable. 这种事情只有在外部条件有利时才会发生。<span class="definition">3（专家）来自（学校或机构）外部的：</span>external examiners, external assessors（均英）校外主考人；外来评定人 / An external auditor will verify the accounts. 外部审计员将核实这些账目。</p>
<p><span class="vocabulary"><strong>exterior</strong></span> [ɪkˈstɪəriə(r); 美 -ˈstɪr-]
<span class="definition">adj. 1 [常用于名词前] 在某事物的外面的：</span>exterior surfaces 外层表面 / The exterior walls were made of pre-formed concrete. 外墙用的是预制混凝土。/ the oven's exterior surfaces 烤箱的外表面 <span class="definition">2 [常用于名词前] 发生或完成于户外的：</span>The filming of the exterior scenes was done on the moors. 外景是在沼泽地拍摄的。</p>
<p><span class="vocabulary"><strong>outermost</strong></span> [ˈaʊtəməʊst; 美 ˈaʊtərmoʊst]
<span class="definition">adj. [只用于名词前] 最外边的、离中心最远的：</span>the outermost planet 最远的行星 / Neptune, the outermost known planet 已知最外围的行星海王星 / He fired and hit the outermost ring of the target. 他开枪射中了靶子的最外一环。/ the outermost corners of each room 每间屋最远的角落</p>
<p>相关词义延伸：
· external还可指与外国有关的、对外的；
· exterior还可指某事物（尤指建筑物）的外部、外观、外表。也可指人的外在行为（尤指与其内心真实感情或性格极为不同的外在行为）。</p>
<p>周边词汇补充：
· peripheral可指（区域）外围的、周边的。还可指次要的。也可指（设备）与计算机相连的，即外围的。亦可指计算机的外围设备、周边设备；
· superficial可指研究或观察得不仔细、不彻底的，只看表面现象的，即粗略的、肤浅的。还可指表面上真实或重要的（实际上仔细观察后并非如此）。也可指（伤口或损坏）表层的、不严重的。亦可指（感情、关系）浅薄的、缺乏深度的。或可指（人）肤浅的、对…缺乏深刻理解的；再可指某事物的表层的、浅表的。</p>
<p><span class="vocabulary"><strong>surface</strong></span> ['sə:fɪs]
<span class="definition">n. 1 [C] 某事物的表面，表层：</span>We’ll need a flat surface to play the game on. 我们得有个平面才能玩这个游戏。/ a broad leaf with a large surface area 表面积很大的阔叶 / frozen surface 结冰的表面 / the inner surface of a bone 骨头的内壁 / the surface layer of the skin 皮肤的表层 / surface temperature 表面温度 <span class="definition">2 [C, usually sing.] 水面；液面；地面等：</span>the earth’s surface 地球表面 / water surface 水面 / floor, ground, land, ocean, road, rock, wall surface 地板表面；地面；陆地表面；洋面；路面；岩石表面；墙面 <span class="definition">3 [C]（桌子、厨房柜面等家具的用于工作的）顶部平面：</span>kitchen, work, working surface 厨房台面；工作台面</p>
<p><span class="vocabulary"><strong>finish</strong></span> ['fɪnɪʃ]
<span class="definition">n. [C, U] 在某事物的表面所刷上或涂上的最后一层油漆、最后一道抛光等；还可指刷漆或抛光完毕后的表面状况：</span>furniture available in a range of finishes 有各种光泽处理的家具 / decorative finish 装饰面 / painted finish 油漆过的表面 / shiny finish 闪亮的表面 / a guitar with a natural wood finish 有着自然木头光泽的吉他 / floor, wall finish 地板表面；墙面 / This paint has a gloss finish. 这种漆的光泽度很好。/ Sand the wood to a fine finish using steel wool. 用钢丝球打磨抛光木材。/ a door handle with a metallic finish 镀金属的门把手</p>
<p><span class="vocabulary"><strong>abroad</strong></span> [ə'brɔ:d]
<span class="definition">adv. [旧时] 在室外；到室外；户外：</span>了解即可</p>
<p><span class="vocabulary"><strong>wall</strong></span> [wɔ:l]
<span class="definition">n. [C] 中空物体（如身体器官或动植物细胞等）的外壁：</span>the abdominal wall 腹腔壁 / cell, vessel wall 细胞壁；血管壁 / the inside walls of the box 箱子的内壁</p>
<p><span class="vocabulary"><strong>skin</strong></span> [skɪn]
<span class="definition">n. [C]（覆盖着某事物的）外壳，外皮，外层：</span>the metal skin of the machine 机器的金属外壳 / the outer skin of the earth 地壳</p>
<p><span class="vocabulary"><strong>shell</strong></span> [ʃel]
<span class="definition">n. [C] 物体的硬外壳：</span>the body shell of a car 车身外壳</p>
<p><span class="vocabulary"><strong>crust</strong></span> [krʌst]
<span class="definition">n. [C, U]（尤指软物或液体上面或周围的）坚硬层、硬表面：</span>Put the lid on properly, or a crust will form on the paints. 把盖子盖好，否则颜料表层会硬化。/ a thin crust of ice 一层薄冰 / As the water evaporates, a crust of salt is left on the surface of the soil. 随着水分的蒸发，地面上留下了一层结晶盐。/ The mud had formed a thick crust on the surface of the road. 路面上结了一层又厚又硬的泥。</p>
<p><span class="vocabulary"><strong>sideline</strong></span> [ˈsaɪdlaɪn]
<span class="definition">n. [pl.]（某一情况的）外围，局外：</span>France no longer wants to be left on the sidelines when critical decisions are taken. 在作出关键决定时，法国不想再被撇在一边了。/ He has watched from the sidelines the great developments unrolling in Eastern Europe. 他一直在一旁关注东欧相继取得的重大进展。</p>
<p><span class="vocabulary"><strong>outdoor</strong></span> ['aʊt'dɔ:]
<span class="definition">adj. 只用于名词前，指被应用于、发生于或位于建筑物外的，即室外的，户外的：</span>outdoor clothing, outdoor activities 户外穿的衣服；户外活动 / an outdoor swimming pool 室外游泳池 / I’m not really the outdoor type. 我不是个真正喜爱户外活动的人。</p>
<p><span class="vocabulary"><strong>open</strong></span> ['əʊpən ]
<span class="definition">adj. 没有覆盖物或房顶的，即敞开的：</span>to work in the open air 在户外作业 / an open wound 开放性伤口 / an open drain 一条明沟 / The hall of the house was open to the sky. 这栋房子的门厅是露天的。<span class="definition">n. [sing.] the open 户外；乡下；野外：</span>Children need to play out in the open. 孩子需要在户外玩耍。</p>
<p>相关词义延伸：
...
· offshore在商业上可指（资金、公司等）设在海外（尤指税制较宽松的国家）的。</p>
<p>· 表示“外观”的词群见[[04外观 形象]]
