<template><div><p>☀ <span class="category"><strong>开庭 审理：</strong></span>
<span class="vocabulary"><strong>sit</strong></span> [sɪt]
<span class="definition">vi.（法庭）开庭：</span>了解即可</p>
<p><span class="vocabulary"><strong>session</strong></span> ['seʃn]
<span class="definition">n. [C] 法庭开庭处理业务的一段时间。狭义上可指每日的“开庭期”或“庭审期”；但在广义上也可指从第一次开庭到最终休庭之间的整个时间段（此期间也许包括若干天、若干周，甚至更长的时间），在此意义上与term或sitting同义，很多权威人士都将session与term作为同义词而互换使用：</span>The court is now in session. 法庭正处于庭审期。</p>
<p><span class="vocabulary"><strong>judge</strong></span> [dӡʌdӡ]
<span class="definition">vt. 在法庭上做出审判：</span>to judge a case 审理案件</p>
